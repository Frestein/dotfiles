...
function fish_prompt -d 'Write out the prompt; do not replace this. Instead, put this at end of your file.'
...
# vterm-eval-cmds.
function vterm_cmd -d 'Run an Emacs command among the ones defined in vterm-eval-cmds.'
    set -l vterm_elisp ()
    for arg in $argv
