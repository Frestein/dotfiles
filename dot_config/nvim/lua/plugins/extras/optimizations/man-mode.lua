...
return {
	...
	{ "chrisgrieser/nvim-various-textobjs",          optional = true, cond = is_not_man_mode },
	{ "nvim-mini/mini.ai",                         optional = true, cond = is_not_man_mode },
	{ "nvim-mini/mini.align",                      optional = true, cond = is_not_man_mode },
	{ "nvim-mini/mini.files",                      optional = true, cond = is_not_man_mode },
	{ "nvim-mini/mini.move",                       optional = true, cond = is_not_man_mode },
	{ "nvim-mini/mini.operators",                  optional = true, cond = is_not_man_mode },
	{ "nvim-mini/mini.pairs",                      optional = true, cond = is_not_man_mode },
	{ "nvim-mini/mini.surround",                   optional = true, cond = is_not_man_mode },
	...
	{ "nvim-treesitter/nvim-treesitter",             optional = true, cond = is_not_man_mode },
