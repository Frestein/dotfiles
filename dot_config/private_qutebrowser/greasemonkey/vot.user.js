...
(() => {
  var d = {
      "./node_modules/@vot.js/core/dist/client.js": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/@vot.js/shared/dist/data/config.js"),
              g = p("./node_modules/@vot.js/shared/dist/utils/logger.js"),
              _ = p("./node_modules/@vot.js/shared/dist/protos/yandex.js"),
              v = p("./node_modules/@vot.js/shared/dist/secure.js"),
              b = p("./node_modules/@vot.js/shared/dist/utils/utils.js"),
              x = p("./node_modules/@vot.js/core/dist/protobuf.js"),
              C = p("./node_modules/@vot.js/core/dist/types/yandex.js"),
              w = p("./node_modules/@vot.js/core/dist/utils/vot.js"),
              T = p("./src/utils/VOTLocalizedError.js"),
              E = d([T]);
            ...
            class MinimalClient {
              ...
              async request(d, f, p = {}, m = "POST") {
                ...
                try {
                  let f = await this.fetch(
                      `${this.schema}://${this.host}${d}`,
                      h,
                    ),
              ...
              async createSession(d) {
                let f = (0, v.yk)(),
                  p = x.P.encodeSessionRequest(f, d),
                  m = await this.request("/session/create", p, {
                    "Vtrans-Signature": await (0, v.dD)(p),
                  });
                if (!m.success)
                  throw new VOTJSError("Failed to request create session", m);
            ...
            class VOTClient extends MinimalClient {
              ...
              isCustomLink(d) {
                return !!(
                  /\.(m3u8|m4(a|v)|mpd)/.exec(d) ??
                  /^https:\/\/cdn\.qstv\.on\.epicgames\.com/.exec(d)
                );
              }
              headersVOT = {
              ...
              constructor({
                ...
                (this.hostVOT = x ? f.replace(`${x}://`, "") : f),
                  (this.schemaVOT = x ?? "https"),
                  (this.requestLang = g),
                  (this.responseLang = _),
                  (this.apiToken = v);
              }
              ...
              async translateVideoYAImpl({
                videoData: d,
                requestLang: f = this.requestLang,
                responseLang: p = this.responseLang,
                translationHelp: m = null,
                headers: _ = {},
                extraOpts: b = {},
                shouldSendFailedAudio: w = !0,
              }) {
                let { url: E, duration: D = h.A.defaultDuration } = d,
                  O = await this.getSession("video-translation"),
                  A = x.S.encodeTranslationRequest(E, D, f, p, m, b),
                  j = this.paths.videoTranslation,
                  F = await (0, v.C0)("Vtrans", O, A, j),
                  U = b.useLivelyVoice ? this.apiTokenHeader : {},
                  W = await this.request(j, A, {
                    ...F,
                    ...U,
                    ..._,
                  });
                ...
                switch (K) {
                  case C.v.FAILED:
                    throw G?.message
                      ? new VOTJSError("Yandex couldn't translate video", G)
                      : new T.n("requestTranslationFailed");
                  case C.v.FINISHED:
                  ...
                  case C.v.AUDIO_REQUESTED:
                    return E.startsWith("https://youtu.be/") && w
                      ? (await this.requestVtransFailAudio(E),
                        await this.requestVtransAudio(E, G.translationId, {
                  ...
                  default:
                    throw (
                      (g.A.error("Unknown response", G),
                      new VOTJSError("Unknown response from Yandex", G))
                    );
                }
              }
              async translateVideoVOTImpl({
                ...
                videoId: f,
                service: p,
                requestLang: m = this.requestLang,
                responseLang: h = this.responseLang,
                headers: g = {},
              }) {
                let _ = (0, w.p)(p, f, d),
                  v = await this.requestVOT(
                ...
                switch (b.status) {
                  case "failed":
                    throw new VOTJSError("Yandex couldn't translate video", b);
                  case "success":
              ...
              async requestVtransFailAudio(d) {
                let f = await this.requestJSON(
                  this.paths.videoTranslationFailAudio,
                  JSON.stringify({ video_url: d }),
                  void 0,
                  "PUT",
                );
                if (!f.data || typeof f.data == "string" || f.data.status !== 1)
                  throw new VOTJSError(
              ...
              async requestVtransAudio(d, f, p, m, h = {}) {
                let g = await this.getSession("video-translation"),
                  _ = x.S.isPartialAudioBuffer(p)
                    ? x.S.encodeTranslationAudioRequest(d, f, p, m)
                    : x.S.encodeTranslationAudioRequest(d, f, p, void 0),
                  b = this.paths.videoTranslationAudio,
                  C = await (0, v.C0)("Vtrans", g, _, b),
                ...
                if (!w.success)
                  throw new VOTJSError(
                    "Failed to request video translation audio",
                    w,
                  );
              ...
              async translateVideoCache({
                ...
                let { url: g, duration: _ = h.A.defaultDuration } = d,
                  b = await this.getSession("video-translation"),
                  C = x.S.encodeTranslationCacheRequest(g, _, f, p),
                  w = this.paths.videoTranslationCache,
                  T = await (0, v.C0)("Vtrans", b, C, w),
                ...
                if (!E.success)
                  throw new VOTJSError(
                    "Failed to request video translation cache",
                    E,
                  );
              ...
              async translateVideo({
                ...
                headers: h = {},
                extraOpts: g = {},
                shouldSendFailedAudio: _ = !0,
              }) {
                let { url: v, videoId: b, host: x } = d;
                return this.isCustomLink(v)
              ...
              async getSubtitlesYAImpl({
                videoData: d,
                requestLang: f = this.requestLang,
                headers: p = {},
              }) {
                let { url: m } = d,
                  h = await this.getSession("video-translation"),
                  g = x.S.encodeSubtitlesRequest(m, f),
                  _ = this.paths.videoSubtitles,
                  b = await (0, v.C0)("Vsubs", h, g, _),
                  C = await this.request(_, g, {
                    ...b,
                    ...p,
                  });
                if (!C.success)
                  throw new VOTJSError("Failed to request video subtitles", C);
                let w = x.S.decodeSubtitlesResponse(C.data),
                  T = w.subtitles.map((d) => {
                    let {
                      language: f,
                      url: p,
              ...
              async getSubtitlesVOTImpl({
                ...
                if (!g.success)
                  throw new VOTJSError("Failed to request video subtitles", g);
                let _ = g.data,
                  v = _.reduce((d, f) => {
              ...
              async pingStream({ pingId: d, headers: f = {} }) {
                let p = await this.getSession("video-translation"),
                  m = x.S.encodeStreamPingRequest(d),
                  h = this.paths.streamPing,
                  g = await (0, v.C0)("Vtrans", p, m, h),
                  _ = await this.request(h, m, {
                    ...g,
                    ...f,
                  });
                if (!_.success)
                  throw new VOTJSError("Failed to request stream ping", _);
                return !0;
              }
              async translateStream({
                ...
                let { url: h } = d;
                if (this.isCustomLink(h))
                  throw new T.n("VOTStreamNotSupportedUrl");
                let b = await this.getSession("video-translation"),
                  C = x.S.encodeStreamRequest(h, f, p),
                  w = this.paths.streamTranslation,
                  E = await (0, v.C0)("Vtrans", b, C, w),
                  D = await this.request(w, C, {
                    ...E,
                    ...m,
                  });
                if (!D.success)
                  throw new VOTJSError(
                    "Failed to request stream translation",
                    D,
                  );
                let O = x.S.decodeStreamResponse(D.data),
                  A = O.interval;
                switch (A) {
                  case _.q8.NO_CONNECTION:
                  case _.q8.TRANSLATING:
                    return {
                      translated: !1,
                      interval: A,
                      message:
                        A === _.q8.NO_CONNECTION
                  ...
                  default:
                    throw (
                      (g.A.error("Unknown response", O),
                      new VOTJSError("Unknown response from Yandex", O))
                    );
                }
              }
            }
      ...
      "./node_modules/@vot.js/core/dist/protobuf.js": (d, f, p) => {
        ...
        class YandexVOTProtobuf {
          ...
          static encodeTranslationAudioRequest(d, f, p, h) {
            return h && YandexVOTProtobuf.isPartialAudioBuffer(p)
              ? m.Y7.encode({
                  url: d,
                  translationId: f,
                  partialAudioInfo: {
      ...
      "./node_modules/@vot.js/core/dist/types/service.js": (d, f, p) => {
        ...
        (function (d) {
          (d.custom = "custom"),
            ...
            (d.trovo = "trovo"),
            (d.yandexdisk = "yandexdisk"),
            (d.ok_ru = "okru"),
            (d.okru = "okru"),
            (d.googledrive = "googledrive"),
            (d.bannedvideo = "bannedvideo"),
            (d.weverse = "weverse"),
            (d.newgrounds = "newgrounds"),
            (d.egghead = "egghead"),
            (d.youku = "youku"),
            (d.archive = "archive"),
            (d.kodik = "kodik"),
            ...
            (d.reddit = "reddit"),
            (d.kick = "kick"),
            (d.apple_developer = "apple_developer"),
            (d.appledeveloper = "apple_developer"),
            (d.poketube = "poketube"),
            (d.epicgames = "epicgames"),
            (d.odysee = "odysee"),
            (d.coursehunterLike = "coursehunterLike"),
            (d.sap = "sap"),
            (d.watchpornto = "watchpornto"),
            (d.linkedin = "linkedin"),
            (d.ricktube = "ricktube"),
            (d.incestflix = "incestflix"),
            (d.porntn = "porntn"),
            (d.dzen = "dzen"),
            (d.cloudflarestream = "cloudflarestream"),
            (d.loom = "loom"),
            (d.rtnews = "rtnews"),
            (d.bitview = "bitview"),
            (d.thisvid = "thisvid"),
      ...
      "./node_modules/@vot.js/core/dist/types/yandex.js": (d, f, p) => {
        ...
        (function (d) {
          (d[(d.FAILED = 0)] = "FAILED"),
            (d[(d.FINISHED = 1)] = "FINISHED"),
            (d[(d.WAITING = 2)] = "WAITING"),
            (d[(d.LONG_WAITING = 3)] = "LONG_WAITING"),
            (d[(d.PART_CONTENT = 5)] = "PART_CONTENT"),
            (d[(d.AUDIO_REQUESTED = 6)] = "AUDIO_REQUESTED"),
            (d[(d.SESSION_REQUIRED = 7)] = "SESSION_REQUIRED");
        })((m ||= {}));
        var h;
        (function (d) {
          (d.WEB_API_VIDEO_SRC_FROM_IFRAME = "web_api_video_src_from_iframe"),
            (d.WEB_API_VIDEO_SRC = "web_api_video_src"),
            (d.WEB_API_GET_ALL_GENERATING_URLS_DATA_FROM_IFRAME =
              "web_api_get_all_generating_urls_data_from_iframe"),
            (d.WEB_API_GET_ALL_GENERATING_URLS_DATA_FROM_IFRAME_TMP_EXP =
              "web_api_get_all_generating_urls_data_from_iframe_tmp_exp"),
            (d.WEB_API_REPLACED_FETCH_INSIDE_IFRAME =
              "web_api_replaced_fetch_inside_iframe"),
            (d.ANDROID_API = "android_api"),
            (d.WEB_API_SLOW = "web_api_slow"),
            (d.WEB_API_STEAL_SIG_AND_N = "web_api_steal_sig_and_n"),
            (d.WEB_API_COMBINED =
              "web_api_get_all_generating_urls_data_from_iframe,web_api_steal_sig_and_n");
        })((h ||= {}));
      },
      ...
      "./node_modules/@vot.js/ext/dist/client.js": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/@vot.js/core/dist/client.js"),
              g = p("./node_modules/@vot.js/shared/dist/secure.js"),
              _ = d([h]);
      ...
      "./node_modules/@vot.js/ext/dist/data/sites.js": (d, f, p) => {
        ...
        p.d(f, { A: () => _ });
        var m = p("./node_modules/@vot.js/core/dist/types/service.js"),
          h = p("./node_modules/@vot.js/shared/dist/data/alternativeUrls.js"),
          g = p("./node_modules/@vot.js/ext/dist/types/service.js");
        let _ = [
          {
          ...
          },
          {
            ...
            url: "https://rt.pornhub.com/view_video.php?viewkey=",
            match: (d) =>
              /^[a-z]+.pornhub.(com|org)$/.exec(d.host) &&
              d.pathname.startsWith("/embed/"),
            selector: "#player",
          },
          {
            host: m.r.twitter,
          ...
          },
          {
            ...
            match: (d) =>
              d.host.includes("facebook.com") &&
              d.pathname.includes("/videos/"),
          ...
          },
          {
            ...
            url: "https://facebook.com/",
            match: (d) =>
              d.host.includes("facebook.com") && d.pathname.includes("/reel/"),
          ...
          },
          {
            ...
            url: "https://t.me/",
            match: (d) =>
              /^web\.telegram\.org$/.test(d.hostname) &&
              d.pathname.startsWith("/k"),
      ...
      "./node_modules/@vot.js/ext/dist/helpers/base.js": (d, f, p) => {
        ...
        class BaseHelper {
          ...
          constructor({
            fetchFn: d = m.u9,
            extraInfo: f = !0,
            referer: p = document.referrer ?? `${window.location.origin}/`,
            ...
            (this.fetch = d),
              (this.extraInfo = f),
              (this.referer = p),
              (this.origin = /^(http(s)?):\/\//.test(String(h))
                ? h
      ...
      "./node_modules/@vot.js/ext/dist/helpers/index.js": (d, f, p) => {
        ...
        var m = p("./node_modules/@vot.js/core/dist/types/service.js"),
          h = p("./node_modules/@vot.js/ext/dist/types/service.js"),
          g = p("./node_modules/@vot.js/ext/dist/helpers/base.js"),
          _ = p("./node_modules/@vot.js/shared/dist/utils/logger.js");
        class MailRuHelper extends g.q {
          API_ORIGIN = "https://my.mail.ru";
          async getVideoMeta(d) {
            try {
              let f = await this.fetch(
                `${this.API_ORIGIN}/+/video/meta/${d}?xemail=&ajax_call=1&func_name=&mna=&mnb=&ext=1&_=${new Date().getTime()}`,
              );
              return await f.json();
            } catch (d) {
        ...
        class WeverseHelper extends g.q {
          ...
          async createHash(d) {
            let f = Date.now(),
              p = d.substring(0, Math.min(255, d.length)) + f,
              m = await (0, v.bT)(this.API_HMAC_KEY, p);
          ...
          async getPostPreview(d) {
            let f =
              `/post/v1.0/post-${d}/preview?` +
              new URLSearchParams({
                fieldSet: "postForPreview",
                ...this.getURLData(),
              }).toString();
            try {
              let d = await this.getHashURLParams(f),
                p = await this.fetch(this.API_ORIGIN + f + "&" + d, {
              ...
              return (
                _.A.error(
                  `Failed to get weverse post preview by postId: ${d}`,
                  f.message,
                ),
                !1
              );
          ...
          async getVideoInKey(d) {
            ...
            try {
              ...
              return (
                _.A.error(
                  `Failed to get weverse InKey by videoId: ${d}`,
                  f.message,
                ),
                !1
              );
          ...
          async getVideoInfo(d, f, p) {
            ...
            try {
              let h = new URLSearchParams({
                ...
                g = await this.fetch(
                  `https://global.apis.naver.com/rmcnmv/rmcnmv/vod/play/v2.0/${d}?` +
                    h,
                  { headers: this.HEADERS },
                );
              return await g.json();
              ...
              return (
                _.A.error(
                  `Failed to get weverse video info (infraVideoId: ${d}, inkey: ${f}, serviceId: ${p}`,
                  m.message,
                ),
                !1
              );
        ...
        class KodikHelper extends g.q {
          ...
          getSecureData(d) {
            try {
              let [f, p, m] = d.split("/").filter((d) => d),
                h = Array.from(document.getElementsByTagName("script")),
                _ = h.filter(
                  (d) =>
                    d.innerHTML.includes(`videoId = "${p}"`) ||
                    d.innerHTML.includes(`serialId = Number(${p})`),
                );
              if (!_.length) throw new g.a("Failed to find secure script");
              let v = /'{[^']+}'/.exec(_[0].textContent.trim())?.[0];
              if (!v)
                throw new g.a("Secure json wasn't found in secure script");
              ...
              let x = h
                .find((d) => d.innerHTML.includes("var videoInfo = {}"))
                ?.textContent?.trim();
              if (!x) throw new g.a("Failed to find videoInfo content");
              let C = /videoInfo\.type\s+?=\s+?'([^']+)'/.exec(x)?.[1],
                w = /videoInfo\.id\s+?=\s+?'([^']+)'/.exec(x)?.[1],
                T = /videoInfo\.hash\s+?=\s+?'([^']+)'/.exec(x)?.[1];
              if (!C || !w || !T)
                throw new g.a("Failed to parse videoInfo content");
              return {
                videoType: C,
                videoId: w,
                hash: T,
              ...
              return (
                _.A.error(
                  `Failed to get kodik secure data by videoPath: ${d}.`,
                  f.message,
                ),
                !1
              );
          ...
          async getFtor(d) {
            ...
            try {
              ...
              return (
                _.A.error(
                  `Failed to get kodik video data (type: ${f}, id: ${p}, hash: ${m})`,
                  d.message,
                ),
                !1
              );
          ...
          decryptUrl(d) {
            let f = atob(
              d.replace(/[a-zA-Z]/g, function (d) {
                let f = d.charCodeAt(0) + 18,
                  p = d <= "Z" ? 90 : 122;
          ...
          async getVideoData(d) {
            ...
            if (!p) return;
            let m = Object.entries(p.links[p.default.toString()]),
              h = m.find(([, d]) => d.type === "application/x-mpegURL")?.[1];
            if (h)
              return {
                url: h.src.startsWith("//")
                  ? `https:${h.src}`
                  : this.decryptUrl(h.src),
              };
          }
          async getVideoId(d) {
        ...
        class PatreonHelper extends g.q {
          ...
          async getPosts(d) {
            try {
              let f = await this.fetch(
                `${this.API_ORIGIN}/posts/${d}?json-api-use-default-includes=false`,
              );
              return await f.json();
            } catch (f) {
              return (
                _.A.error(
                  `Failed to get patreon posts by postId: ${d}.`,
                  f.message,
                ),
                !1
              );
        ...
        class RedditHelper extends g.q {
          ...
          async getVideoData(d) {
            try {
              ...
              _.A.error(
                `Failed to get reddit video data by video ID: ${d}`,
                f.message,
              );
              return;
            }
        ...
        class BannedVideoHelper extends g.q {
          ...
          async getVideoInfo(d) {
            try {
              ...
              return (
                console.error(
                  `Failed to get bannedvideo video info by videoId: ${d}.`,
                  f.message,
                ),
                !1
              );
        ...
        class KickHelper extends g.q {
          ...
          async getClipInfo(d) {
            try {
              let f = await this.fetch(`${this.API_ORIGIN}/v2/clips/${d}`),
                p = await f.json(),
                { clip_url: m, duration: h, title: g } = p.clip;
              return {
                url: m,
                duration: h,
                title: g,
              ...
              _.A.error(
                `Failed to get kick clip info by clipId: ${d}.`,
                f.message,
              );
              return;
            }
          ...
          async getVideoInfo(d) {
            try {
              let f = await this.fetch(`${this.API_ORIGIN}/v1/video/${d}`),
                p = await f.json(),
                { source: m, livestream: h } = p,
                { session_title: g, duration: _ } = h;
              return {
                url: m,
              ...
              _.A.error(
                `Failed to get kick video info by videoId: ${d}.`,
                f.message,
              );
              return;
            }
          ...
          async getVideoData(d) {
            return d.startsWith("videos")
              ? await this.getVideoInfo(d.replace("videos/", ""))
              : await this.getClipInfo(d.replace("clips/", ""));
          }
          async getVideoId(d) {
        ...
        class AppleDeveloperHelper extends g.q {
          ...
          async getVideoData(d) {
            try {
              ...
              _.A.error(
                `Failed to get apple developer video data by video ID: ${d}`,
                f.message,
              );
              return;
            }
        ...
        class EpicGamesHelper extends g.q {
          ...
          async getPostInfo(d) {
            try {
              let f = await this.fetch(
                `${this.API_ORIGIN}/post.json?hash_id=${d}`,
              );
              return await f.json();
            } catch (f) {
              return (
                _.A.error(
                  `Failed to get epicgames post info by videoId: ${d}.`,
                  f.message,
                ),
                !1
              );
          ...
          getVideoBlock() {
            let d = /videoUrl\s?=\s"([^"]+)"?/,
              f = Array.from(document.body.querySelectorAll("script")).find(
                (f) => d.exec(f.innerHTML),
              );
            if (!f) return;
            let p = f.innerHTML.trim(),
              m = d.exec(p)?.[1]?.replace("qsep://", "https://");
            if (!m) return;
            ...
            try {
              h = (
                ...
                .split("\n")
                .map((d) => d.replace(/([^\s]+):\s?(?!.*\1)/, '"$1":'))
                .join("\n");
              let d = JSON.parse(h),
                f = d.filter((d) => d.type === "captions");
              return {
                playlistUrl: m,
                subtitles: f,
              };
          ...
          async getVideoData(d) {
            let f = d.split(":")?.[1],
              p = await this.getPostInfo(f);
            if (!p) return;
            let m = this.getVideoBlock();
            if (!m) return;
            let { playlistUrl: h, subtitles: g } = m,
              { title: _, description: v } = p,
              b = g.map((d) => ({
          ...
          async getVideoId(d) {
            return new Promise((d) => {
              let f = "https://dev.epicgames.com",
                p = btoa(window.location.href);
              window.addEventListener("message", (p) => {
                if (
                  p.origin !== f ||
                  !(
                    typeof p.data == "string" &&
                    p.data.startsWith("getVideoId:")
                  )
                )
                  return;
        ...
        class OdyseeHelper extends g.q {
          ...
          async getVideoData(d) {
            try {
              let f = await this.fetch(`${this.API_ORIGIN}/${d}`),
                p = await f.text(),
                m = /"contentUrl":(\s)?"([^"]+)"/.exec(p)?.[2];
              if (!m) throw new g.a("Odysee url doesn't parsed");
              return { url: m };
            } catch (f) {
              _.A.error(
                `Failed to get odysee video data by video ID: ${d}`,
                f.message,
              );
              return;
            }
        ...
        class CoursehunterLikeHelper extends g.q {
          ...
          async getLessonsData(d) {
            ...
            try {
              let f = await this.fetch(
                `${this.API_ORIGIN}/api/v1/course/${d}/lessons`,
              );
              return await f.json();
            } catch (f) {
              _.A.error(
                `Failed to get CoursehunterLike lessons data by courseId: ${d}, because ${f.message}`,
              );
              return;
            }
          }
          ...
          async getVideoData(d) {
            ...
            if (!p) return;
            let m = this.getLessondId(d),
              h = p?.[m - 1],
              { file: g, duration: _, title: v } = h;
            if (g)
              return {
                url: (0, x.fl)(g),
                duration: _,
        ...
        class TwitchHelper extends g.q {
          ...
          async getClipLink(d, f) {
            let p = document.querySelector(
              ...
              m = d.slice(1);
            if (p) {
              let d = JSON.parse(p.innerText),
                f = d["@graph"].find((d) => d["@type"] === "VideoObject")
                  ?.creator.url;
          ...
          async getVideoId(d) {
            let f = d.pathname;
            if (/^m\.twitch\.tv$/.test(f))
              return /videos\/([^/]+)/.exec(d.href)?.[0] ?? f.slice(1);
            if (/^player\.twitch\.tv$/.test(d.hostname))
              return `videos/${d.searchParams.get("video")}`;
            let p = /([^/]+)\/(?:clip)\/([^/]+)/.exec(f);
            if (p) return p[0];
        ...
        class SapHelper extends g.q {
          ...
          async requestKaltura(d, f, p) {
            let m = "html5:v3.17.22",
              h = "3.3.0";
            try {
              let g = await this.fetch(
                `https://${d}/api_v3/service/multirequest`,
                {
                  method: "POST",
                  body: JSON.stringify({
                    1: {
          ...
          async getKalturaData(d) {
            try {
              ...
              if (!m || Number.isNaN(+h) || !_)
                throw new g.a(
                  `One of the necessary parameters for getting a link to a sap video in wasn't found for ${d}. Params: kalturaDomain = ${m}, partnerId = ${h}, entryId = ${_}`,
                );
        ...
        class VideoJSHelper extends g.q {
          ...
          getVideoDataByPlayer(d) {
            try {
              ...
              if (!f)
                throw Error(
                  `Video player doesn't have player option, videoId ${d}`,
                );
              let p = f.duration(),
                m = Array.isArray(f.currentSources)
                  ? f.currentSources
                  : f.getCache()?.sources,
                { tracks_: h } = f.textTracks(),
                g = m.find(
                  (d) => d.type === "video/mp4" || d.type === "video/webm",
                );
        ...
        class VimeoHelper extends g.q {
          ...
          async getViewerData() {
            try {
              let d = await this.fetch("https://vimeo.com/_next/viewer"),
                f = await d.json(),
                { apiUrl: p, jwt: m } = f;
              return (
                (this.API_ORIGIN = `https://${p}`),
                (this.API_KEY = `jwt ${m}`),
                f
              );
            } catch (d) {
              return (
                _.A.error("Failed to get default viewer data.", d.message), !1
              );
            }
          }
          async getVideoInfo(d) {
            try {
              let f = new URLSearchParams({
                ...
                p = await this.fetch(`${this.API_ORIGIN}/videos/${d}?${f}`, {
                  headers: { Authorization: this.API_KEY },
                }),
                m = await p.json();
              if (this.isErrorData(m))
                throw Error(m.developer_message ?? m.error);
              return m;
            } catch (f) {
              return (
                _.A.error(
                  `Failed to get video info by video ID: ${d}`,
                  f.message,
                ),
                !1
              );
          ...
          async getPrivateVideoSource(d) {
            try {
              let { default_cdn: f, cdns: p } = d.dash,
                m = p[f].url,
                h = await this.fetch(m);
              if (h.status !== 200) throw new g.a(await h.text());
              let _ = await h.json(),
                v = new URL(_.base_url, m),
                b = _.audio.find(
                  (d) => d.mime_type === "audio/mp4" && d.format === "dash",
                );
              ...
              return (
                T.delete("range"),
                new URL(`${b.base_url}${C}?${T.toString()}`, v).href
              );
            } catch (d) {
              return (
                _.A.error("Failed to get private video source", d.message), !1
              );
            }
          }
          async getPrivateVideoInfo(d) {
            try {
              ...
              let f = await this.getPrivateVideoSource(
                playerConfig.request.files,
              );
              if (!f) throw new g.a("Failed to get private video source");
              let {
                video: { title: p, duration: m },
                request: { text_tracks: h },
              } = playerConfig;
              return {
              ...
              return (
                _.A.error(
                  `Failed to get private video info by video ID: ${d}`,
                  f.message,
                ),
                !1
              );
          ...
          async getSubsInfo(d) {
            try {
              let f = new URLSearchParams({
                ...
                p = await this.fetch(
                  `${this.API_ORIGIN}/videos/${d}/texttracks?${f}`,
                  { headers: { Authorization: this.API_KEY } },
                ),
                m = await p.json();
              if (this.isErrorData(m))
              ...
              return (
                _.A.error(
                  `Failed to get subtitles info by video ID: ${d}`,
                  f.message,
                ),
                []
              );
          ...
          async getVideoData(d) {
            ...
            if (f) {
              ...
              if (!f) return;
              let { url: p, subs: m, video_url: h, title: g, duration: _ } = f,
                v = m.map((d) => ({
            ...
            let h = await this.getSubsInfo(d),
              g = h.map((d) => ({
                language: (0, x.ec)(d.language),
                source: "vimeo",
                format: "vtt",
          ...
          async getVideoId(d) {
            ...
            if (f) {
              let p = d.searchParams.get("h"),
                m = f.replace("video/", "");
              return p ? `${m}/${p}` : m;
            }
            let p =
              /channels\/[^/]+\/([^/]+)/.exec(d.pathname)?.[1] ??
              /groups\/[^/]+\/videos\/([^/]+)/.exec(d.pathname)?.[1] ??
              /(showcase|album)\/[^/]+\/video\/([^/]+)/.exec(d.pathname)?.[2];
        ...
        class YandexDiskHelper extends g.q {
          ...
          async getClientVideoData(d) {
            let f = new URL(window.location.href),
              p = f.searchParams.get("idDialog");
            if (!p) return;
            let m = document.querySelector("#preloaded-data");
            if (m)
              try {
                let d = JSON.parse(m.innerText),
                  { idClient: f, sk: h } = d.config,
                  _ = await this.fetch(
                    this.API_ORIGIN + "/models-v2?m=mpfs/info",
                    {
                      method: "POST",
                      body: JSON.stringify({
                        apiMethod: "mpfs/info",
                  ...
                  v = await _.json();
                if (this.isErrorData(v))
                  throw new g.a(v.error?.message ?? v.error?.code);
                if (v?.type !== "file")
                  throw new g.a("Failed to get resource info");
                let {
                  meta: { short_url: b, video_info: x },
                  name: C,
                } = v;
                if (!x) throw new g.a("There's no video open right now");
                if (!b) throw new g.a("Access to the video is limited");
                let w = this.clearTitle(C),
                  T = Math.round(x.duration / 1e3);
                return {
                  url: b,
                  title: w,
                  duration: T,
                ...
                _.A.error(
                  `Failed to get yandex disk video data by video ID: ${d}, because ${f.message}`,
                );
                return;
              }
          }
          ...
          async fetchList(d, f) {
            let p = this.getBodyHash(d, f),
              m = await this.fetch(this.API_ORIGIN + "/public/api/fetch-list", {
                method: "POST",
                body: p,
              }),
              h = await m.json();
            if (Object.hasOwn(h, "error"))
              throw new g.a("Failed to fetch folder list");
            return h.resources;
          }
          async getDownloadUrl(d, f) {
            let p = this.getBodyHash(d, f),
              m = await this.fetch(
                this.API_ORIGIN + "/public/api/download-url",
                {
                  method: "POST",
                  body: p,
                },
          ...
          async getDiskVideoData(d) {
            try {
              ...
              let m = JSON.parse(f.innerText),
                ...
                b = h[_],
                C = p.length - 1,
                w = p.filter((d, f) => f !== C).join("/"),
                T = Object.values(h);
              w.includes("/") &&
                (T = await this.fetchList(`${b.hash}:/${w}`, v));
              let E = T.find((d) => d.name === p[C]);
              if (!E) throw new g.a("Failed to find resource");
              if (E && E.type === "dir")
                throw new g.a("Path is dir, but expected file");
              let {
                meta: { short_url: D, mediatype: O, videoDuration: A },
                path: j,
                name: F,
              } = E;
              if (O !== "video") throw new g.a("Resource isn't a video");
              let U = this.clearTitle(F),
                W = Math.round(A / 1e3);
              if (D)
                return {
                  url: D,
              ...
              _.A.error(
                `Failed to get yandex disk video data by disk video ID: ${d}`,
                f.message,
              );
              return;
            }
          ...
          async getVideoData(d) {
            return d.startsWith(this.INLINE_PREFIX) || /^\/d\/([^/]+)$/.exec(d)
              ? { url: this.service.url + d.slice(1) }
              : ((d = decodeURIComponent(d)),
                d.startsWith(this.CLIENT_PREFIX)
                  ? await this.getClientVideoData(d)
                  : await this.getDiskVideoData(d));
          }
          async getVideoId(d) {
            if (d.pathname.startsWith(this.CLIENT_PREFIX))
        ...
        class VKHelper extends g.q {
          ...
          async getVideoData(d) {
            ...
            try {
              let { description: p, duration: m, md_title: h } = f.vars,
                g = new DOMParser(),
                _ = g.parseFromString(p, "text/html"),
                v = Array.from(_.body.childNodes)
                  .filter((d) => d.nodeName !== "BR")
                  .map((d) => d.textContent)
                  .join("\n"),
                b;
              return (
                Object.hasOwn(f.vars, "subs") &&
                  (b = f.vars.subs.map((d) => ({
                    language: (0, x.ec)(d.lang),
                    source: "vk",
                    format: "vtt",
              ...
              return (
                _.A.error(`Failed to get VK video data, because: ${f.message}`),
                this.returnBaseData(d)
              );
            }
          }
          async getVideoId(d) {
            ...
            let p = /\/playlist\/[^/]+\/(video-?\d{8,9}_\d{9})/.exec(
              d.pathname,
            );
            if (p) return p[1];
            let m = d.searchParams.get("z");
            if (m) return m.split("/")[0];
            let h = d.searchParams.get("oid"),
              g = d.searchParams.get("id");
            if (h && g) return `video-${Math.abs(parseInt(h))}_${g}`;
          }
        }
        class TrovoHelper extends g.q {
          async getVideoId(d) {
            let f = d.searchParams.get("vid"),
              p = /([^/]+)\/([\d]+)/.exec(d.pathname)?.[0];
        ...
        class IncestflixHelper extends g.q {
          async getVideoData(d) {
            try {
              ...
              return (
                p.searchParams.append("media-proxy", "video.mp4"),
                { url: (0, x.fl)(p) }
              );
            } catch (f) {
              _.A.error(
                `Failed to get Incestflix data by videoId: ${d}`,
                f.message,
              );
              return;
            }
        ...
        class PornTNHelper extends g.q {
          async getVideoData(d) {
            try {
              ...
              let m = new URL(f);
              m.searchParams.append("rnd", d),
                _.A.log("PornTN get_file link", m.href);
              let h = await this.fetch(m.href, { method: "head" }),
                v = new URL(h.url);
              ...
              _.A.error(
                `Failed to get PornTN data by videoId: ${d}`,
                f.message,
              );
              return;
            }
        ...
        class BilibiliHelper extends g.q {
          async getVideoId(d) {
            ...
            return (
              m &&
                d.searchParams.get("p") !== null &&
                (m += `/?p=${d.searchParams.get("p")}`),
              m
            );
          }
        }
        ...
        class DailymotionHelper extends g.q {
          async getVideoId(d) {
            let f = Array.from(document.querySelectorAll("*")).filter((d) =>
                d.innerHTML.trim().includes(".m3u8"),
              ),
              p = f?.[1]?.lastChild?.src;
        ...
        class TwitterHelper extends g.q {
          async getVideoId(d) {
            ...
            if (f) return f;
            let p = this.video?.closest('[data-testid="tweet"]'),
              m = p?.querySelector('a[role="link"][aria-label]')?.href;
        ...
        class PornhubHelper extends g.q {
          async getVideoId(d) {
            return (
              d.searchParams.get("viewkey") ??
              /embed\/([^/]+)/.exec(d.pathname)?.[1]
            );
          }
        }
        ...
        class NineGAGHelper extends g.q {
          async getVideoData(d) {
            ...
            try {
              ...
              let d = this.video.querySelector(
                'source[type^="video/mp4"], source[type^="video/webm"]',
              )?.src;
              if (!d || !/^https?:\/\//.test(d))
                throw Error("Video source not found");
              return {
                ...f,
                translationHelp: [
                  {
        ...
        class UdemyHelper extends g.q {
          ...
          getModuleData() {
            let d = document.querySelector(
              ...
              f = d?.dataset?.moduleArgs;
            if (f) return JSON.parse(f);
          }
          getLectureId() {
            return /learn\/lecture\/([^/]+)/.exec(
          ...
          async getLectureData(d, f) {
            try {
              let p = await this.fetch(
                  `${this.API_ORIGIN}/users/me/subscribed-courses/${d}/lectures/${f}/?` +
                    new URLSearchParams({
                ...
                m = await p.json();
              if (this.isErrorData(m))
                throw new g.a(m.detail ?? "unknown error");
              return m;
            } catch (p) {
              _.A.error(
                `Failed to get lecture data by courseId: ${d} and lectureId: ${f}`,
                p.message,
              );
              return;
            }
          ...
          async getCourseLang(d) {
            try {
              let f = await this.fetch(
                  `${this.API_ORIGIN}/users/me/subscribed-courses/${d}?` +
                    new URLSearchParams({
                      "fields[course]": "locale",
                    }).toString(),
                ),
                p = await f.json();
              if (this.isErrorData(p))
                throw new g.a(p.detail ?? "unknown error");
              return p;
            } catch (f) {
              _.A.error(
                `Failed to get course lang by courseId: ${d}`,
                f.message,
              );
              return;
            }
          ...
          findSubtitleUrl(d, f) {
            let p =
              d?.find((d) => (0, x.ec)(d.locale_id) === f) ??
              d?.find((d) => (0, x.ec)(d.locale_id) === "en") ??
              d?.[0];
            return p?.url;
          }
          async getVideoData(d) {
            ...
            let { courseId: p } = f,
              m = this.getLectureId();
            if ((_.A.log(`[Udemy] courseId: ${p}, lectureId: ${m}`), !m))
              return;
            let h = await this.getLectureData(p, m);
            if (!h) return;
            let { title: g, description: v, asset: b } = h,
              { length: C, media_sources: T, captions: E } = b,
              D = this.findVideoUrl(T);
            if (!D) {
              _.A.log("Failed to find .mp4 video file in media_sources", T);
              return;
            }
            let O = "en",
              A = await this.getCourseLang(p);
            if (A) {
              let {
                locale: { locale: d },
              } = A;
            ...
            return (
              j || _.A.log("Failed to find subtitle file in captions", E),
              {
                ...(j
                  ? {
                      url: this.service?.url + d,
        ...
        class CourseraHelper extends VideoJSHelper {
          ...
          async getCourseData(d) {
            try {
              let f = await this.fetch(
                  `${this.API_ORIGIN}/onDemandCourses.v1/${d}`,
                ),
                p = await f.json();
              return p?.elements?.[0];
            } catch (f) {
              _.A.error(
                `Failed to get course data by courseId: ${d}`,
                f.message,
              );
              return;
            }
          ...
          async getVideoData(d) {
            ...
            if (!m) return f;
            let h = "en",
              g = await this.getCourseData(m);
            if (g) {
              let {
                primaryLanguageCodes: [d],
              } = g;
              h = d ? (0, x.ec)(d) : "en";
            }
            w.xm.includes(h) || (h = "en");
            let v =
                f.subtitles.find((d) => d.language === h) ?? f.subtitles?.[0],
              b = v?.url;
            b || _.A.warn("Failed to find any subtitle file");
            let { url: C, duration: T } = f,
              E = b
                ? [
                    {
                      target: "subtitles_file_url",
          ...
          async getVideoId(d) {
            let f =
              /learn\/([^/]+)\/lecture\/([^/]+)/.exec(d.pathname) ??
              /lecture\/([^/]+)\/([^/]+)/.exec(d.pathname);
            return f?.[0];
          }
        }
        ...
        class DouyinHelper extends g.q {
          ...
          async getVideoData(d) {
            ...
            if (!f) return;
            let {
              config: { url: p, duration: m, lang: h, isLive: g },
            } = f;
            if (!p) return;
            let _ = p.find((d) =>
              d.src.includes("www.douyin.com/aweme/v1/play/"),
            );
            if (_)
              return {
                url: (0, x.fl)(_.src),
        ...
        class LoomHelper extends g.q {
          ...
          async getVideoData(d) {
            try {
              ...
              if (p.status !== 200)
                throw new g.a("Failed to get data from graphql");
              let m = await p.json(),
                h = m.data.fetchVideoTranscript;
              ...
              return (
                _.A.error(
                  `Failed to get Loom video data, because: ${f.message}`,
                ),
                this.returnBaseData(d)
              );
            }
        ...
        class ArtstationHelper extends g.q {
          ...
          getCSRFToken() {
            return document.querySelector('meta[name="public-csrf-token"]')
              ?.content;
          }
          async getCourseInfo(d) {
            try {
              let f = await this.fetch(
                `${this.API_ORIGIN}/courses/${d}/autoplay.json`,
                {
                  method: "POST",
              ...
              return (
                _.A.error(
                  `Failed to get artstation course info by courseId: ${d}.`,
                  f.message,
                ),
                !1
              );
          ...
          async getVideoUrl(d) {
            try {
              let f = await this.fetch(
                  `${this.API_ORIGIN}/quicksilver/video_url.json?chapter_id=${d}`,
                ),
                p = await f.json();
              ...
              return (
                _.A.error(
                  `Failed to get artstation video url by chapterId: ${d}.`,
                  f.message,
                ),
                !1
              );
          ...
          async getVideoData(d) {
            let [, f, , , p] = d.split("/"),
              m = await this.getCourseInfo(f);
            if (!m) return;
            let h = m.chapters.find((d) => d.hash_id === p);
            if (!h) return;
            let g = await this.getVideoUrl(h.id);
            if (!g) return;
            let { title: _, duration: v, subtitles: b } = h,
              C = b
                .filter((d) => d.format === "vtt")
                .map((d) => ({
        ...
        class BitviewHelper extends g.q {
          async getVideoData(d) {
            try {
              ...
              _.A.error(
                `Failed to get Bitview data by videoId: ${d}`,
                f.message,
              );
              return;
            }
        ...
        class KickstarterHelper extends g.q {
          async getVideoData(d) {
            try {
              let d = document.querySelector(".ksr-video-player > video"),
                f = d?.querySelector("source[type^='video/mp4']")?.src;
              if (!f) throw new g.a("Failed to find video URL");
              let p = d?.querySelectorAll("track") ?? [];
              return {
                url: f,
                subtitles: Array.from(p).reduce((d, f) => {
                  let p = f.getAttribute("srclang"),
                    m = f.getAttribute("src");
                  return (
                    !p ||
                      !m ||
                      d.push({
              ...
              _.A.error(
                `Failed to get Kickstarter data by videoId: ${d}`,
                f.message,
              );
              return;
            }
        ...
        class IgnHelper extends g.q {
          ...
          getVideoDataByNext(d) {
            try {
              ...
              let f = JSON.parse(d),
                ...
                _ = g.find(
                  (d) => d.height === 360 && d.url.includes(".mp4"),
                )?.url;
              ...
              return (
                _.A.warn(
                  `Failed to get ign video data by video ID: ${d}, because ${f.message}. Using clear link instead...`,
                ),
                this.returnBaseData(d)
              );
            }
          ...
          async getVideoData(d) {
            return document.getElementById("__NEXT_DATA__")
              ? this.getVideoDataByNext(d)
              : this.getVideoDataBySource(d);
          }
          async getVideoId(d) {
            return (
              /([^/]+)\/([\d]+)\/video\/([^/]+)/.exec(d.pathname)?.[0] ??
              /\/videos\/([^/]+)/.exec(d.pathname)?.[0]
            );
          }
        }
        ...
        class TelegramHelper extends g.q {
          ...
          async getVideoId(d) {
            ...
            let m = p.media;
            if (m._ !== "messageMediaDocument" || m.document.type !== "video")
              return;
            let h = p.mid & 4294967295,
              g = await f.managers.appPeersManager.getPeerUsername(p.peerId);
            return `${g}/${h}`;
          }
        }
      ...
      "./node_modules/@vot.js/ext/dist/helpers/youtube.js": (d, f, p) => {
        ...
        var m = p("./node_modules/@vot.js/ext/dist/helpers/base.js"),
          h = p("./node_modules/@vot.js/shared/dist/utils/logger.js"),
          g = p("./node_modules/@vot.js/shared/dist/utils/utils.js"),
          _ = p("./node_modules/@vot.js/shared/dist/data/consts.js");
        class YoutubeHelper extends m.q {
          ...
          static getSubtitles(d) {
            let f = YoutubeHelper.getPlayerResponse(),
              p = f?.captions?.playerCaptionsTracklistRenderer;
            if (!p) return [];
            let m = p.captionTracks ?? [],
              _ = p.translationLanguages ?? [],
              v = _.find((f) => f.languageCode === d),
              b = m.find((d) => d?.kind === "asr"),
              x = b?.languageCode ?? "en",
              C = m.reduce((f, p) => {
                if (!("languageCode" in p)) return f;
                let m = p.languageCode ? (0, g.ec)(p.languageCode) : void 0,
                  h = p.baseUrl;
                if (!m || !h) return f;
          ...
          static getLanguage() {
            if (!YoutubeHelper.isMobile()) {
              let d = YoutubeHelper.getPlayer(),
                f = d?.getAudioTrack?.call(void 0)?.getLanguageInfo();
              if (f && f.id !== "und") return (0, g.ec)(f.id.split(".")[0]);
            }
            let d = YoutubeHelper.getPlayerResponse(),
              f =
                d?.captions?.playerCaptionsTracklistRenderer.captionTracks.find(
                  (d) => d.kind === "asr" && d.languageCode,
                );
            return f ? (0, g.ec)(f.languageCode) : void 0;
          }
          async getVideoData(d) {
            let { title: f } = YoutubeHelper.getPlayerData() ?? {},
              {
                shortDescription: p,
                isLive: m,
                title: h,
              } = YoutubeHelper.getPlayerResponse()?.videoDetails ?? {},
              g = YoutubeHelper.getSubtitles(this.language),
              v = YoutubeHelper.getLanguage();
            v && !_.xm.includes(v) && (v = void 0);
            let b =
              YoutubeHelper.getPlayer()?.getDuration?.call(void 0) ?? void 0;
            return {
              url: this.service.url + d,
              isStream: m,
              title: h,
          ...
          async getVideoId(d) {
            if (
              (d.hostname === "youtu.be" &&
                ((d.search = `?v=${d.pathname.replace("/", "")}`),
                (d.pathname = "/watch")),
              d.searchParams.has("enablejsapi"))
            ) {
              let f = YoutubeHelper.getPlayer()?.getVideoUrl();
              d = f ? new URL(f) : d;
            }
            return (
              /(?:watch|embed|shorts|live)\/([^/]+)/.exec(d.pathname)?.[1] ??
              d.searchParams.get("v")
            );
          }
        }
      },
      "./node_modules/@vot.js/ext/dist/index.js": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/@vot.js/ext/dist/client.js"),
              g = p("./node_modules/@vot.js/ext/dist/utils/videoData.js"),
              _ = p("./node_modules/@vot.js/ext/dist/data/sites.js"),
              v = p("./node_modules/@vot.js/ext/dist/types/index.js"),
              b = p("./node_modules/@vot.js/ext/dist/helpers/index.js"),
              x = d([h]);
      ...
      "./node_modules/@vot.js/ext/dist/types/service.js": (d, f, p) => {
        ...
        (function (d) {
          (d.udemy = "udemy"),
            (d.coursera = "coursera"),
            (d.douyin = "douyin"),
            (d.artstation = "artstation"),
            (d.kickstarter = "kickstarter"),
            (d.oraclelearn = "oraclelearn");
        })((h ||= {}));
        let g = {
          ...m.r,
          ...h,
      ...
      "./node_modules/@vot.js/ext/dist/utils/videoData.js": (d, f, p) => {
        ...
        var m = p("./node_modules/@vot.js/core/dist/types/service.js"),
          h = p("./node_modules/@vot.js/core/dist/utils/videoData.js"),
          g = p("./node_modules/@vot.js/ext/dist/data/sites.js"),
          _ = p("./node_modules/@vot.js/ext/dist/helpers/index.js");
        function getService() {
          ...
          return g.A.filter(
            (d) =>
              (Array.isArray(d.match)
                ? d.match.some(isMathes)
                : isMathes(d.match)) &&
              d.host &&
              d.url,
          );
      ...
      "./node_modules/@vot.js/shared/dist/data/alternativeUrls.js": (
        ...
        let m = [
          ...
          b = ["ricktube.ru"],
          x = null,
          C = ["coursehunter.net", "coursetrain.net"];
      },
      ...
      "./node_modules/@vot.js/shared/dist/index.js": (d, f, p) => {
        ...
        var m = p("./node_modules/@vot.js/shared/dist/data/config.js"),
          h = p("./node_modules/@vot.js/shared/dist/protos/yandex.js"),
          g = p("./node_modules/@vot.js/shared/dist/utils/logger.js"),
          _ = p("./node_modules/@vot.js/shared/dist/utils/utils.js"),
          v = p("./node_modules/@vot.js/shared/dist/types/logger.js"),
          b;
        (function (d) {
      ...
      "./node_modules/@vot.js/shared/dist/protos/yandex.js": (d, f, p) => {
        ...
        function uInt64ToString(d, f) {
          if ((({ lo: d, hi: f } = toUnsigned(d, f)), f <= 2097151))
            return String(m * f + d);
          let p = d & 16777215,
            h = ((d >>> 24) | (f << 8)) & 16777215,
            g = (f >> 16) & 65535,
            _ = p + h * 6777216 + g * 6710656,
            v = h + g * 8147497,
            b = g * 2,
            x = 1e7;
          return (
            _ >= x && ((v += Math.floor(_ / x)), (_ %= x)),
            v >= x && ((b += Math.floor(v / x)), (v %= x)),
            b.toString() +
              decimalFrom1e7WithLeadingZeros(v) +
              decimalFrom1e7WithLeadingZeros(_)
          );
        }
        ...
        function varint32read() {
          ...
          if (
            !(d & 128) ||
            ((d = this.buf[this.pos++]), (f |= (d & 127) << 7), !(d & 128)) ||
            ((d = this.buf[this.pos++]), (f |= (d & 127) << 14), !(d & 128)) ||
            ((d = this.buf[this.pos++]), (f |= (d & 127) << 21), !(d & 128))
          )
        ...
        function makeInt64Support() {
          let d = new DataView(new ArrayBuffer(8)),
            f =
              ...
              typeof d.getBigInt64 == "function" &&
              typeof d.getBigUint64 == "function" &&
              typeof d.setBigInt64 == "function" &&
              typeof d.setBigUint64 == "function" &&
              (typeof process != "object" ||
                typeof process.env != "object" ||
                process.env.BUF_BIGINT_DISABLE !== "1");
          if (f) {
            let f = BigInt("-9223372036854775808"),
              p = BigInt("9223372036854775807"),
              m = BigInt("0"),
            ...
            return {
              ...
              enc(f) {
                return (
                  d.setBigInt64(0, this.parse(f), !0),
                  {
                    lo: d.getInt32(0, !0),
                    hi: d.getInt32(4, !0),
                  }
              ...
              uEnc(f) {
                return (
                  d.setBigInt64(0, this.uParse(f), !0),
                  {
                    lo: d.getInt32(0, !0),
                    hi: d.getInt32(4, !0),
                  }
        ...
        function getTextEncoding() {
          if (globalThis[g] == null) {
            let d = new globalThis.TextEncoder(),
              f = new globalThis.TextDecoder();
            globalThis[g] = {
              encodeUtf8(f) {
                return d.encode(f);
              },
        ...
        (function (d) {
          (d[(d.Varint = 0)] = "Varint"),
            (d[(d.Bit64 = 1)] = "Bit64"),
            (d[(d.LengthDelimited = 2)] = "LengthDelimited"),
            (d[(d.StartGroup = 3)] = "StartGroup"),
            (d[(d.EndGroup = 4)] = "EndGroup"),
            (d[(d.Bit32 = 5)] = "Bit32");
        })((_ ||= {}));
        let v = 34028234663852886e22,
        ...
        class BinaryWriter {
          ...
          finish() {
            ...
            for (let f = 0; f < this.chunks.length; f++)
              d += this.chunks[f].length;
            let f = new Uint8Array(d),
              p = 0;
            for (let d = 0; d < this.chunks.length; d++)
              f.set(this.chunks[d], p), (p += this.chunks[d].length);
          ...
          uint32(d) {
            for (assertUInt32(d); d > 127; )
              this.buf.push((d & 127) | 128), (d >>>= 7);
          ...
          sfixed64(d) {
            let f = new Uint8Array(8),
              ...
              m = h.enc(d);
            return (
              p.setInt32(0, m.lo, !0), p.setInt32(4, m.hi, !0), this.raw(f)
            );
          }
          fixed64(d) {
            let f = new Uint8Array(8),
        ...
        class BinaryReader {
          ...
          tag() {
            let d = this.uint32(),
              ...
              p = d & 7;
            if (f <= 0 || p < 0 || p > 5)
              throw Error("illegal tag: field no " + f + " wire type " + p);
            return [f, p];
          }
          skip(d, f) {
            let p = this.pos;
            switch (d) {
              ...
              case _.StartGroup:
                ...
                break;
              default:
                throw Error("cant skip wire type " + d);
            }
          ...
          bytes() {
            let d = this.uint32(),
              f = this.pos;
            return (
              (this.pos += d), this.assertBounds(), this.buf.subarray(f, f + d)
            );
          }
          string() {
        ...
        function assertInt32(d) {
          if (typeof d == "string") d = Number(d);
            ...
            throw Error("invalid int32: " + typeof d);
          if (!Number.isInteger(d) || d > C || d < w)
            throw Error("invalid int32: " + d);
        }
        function assertUInt32(d) {
          if (typeof d == "string") d = Number(d);
          else if (typeof d != "number")
            throw Error("invalid uint32: " + typeof d);
          if (!Number.isInteger(d) || d > x || d < 0)
            throw Error("invalid uint32: " + d);
        }
        function assertFloat32(d) {
          if (typeof d == "string") {
            let f = d;
            if (((d = Number(d)), isNaN(d) && f !== "NaN"))
              throw Error("invalid float32: " + f);
          } else if (typeof d != "number")
            throw Error("invalid float32: " + typeof d);
          if (Number.isFinite(d) && (d > v || d < b))
            throw Error("invalid float32: " + d);
        }
        let T = "";
        var E;
        (function (d) {
          (d[(d.NO_CONNECTION = 0)] = "NO_CONNECTION"),
            (d[(d.TRANSLATING = 10)] = "TRANSLATING"),
            (d[(d.STREAMING = 20)] = "STREAMING"),
        ...
        let D = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.target !== "" && f.uint32(10).string(d.target),
              d.targetUrl !== "" && f.uint32(18).string(d.targetUrl),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseVideoTranslationHelpObject();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
          ...
          fromJSON(d) {
            return {
              ...
              targetUrl: isSet(d.targetUrl)
                ? globalThis.String(d.targetUrl)
                : "",
            };
          },
          toJSON(d) {
            ...
            return (
              ...
              d.targetUrl !== "" && (f.targetUrl = d.targetUrl),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              (f.target = d.target ?? ""), (f.targetUrl = d.targetUrl ?? ""), f
            );
          },
        };
        ...
        let O = {
          encode(d, f = new BinaryWriter()) {
            d.url !== "" && f.uint32(26).string(d.url),
              d.deviceId !== void 0 && f.uint32(34).string(d.deviceId),
              d.firstRequest !== !1 && f.uint32(40).bool(d.firstRequest),
              d.duration !== 0 && f.uint32(49).double(d.duration),
              d.unknown0 !== 0 && f.uint32(56).int32(d.unknown0),
              d.language !== "" && f.uint32(66).string(d.language),
              d.forceSourceLang !== !1 && f.uint32(72).bool(d.forceSourceLang),
              d.unknown1 !== 0 && f.uint32(80).int32(d.unknown1);
            for (let p of d.translationHelp)
              D.encode(p, f.uint32(90).fork()).join();
            return (
              d.wasStream !== !1 && f.uint32(104).bool(d.wasStream),
              d.responseLanguage !== "" &&
                f.uint32(114).string(d.responseLanguage),
              d.unknown2 !== 0 && f.uint32(120).int32(d.unknown2),
              d.unknown3 !== 0 && f.uint32(128).int32(d.unknown3),
              d.bypassCache !== !1 && f.uint32(136).bool(d.bypassCache),
              d.useLivelyVoice !== !1 && f.uint32(144).bool(d.useLivelyVoice),
              d.videoTitle !== "" && f.uint32(154).string(d.videoTitle),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseVideoTranslationRequest();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 3:
          ...
          fromJSON(d) {
            return {
              ...
              deviceId: isSet(d.deviceId)
                ? globalThis.String(d.deviceId)
                : void 0,
              firstRequest: isSet(d.firstRequest)
                ? globalThis.Boolean(d.firstRequest)
                : !1,
              ...
              forceSourceLang: isSet(d.forceSourceLang)
                ? globalThis.Boolean(d.forceSourceLang)
                : !1,
              unknown1: isSet(d.unknown1) ? globalThis.Number(d.unknown1) : 0,
              translationHelp: globalThis.Array.isArray(d?.translationHelp)
                ? d.translationHelp.map((d) => D.fromJSON(d))
                : [],
              wasStream: isSet(d.wasStream)
                ? globalThis.Boolean(d.wasStream)
                : !1,
              responseLanguage: isSet(d.responseLanguage)
                ? globalThis.String(d.responseLanguage)
                : "",
              unknown2: isSet(d.unknown2) ? globalThis.Number(d.unknown2) : 0,
              unknown3: isSet(d.unknown3) ? globalThis.Number(d.unknown3) : 0,
              bypassCache: isSet(d.bypassCache)
                ? globalThis.Boolean(d.bypassCache)
                : !1,
              useLivelyVoice: isSet(d.useLivelyVoice)
                ? globalThis.Boolean(d.useLivelyVoice)
                : !1,
              videoTitle: isSet(d.videoTitle)
                ? globalThis.String(d.videoTitle)
                : "",
            };
          },
          toJSON(d) {
            ...
            return (
              d.url !== "" && (f.url = d.url),
              d.deviceId !== void 0 && (f.deviceId = d.deviceId),
              d.firstRequest !== !1 && (f.firstRequest = d.firstRequest),
              d.duration !== 0 && (f.duration = d.duration),
              d.unknown0 !== 0 && (f.unknown0 = Math.round(d.unknown0)),
              d.language !== "" && (f.language = d.language),
              d.forceSourceLang !== !1 &&
                (f.forceSourceLang = d.forceSourceLang),
              d.unknown1 !== 0 && (f.unknown1 = Math.round(d.unknown1)),
              d.translationHelp?.length &&
                (f.translationHelp = d.translationHelp.map((d) => D.toJSON(d))),
              d.wasStream !== !1 && (f.wasStream = d.wasStream),
              d.responseLanguage !== "" &&
                (f.responseLanguage = d.responseLanguage),
              d.unknown2 !== 0 && (f.unknown2 = Math.round(d.unknown2)),
              d.unknown3 !== 0 && (f.unknown3 = Math.round(d.unknown3)),
              d.bypassCache !== !1 && (f.bypassCache = d.bypassCache),
              d.useLivelyVoice !== !1 && (f.useLivelyVoice = d.useLivelyVoice),
              d.videoTitle !== "" && (f.videoTitle = d.videoTitle),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              (f.url = d.url ?? ""),
              (f.deviceId = d.deviceId ?? void 0),
              (f.firstRequest = d.firstRequest ?? !1),
              (f.duration = d.duration ?? 0),
              (f.unknown0 = d.unknown0 ?? 0),
              (f.language = d.language ?? ""),
              (f.forceSourceLang = d.forceSourceLang ?? !1),
              (f.unknown1 = d.unknown1 ?? 0),
              (f.translationHelp =
                d.translationHelp?.map((d) => D.fromPartial(d)) || []),
              (f.wasStream = d.wasStream ?? !1),
              (f.responseLanguage = d.responseLanguage ?? ""),
              (f.unknown2 = d.unknown2 ?? 0),
              (f.unknown3 = d.unknown3 ?? 0),
              (f.bypassCache = d.bypassCache ?? !1),
              (f.useLivelyVoice = d.useLivelyVoice ?? !1),
              (f.videoTitle = d.videoTitle ?? ""),
              f
            );
          },
        };
        ...
        let A = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.url !== void 0 && f.uint32(10).string(d.url),
              d.duration !== void 0 && f.uint32(17).double(d.duration),
              d.status !== 0 && f.uint32(32).int32(d.status),
              d.remainingTime !== void 0 && f.uint32(40).int32(d.remainingTime),
              d.unknown0 !== void 0 && f.uint32(48).int32(d.unknown0),
              d.translationId !== "" && f.uint32(58).string(d.translationId),
              d.language !== void 0 && f.uint32(66).string(d.language),
              d.message !== void 0 && f.uint32(74).string(d.message),
              d.isLivelyVoice !== !1 && f.uint32(80).bool(d.isLivelyVoice),
              d.unknown2 !== void 0 && f.uint32(88).int32(d.unknown2),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseVideoTranslationResponse();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
          ...
          fromJSON(d) {
            return {
              ...
              duration: isSet(d.duration)
                ? globalThis.Number(d.duration)
                : void 0,
              status: isSet(d.status) ? globalThis.Number(d.status) : 0,
              remainingTime: isSet(d.remainingTime)
                ? globalThis.Number(d.remainingTime)
                : void 0,
              unknown0: isSet(d.unknown0)
                ? globalThis.Number(d.unknown0)
                : void 0,
              translationId: isSet(d.translationId)
                ? globalThis.String(d.translationId)
                : "",
              language: isSet(d.language)
                ? globalThis.String(d.language)
                : void 0,
              message: isSet(d.message) ? globalThis.String(d.message) : void 0,
              isLivelyVoice: isSet(d.isLivelyVoice)
                ? globalThis.Boolean(d.isLivelyVoice)
                : !1,
              unknown2: isSet(d.unknown2)
                ? globalThis.Number(d.unknown2)
                : void 0,
            };
          },
          toJSON(d) {
            let f = {};
            return (
              d.url !== void 0 && (f.url = d.url),
              d.duration !== void 0 && (f.duration = d.duration),
              d.status !== 0 && (f.status = Math.round(d.status)),
              d.remainingTime !== void 0 &&
                (f.remainingTime = Math.round(d.remainingTime)),
              d.unknown0 !== void 0 && (f.unknown0 = Math.round(d.unknown0)),
              d.translationId !== "" && (f.translationId = d.translationId),
              d.language !== void 0 && (f.language = d.language),
              d.message !== void 0 && (f.message = d.message),
              d.isLivelyVoice !== !1 && (f.isLivelyVoice = d.isLivelyVoice),
              d.unknown2 !== void 0 && (f.unknown2 = Math.round(d.unknown2)),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              (f.url = d.url ?? void 0),
              (f.duration = d.duration ?? void 0),
              (f.status = d.status ?? 0),
              (f.remainingTime = d.remainingTime ?? void 0),
              (f.unknown0 = d.unknown0 ?? void 0),
              (f.translationId = d.translationId ?? ""),
              (f.language = d.language ?? void 0),
              (f.message = d.message ?? void 0),
              (f.isLivelyVoice = d.isLivelyVoice ?? !1),
              (f.unknown2 = d.unknown2 ?? void 0),
              f
            );
          },
        };
        ...
        let j = {
          encode(d, f = new BinaryWriter()) {
            return (
              ...
              d.remainingTime !== void 0 && f.uint32(16).int32(d.remainingTime),
              d.message !== void 0 && f.uint32(26).string(d.message),
              d.unknown0 !== void 0 && f.uint32(32).int32(d.unknown0),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseVideoTranslationCacheItem();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
        ...
        let F = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.url !== "" && f.uint32(10).string(d.url),
              d.duration !== 0 && f.uint32(17).double(d.duration),
              d.language !== "" && f.uint32(26).string(d.language),
              d.responseLanguage !== "" &&
                f.uint32(34).string(d.responseLanguage),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseVideoTranslationCacheRequest();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
        ...
        let U = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.default !== void 0 &&
                j.encode(d.default, f.uint32(10).fork()).join(),
              d.cloning !== void 0 &&
                j.encode(d.cloning, f.uint32(18).fork()).join(),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseVideoTranslationCacheResponse();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
          ...
          toJSON(d) {
            let f = {};
            return (
              d.default !== void 0 && (f.default = j.toJSON(d.default)),
              d.cloning !== void 0 && (f.cloning = j.toJSON(d.cloning)),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              (f.default =
                d.default !== void 0 && d.default !== null
                  ? j.fromPartial(d.default)
                  : void 0),
              (f.cloning =
                d.cloning !== void 0 && d.cloning !== null
                  ? j.fromPartial(d.cloning)
                  : void 0),
              f
            );
          },
        ...
        let W = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.audioFile.length !== 0 && f.uint32(18).bytes(d.audioFile),
              d.fileId !== "" && f.uint32(10).string(d.fileId),
              f
            );
          },
          decode(d, f) {
          ...
          fromJSON(d) {
            return {
              audioFile: isSet(d.audioFile)
                ? bytesFromBase64(d.audioFile)
                : new Uint8Array(),
          ...
          toJSON(d) {
            let f = {};
            return (
              d.audioFile.length !== 0 &&
                (f.audioFile = base64FromBytes(d.audioFile)),
              d.fileId !== "" && (f.fileId = d.fileId),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              (f.audioFile = d.audioFile ?? new Uint8Array()),
              (f.fileId = d.fileId ?? ""),
              f
            );
          },
        ...
        let G = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.audioFile.length !== 0 && f.uint32(18).bytes(d.audioFile),
              d.chunkId !== 0 && f.uint32(8).int32(d.chunkId),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBasePartialAudioBufferObject();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 2:
          ...
          toJSON(d) {
            ...
            return (
              d.audioFile.length !== 0 &&
                (f.audioFile = base64FromBytes(d.audioFile)),
              d.chunkId !== 0 && (f.chunkId = Math.round(d.chunkId)),
              f
            );
          },
          create(d) {
        ...
        let K = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.audioBuffer !== void 0 &&
                G.encode(d.audioBuffer, f.uint32(10).fork()).join(),
              d.audioPartsLength !== 0 &&
                f.uint32(16).int32(d.audioPartsLength),
              d.fileId !== "" && f.uint32(26).string(d.fileId),
              d.version !== 0 && f.uint32(32).int32(d.version),
              f
            );
          },
          decode(d, f) {
          ...
          fromJSON(d) {
            return {
              audioBuffer: isSet(d.audioBuffer)
                ? G.fromJSON(d.audioBuffer)
                : void 0,
              audioPartsLength: isSet(d.audioPartsLength)
                ? globalThis.Number(d.audioPartsLength)
                : 0,
              fileId: isSet(d.fileId) ? globalThis.String(d.fileId) : "",
          ...
          toJSON(d) {
            ...
            return (
              d.audioBuffer !== void 0 &&
                (f.audioBuffer = G.toJSON(d.audioBuffer)),
              d.audioPartsLength !== 0 &&
                (f.audioPartsLength = Math.round(d.audioPartsLength)),
              d.fileId !== "" && (f.fileId = d.fileId),
              d.version !== 0 && (f.version = Math.round(d.version)),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              (f.audioBuffer =
                d.audioBuffer !== void 0 && d.audioBuffer !== null
                  ? G.fromPartial(d.audioBuffer)
                  : void 0),
              (f.audioPartsLength = d.audioPartsLength ?? 0),
              (f.fileId = d.fileId ?? ""),
              (f.version = d.version ?? 0),
              f
            );
          },
        };
        ...
        let q = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.translationId !== "" && f.uint32(10).string(d.translationId),
              d.url !== "" && f.uint32(18).string(d.url),
              d.partialAudioInfo !== void 0 &&
                K.encode(d.partialAudioInfo, f.uint32(34).fork()).join(),
              d.audioInfo !== void 0 &&
                W.encode(d.audioInfo, f.uint32(50).fork()).join(),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseVideoTranslationAudioRequest();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
          ...
          fromJSON(d) {
            return {
              translationId: isSet(d.translationId)
                ...
                : "",
              url: isSet(d.url) ? globalThis.String(d.url) : "",
              partialAudioInfo: isSet(d.partialAudioInfo)
                ? K.fromJSON(d.partialAudioInfo)
                : void 0,
          ...
          toJSON(d) {
            ...
            return (
              ...
              d.url !== "" && (f.url = d.url),
              d.partialAudioInfo !== void 0 &&
                (f.partialAudioInfo = K.toJSON(d.partialAudioInfo)),
              d.audioInfo !== void 0 && (f.audioInfo = W.toJSON(d.audioInfo)),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              ...
              (f.url = d.url ?? ""),
              (f.partialAudioInfo =
                d.partialAudioInfo !== void 0 && d.partialAudioInfo !== null
                  ? K.fromPartial(d.partialAudioInfo)
                  : void 0),
              (f.audioInfo =
                d.audioInfo !== void 0 && d.audioInfo !== null
                  ? W.fromPartial(d.audioInfo)
                  : void 0),
              f
            );
          },
        ...
        let J = {
          ...
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseVideoTranslationAudioResponse();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
          ...
          fromJSON(d) {
            return {
              status: isSet(d.status) ? globalThis.Number(d.status) : 0,
              remainingChunks: globalThis.Array.isArray(d?.remainingChunks)
                ? d.remainingChunks.map((d) => globalThis.String(d))
                : [],
            };
          },
          toJSON(d) {
            ...
            return (
              d.status !== 0 && (f.status = Math.round(d.status)),
              d.remainingChunks?.length &&
                (f.remainingChunks = d.remainingChunks),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              (f.status = d.status ?? 0),
              (f.remainingChunks = d.remainingChunks?.map((d) => d) || []),
              f
            );
          },
        };
        ...
        let Y = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.language !== "" && f.uint32(10).string(d.language),
              d.url !== "" && f.uint32(18).string(d.url),
              d.unknown0 !== 0 && f.uint32(24).int32(d.unknown0),
              d.translatedLanguage !== "" &&
                f.uint32(34).string(d.translatedLanguage),
              d.translatedUrl !== "" && f.uint32(42).string(d.translatedUrl),
              d.unknown1 !== 0 && f.uint32(48).int32(d.unknown1),
              d.unknown2 !== 0 && f.uint32(56).int32(d.unknown2),
              f
            );
          },
          decode(d, f) {
          ...
          fromJSON(d) {
            return {
              ...
              url: isSet(d.url) ? globalThis.String(d.url) : "",
              unknown0: isSet(d.unknown0) ? globalThis.Number(d.unknown0) : 0,
              translatedLanguage: isSet(d.translatedLanguage)
                ? globalThis.String(d.translatedLanguage)
                : "",
              translatedUrl: isSet(d.translatedUrl)
                ? globalThis.String(d.translatedUrl)
                : "",
              unknown1: isSet(d.unknown1) ? globalThis.Number(d.unknown1) : 0,
              unknown2: isSet(d.unknown2) ? globalThis.Number(d.unknown2) : 0,
            };
          ...
          toJSON(d) {
            ...
            return (
              ...
              d.unknown0 !== 0 && (f.unknown0 = Math.round(d.unknown0)),
              d.translatedLanguage !== "" &&
                (f.translatedLanguage = d.translatedLanguage),
              d.translatedUrl !== "" && (f.translatedUrl = d.translatedUrl),
              d.unknown1 !== 0 && (f.unknown1 = Math.round(d.unknown1)),
              d.unknown2 !== 0 && (f.unknown2 = Math.round(d.unknown2)),
              f
            );
          ...
          fromPartial(d) {
            ...
            return (
              ...
              (f.unknown0 = d.unknown0 ?? 0),
              (f.translatedLanguage = d.translatedLanguage ?? ""),
              (f.translatedUrl = d.translatedUrl ?? ""),
              (f.unknown1 = d.unknown1 ?? 0),
              (f.unknown2 = d.unknown2 ?? 0),
              f
            );
        ...
        let X = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.url !== "" && f.uint32(10).string(d.url),
              d.language !== "" && f.uint32(18).string(d.language),
              f
            );
          },
          decode(d, f) {
        ...
        let Z = {
          ...
          fromJSON(d) {
            return {
              ...
              subtitles: globalThis.Array.isArray(d?.subtitles)
                ? d.subtitles.map((d) => Y.fromJSON(d))
                : [],
            };
          },
          toJSON(d) {
            let f = {};
            return (
              d.waiting !== !1 && (f.waiting = d.waiting),
              d.subtitles?.length &&
                (f.subtitles = d.subtitles.map((d) => Y.toJSON(d))),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              (f.waiting = d.waiting ?? !1),
              (f.subtitles = d.subtitles?.map((d) => Y.fromPartial(d)) || []),
              f
            );
          },
        };
        ...
        let Q = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.url !== "" && f.uint32(10).string(d.url),
              d.timestamp !== "" && f.uint32(18).string(d.timestamp),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseStreamTranslationObject();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
          ...
          fromJSON(d) {
            return {
              url: isSet(d.url) ? globalThis.String(d.url) : "",
              timestamp: isSet(d.timestamp)
                ? globalThis.String(d.timestamp)
                : "",
            };
          },
          toJSON(d) {
            ...
            return (
              d.url !== "" && (f.url = d.url),
              d.timestamp !== "" && (f.timestamp = d.timestamp),
              f
            );
          },
          create(d) {
        ...
        let $ = {
          encode(d, f = new BinaryWriter()) {
            return (
              ...
              d.language !== "" && f.uint32(18).string(d.language),
              d.responseLanguage !== "" &&
                f.uint32(26).string(d.responseLanguage),
              d.unknown0 !== 0 && f.uint32(40).int32(d.unknown0),
              d.unknown1 !== 0 && f.uint32(48).int32(d.unknown1),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseStreamTranslationRequest();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
        ...
        let ee = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.interval !== 0 && f.uint32(8).int32(d.interval),
              d.translatedInfo !== void 0 &&
                Q.encode(d.translatedInfo, f.uint32(18).fork()).join(),
              d.pingId !== void 0 && f.uint32(24).int32(d.pingId),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseStreamTranslationResponse();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
          ...
          fromJSON(d) {
            return {
              interval: isSet(d.interval)
                ? streamIntervalFromJSON(d.interval)
                : 0,
              translatedInfo: isSet(d.translatedInfo)
                ? Q.fromJSON(d.translatedInfo)
                : void 0,
          ...
          toJSON(d) {
            ...
            return (
              d.interval !== 0 &&
                (f.interval = streamIntervalToJSON(d.interval)),
              d.translatedInfo !== void 0 &&
                (f.translatedInfo = Q.toJSON(d.translatedInfo)),
              d.pingId !== void 0 && (f.pingId = Math.round(d.pingId)),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              (f.interval = d.interval ?? 0),
              (f.translatedInfo =
                d.translatedInfo !== void 0 && d.translatedInfo !== null
                  ? Q.fromPartial(d.translatedInfo)
                  : void 0),
              (f.pingId = d.pingId ?? void 0),
              f
            );
          },
        };
        ...
        let te = {
          ...
          fromJSON(d) {
            return {
              pingId: isSet(d.pingId) ? globalThis.Number(d.pingId) : 0,
            };
          },
          toJSON(d) {
            let f = {};
        ...
        let ne = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.uuid !== "" && f.uint32(10).string(d.uuid),
              d.module !== "" && f.uint32(18).string(d.module),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseYandexSessionRequest();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
          ...
          toJSON(d) {
            let f = {};
            return (
              d.uuid !== "" && (f.uuid = d.uuid),
              d.module !== "" && (f.module = d.module),
              f
            );
          },
          create(d) {
        ...
        let re = {
          encode(d, f = new BinaryWriter()) {
            return (
              d.secretKey !== "" && f.uint32(10).string(d.secretKey),
              d.expires !== 0 && f.uint32(16).int32(d.expires),
              f
            );
          },
          decode(d, f) {
            let p = d instanceof BinaryReader ? d : new BinaryReader(d),
              m = f === void 0 ? p.len : p.pos + f,
              h = createBaseYandexSessionResponse();
            for (; p.pos < m; ) {
              let d = p.uint32();
              switch (d >>> 3) {
                case 1:
          ...
          fromJSON(d) {
            return {
              secretKey: isSet(d.secretKey)
                ? globalThis.String(d.secretKey)
                : "",
          ...
          toJSON(d) {
            let f = {};
            return (
              d.secretKey !== "" && (f.secretKey = d.secretKey),
              d.expires !== 0 && (f.expires = Math.round(d.expires)),
              f
            );
          },
          create(d) {
          ...
          fromPartial(d) {
            ...
            return (
              (f.secretKey = d.secretKey ?? ""), (f.expires = d.expires ?? 0), f
            );
          },
        };
        function bytesFromBase64(d) {
          if (globalThis.Buffer)
            return Uint8Array.from(globalThis.Buffer.from(d, "base64"));
          {
            let f = globalThis.atob(d),
        ...
        function base64FromBytes(d) {
          if (globalThis.Buffer)
            return globalThis.Buffer.from(d).toString("base64");
          {
            let f = [];
            return (
              d.forEach((d) => {
      ...
      "./node_modules/@vot.js/shared/dist/secure.js": (d, f, p) => {
        ...
        async function getCrypto() {
          return typeof window < "u" && window.crypto
            ? window.crypto
        ...
        async function signHMAC(d, f, p) {
          let m = await getCrypto(),
            h = await m.subtle.importKey(
              "raw",
              _.encode(f),
              {
                name: "HMAC",
        ...
        async function getSignature(d) {
          ...
          return new Uint8Array(f).reduce(
            (d, f) => d + f.toString(16).padStart(2, "0"),
            "",
          );
        }
        async function getSecYaHeaders(d, f, p, h) {
          let { secretKey: g, uuid: v } = f,
            b = `${v}:${h}:${m.A.componentVersion}`,
            x = _.encode(b),
            C = await getSignature(x);
          if (d === "Ya-Summary")
            return {
              [`X-${d}-Sk`]: g,
              [`X-${d}-Token`]: `${C}:${b}`,
      ...
      "./node_modules/@vot.js/shared/dist/utils/logger.js": (d, f, p) => {
        ...
        p.d(f, { A: () => Logger });
        var m = p("./node_modules/@vot.js/shared/dist/data/config.js"),
          h = p("./node_modules/@vot.js/shared/dist/types/logger.js");
        class Logger {
      ...
      "./node_modules/@vot.js/shared/dist/utils/subs.js": (d, f, p) => {
          ...
          let p = f === "vtt",
            ...
            h = d.subtitles
              .map((d, f) => {
                ...
                return (
                  h +
                  `${convertToStrTime(d.startMs, m)} --> ${convertToStrTime(d.startMs + d.durationMs, m)}\n${d.text}\n\n`
                );
              })
              .join("")
              .trim();
        ...
        function convertSubs(d, f = "srt") {
          ...
          return p === f
            ? d
            : p === "json"
              ? convertSubsFromJSON(d, f)
              : ((d = convertSubsToJSON(d, p)),
                f === "json" ? d : convertSubsFromJSON(d, f));
        }
      },
      "./node_modules/@vot.js/shared/dist/utils/utils.js": (d, f, p) => {
        ...
        async function fetchWithTimeout(
          d,
          f = { headers: { "User-Agent": m.A.userAgent } },
        ) {
          let { timeout: p = 3e3, ...h } = f,
            g = new AbortController(),
            _ = setTimeout(() => g.abort(), p),
            v = await fetch(d, {
              signal: g.signal,
              ...h,
            });
        ...
        function normalizeLang(d) {
          return d.length === 3
            ? h[d]
            : d.toLowerCase().split(/[_;-]/)[0].trim();
        }
        function proxyMedia(d, f = "mp4") {
          let p = `https://${m.A.mediaProxy}/v1/proxy/video.${f}?format=base64&force=true`;
          return d instanceof URL
            ? `${p}&url=${btoa(d.href)}&origin=${d.origin}&referer=${d.origin}`
            : `${p}&url=${btoa(d)}`;
        }
      },
        ...
        (function (f, p) {
          ...
          return (function (d) {
            ...
            function r(p) {
              ...
              return (
                d[p].call(m.exports, m, m.exports, r), (m.l = !0), m.exports
              );
            }
            return (
              (r.m = d),
              ...
              (r.t = function (d, f) {
                if (
                  (1 & f && (d = r(d)),
                  8 & f || (4 & f && typeof d == "object" && d && d.__esModule))
                )
                  return d;
                ...
                h = (function () {
                  ...
                  return (
                    ...
                    (e.compareVersions = function (d, f, p) {
                      p === void 0 && (p = !1);
                      var m = e.getVersionPrecision(d),
                        h = e.getVersionPrecision(f),
                        g = Math.max(m, h),
                        _ = 0,
                        v = e.map([d, f], function (d) {
                          var f = g - e.getVersionPrecision(d),
                            p = d + Array(f + 1).join(".0");
                          return e
                            .map(p.split("."), function (d) {
                    ...
                    (e.find = function (d, f) {
                      ...
                      if (Array.prototype.find)
                        return Array.prototype.find.call(d, f);
                    ...
                    (e.assign = function (d) {
                      for (
                        ...
                        g[_ - 1] = arguments[_];
                      if (Object.assign)
                        return Object.assign.apply(Object, [d].concat(g));
                      var o = function () {
                        var d = g[f];
                        typeof d == "object" &&
                          d &&
            ...
            90: function (d, f, p) {
              ...
              (f.__esModule = !0), (f.default = void 0);
              var m,
                h = (m = p(91)) && m.__esModule ? m : { default: m },
                g = p(18);
              function a(d, f) {
              ...
              var _ = (function () {
                ...
                var d, f, p;
                return (
                  (e.getParser = function (d, f) {
                    if ((f === void 0 && (f = !1), typeof d != "string"))
                ...
                return (
                  ...
                  (d.parseBrowser = function () {
                    ...
                    var f = v.default.find(m.default, function (f) {
                      ...
                      if (f.test instanceof Array)
                        return f.test.some(function (f) {
                          return d.test(f);
                        });
                    ...
                    return (
                      f &&
                        (this.parsedResult.browser = f.describe(this.getUA())),
                      this.parsedResult.browser
                    );
                  }),
                  ...
                  (d.parsePlatform = function () {
                    ...
                    return (
                      f &&
                        (this.parsedResult.platform = f.describe(this.getUA())),
                      this.parsedResult.platform
                    );
                  }),
                  ...
                  (d.parseEngine = function () {
                    ...
                    return (
                      f &&
                        (this.parsedResult.engine = f.describe(this.getUA())),
                      this.parsedResult.engine
                    );
                  }),
                  (d.parse = function () {
                  ...
                  (d.satisfies = function (d) {
                    ...
                    if (
                      (Object.keys(d).forEach(function (f) {
                        ...
                        typeof _ == "string"
                          ? ((h[f] = _), (g += 1))
                          : typeof _ == "object" && ((p[f] = _), (m += 1));
                      }),
                      m > 0)
                    ) {
                      var _ = Object.keys(p),
                        b = v.default.find(_, function (d) {
                          return f.isOS(d);
                        });
                      if (b) {
                  ...
                  (d.isBrowser = function (d, f) {
                    f === void 0 && (f = !1);
                    var p = this.getBrowserName().toLowerCase(),
                      m = d.toLowerCase(),
                      h = v.default.getBrowserTypeByAlias(m);
                        ...
                        d[0] === ">" || d[0] === "<"
                          ? ((p = d.substr(1)),
                            d[1] === "="
                              ? ((m = !0), (p = d.substr(2)))
                              : (f = []),
                            d[0] === ">" ? f.push(1) : f.push(-1))
                          : d[0] === "="
                            ? (p = d.substr(1))
                            : d[0] === "~" && ((m = !0), (p = d.substr(1))),
                        f.indexOf(v.default.compareVersions(h, p, m)) > -1
                      );
                  }),
                  (d.isOS = function (d) {
                  ...
                  (d.is = function (d, f) {
                    return (
                      f === void 0 && (f = !1),
                      this.isBrowser(d, f) || this.isOS(d) || this.isPlatform(d)
                    );
                  }),
                  (d.some = function (d) {
                    var f = this;
            ...
            92: function (d, f, p) {
              ...
              (f.__esModule = !0), (f.default = void 0);
              var m,
                h = (m = p(17)) && m.__esModule ? m : { default: m },
                g = /version\/(\d+(\.?_?\d+)+)/i,
                _ = [
                  {
                    test: [/googlebot/i],
                    describe: function (d) {
                      var f = { name: "Googlebot" },
                        p =
                          h.default.getFirstMatch(
                            /googlebot\/(\d+(\.\d+))/i,
                            d,
                          ) || h.default.getFirstMatch(g, d);
                  ...
                  },
                  {
                    ...
                    describe: function (d) {
                      var f = { name: "Samsung Internet for Android" },
                        p =
                          h.default.getFirstMatch(g, d) ||
                          h.default.getFirstMatch(
                  ...
                  },
                  {
                    test: [/Whale/i],
                    describe: function (d) {
                      var f = { name: "NAVER Whale Browser" },
                        p =
                          h.default.getFirstMatch(g, d) ||
                          h.default.getFirstMatch(
                            /(?:whale)[\s/](\d+(?:\.\d+)+)/i,
                  ...
                  },
                  {
                    test: [/msie|trident/i],
                    describe: function (d) {
                      var f = { name: "Internet Explorer" },
                        p = h.default.getFirstMatch(
                          /(?:msie |rv:)(\d+(\.?_?\d+)+)/i,
                          d,
                        );
                      return p && (f.version = p), f;
                  ...
                  {
                    test: function (d) {
                      var f = !d.test(/like android/i),
                        p = d.test(/android/i);
                      return f && p;
                    },
                    describe: function (d) {
                      var f = { name: "Android Browser" },
                        p = h.default.getFirstMatch(g, d);
                      return p && (f.version = p), f;
                    },
                  },
                  {
              ...
              var m,
                ...
                _ = [
                  ...
                  },
                  {
                    ...
                    describe: function (d) {
                      var f = h.default.getFirstMatch(
                        ...
                        p = h.default.getWindowsVersionName(f);
                      return {
                  ...
                  },
                  {
                    ...
                    describe: function (d) {
                      var f = h.default
                          .getFirstMatch(/mac os x (\d+(\.?_?\d+)+)/i, d)
                          .replace(/[_\s]/g, "."),
                        p = h.default.getMacOSVersionName(f),
                        m = {
                          name: g.OS_MAP.MacOS,
                          version: f,
                        };
                  ...
                  },
                  {
                    ...
                    describe: function (d) {
                      var f = h.default
                        .getFirstMatch(/os (\d+([_\s]\d+)*) like mac os x/i, d)
                        .replace(/[_\s]/g, ".");
                      return {
                        name: g.OS_MAP.iOS,
                        version: f,
                  ...
                  },
                  {
                    ...
                    describe: function (d) {
                      var f = h.default.getFirstMatch(
                        ...
                        p = h.default.getAndroidVersionName(f),
                        m = {
                  ...
                  },
                  {
                    ...
                    describe: function (d) {
                      var f =
                        ...
                        h.default.getFirstMatch(/\bbb(\d+)/i, d);
                      return {
              ...
              var m,
                ...
                _ = [
                  ...
                  },
                  {
                    ...
                    describe: function (d) {
                      var f =
                          h.default.getFirstMatch(/(can-l01)/i, d) && "Nova",
                        p = {
                  ...
                  {
                    test: function (d) {
                      var f = d.test(/ipod|iphone/i),
                        p = d.test(/like (ipod|iphone)/i);
                      return f && !p;
                    },
                    describe: function (d) {
              ...
              var m,
                ...
                _ = [
                  ...
                  },
                  {
                    test: [/trident/i],
                    describe: function (d) {
                      var f = { name: g.ENGINE_MAP.Trident },
                        p = h.default.getFirstMatch(
                          /trident\/(\d+(\.?_?\d+)+)/i,
                          d,
                        );
                  ...
                  },
                  {
                    ...
                    describe: function (d) {
                      var f = { name: g.ENGINE_MAP.Presto },
                        p = h.default.getFirstMatch(
                          /presto\/(\d+(\.?_?\d+)+)/i,
                          d,
                        );
                  ...
                  {
                    test: function (d) {
                      var f = d.test(/gecko/i),
                        p = d.test(/like gecko/i);
                      return f && !p;
                    },
                    describe: function (d) {
                      var f = { name: g.ENGINE_MAP.Gecko },
                        p = h.default.getFirstMatch(
                          /gecko\/(\d+(\.?_?\d+)+)/i,
                          d,
                        );
                  ...
                  },
                  {
                    test: [/(apple)?webkit/i],
                    describe: function (d) {
                      var f = { name: g.ENGINE_MAP.WebKit },
                        p = h.default.getFirstMatch(
                          /webkit\/(\d+(\.?_?\d+)+)/i,
                          d,
                        );
      ...
      "./node_modules/browser-id3-writer/dist/browser-id3-writer.mjs": (
        ...
        function a(d) {
          let f = new ArrayBuffer(2 * d.length),
            p = new Uint8Array(f);
          return new Uint16Array(f).set(e(d)), p;
        }
        function r(d) {
          let f = 255;
          return [(d >>> 24) & f, (d >>> 16) & f, (d >>> 8) & f, d & f];
        }
        function n(d) {
          return 11 + d;
        }
        ...
        class o {
          ...
          _setPictureFrame(d, f, p, m) {
            let h = (function (d) {
                ...
                if (d[0] === 137 && d[1] === 80 && d[2] === 78 && d[3] === 71)
                  return "image/png";
                if (d[0] === 71 && d[1] === 73 && d[2] === 70)
                  return "image/gif";
                if (d[8] === 87 && d[9] === 69 && d[10] === 66 && d[11] === 80)
                  return "image/webp";
                let f = d[0] === 73 && d[1] === 73 && d[2] === 42 && d[3] === 0,
                  p = d[0] === 77 && d[1] === 77 && d[2] === 0 && d[3] === 42;
                return f || p
                  ? "image/tiff"
                  : d[0] === 66 && d[1] === 77
                    ? "image/bmp"
          ...
          _setLyricsFrame(d, f, p) {
            let m = d.split("").map((d) => d.charCodeAt(0)),
              h = f.toString(),
              g = p.toString();
            var _, v;
            this.frames.push({
              ...
              description: h,
              size:
                ((_ = h.length), (v = g.length), 16 + 2 * _ + 2 + 2 + 2 * v),
            });
          }
          ...
          _setUserStringFrame(d, f) {
            ...
            this.frames.push({
              ...
              value: m,
              size:
                ((h = p.length), (g = m.length), 13 + 2 * h + 2 + 2 + 2 * g),
            });
          }
          ...
          _setSynchronisedLyricsFrame(d, f, p, m, h) {
            let g = h.toString(),
              _ = m.split("").map((d) => d.charCodeAt(0));
            this.frames.push({
              name: "SYLT",
              value: f,
              language: _,
          ...
          constructor(d) {
            if (!d || typeof d != "object" || !("byteLength" in d))
              throw Error(
          ...
          setFrame(d, f) {
            switch (d) {
              ...
              case "TCON": {
                if (!Array.isArray(f))
                  throw Error(`${d} frame value should be an array of strings`);
                let p = d === "TCON" ? ";" : "/",
                  m = f.join(p);
              ...
              case "USLT":
                ...
                if (f.language && !f.language.match(/[a-z]{3}/i))
                  throw Error(
              ...
              case "COMM":
                ...
                break;
              case "PRIV":
                if (typeof f != "object" || !("id" in f) || !("data" in f))
                  throw Error(
              ...
              case "IPLS":
                if (!Array.isArray(f) || !Array.isArray(f[0]))
                  throw Error("IPLS frame value should be an array of pairs");
              ...
              case "SYLT":
                if (
                  ...
                  !("type" in f) ||
                  !("text" in f) ||
                  !("timestampFormat" in f)
                )
                  throw Error(
                    "SYLT frame value should be an object with keys type, text and timestampFormat",
                  );
                if (!Array.isArray(f.text) || !Array.isArray(f.text[0]))
                  throw Error(
                    "SYLT frame text value should be an array of pairs",
                  );
                if (f.type < 0 || f.type > 6)
                  throw Error("Incorrect SYLT frame content type");
                if (f.timestampFormat < 1 || f.timestampFormat > 2)
                  throw Error("Incorrect SYLT frame time stamp format");
                (f.language = f.language || "eng"),
                ...
                break;
              default:
                throw Error(`Unsupported frame ${d}`);
            }
            return this;
          }
          removeTag() {
            if (this.arrayBuffer.byteLength < 10) return;
            let d = new Uint8Array(this.arrayBuffer),
              f = d[3],
              p =
                ((m = [d[6], d[7], d[8], d[9]])[0] << 21) +
                (m[1] << 14) +
                (m[2] << 7) +
                m[3] +
                10;
            ...
            (h = d)[0] !== 73 ||
              ...
              f < 2 ||
              f > 4 ||
              (this.arrayBuffer = new Uint8Array(d.subarray(p)).buffer);
          }
          addTag() {
            this.removeTag();
            let d = [255, 254],
              f =
                10 + this.frames.reduce((d, f) => d + f.size, 0) + this.padding,
              p = new ArrayBuffer(this.arrayBuffer.byteLength + f),
              m = new Uint8Array(p),
              h = 0,
              g = [];
            return (
              ...
              (g = (function (d) {
                let f = 127;
                return [(d >>> 21) & f, (d >>> 14) & f, (d >>> 7) & f, d & f];
              })(f - 10)),
              m.set(g, h),
              (h += g.length),
              this.frames.forEach((f) => {
                switch (
                  ...
                  case "COMM":
                    (g = [1]),
                      (f.name !== "USLT" && f.name !== "COMM") ||
                        (g = g.concat(f.language)),
                      (g = g.concat(d)),
                      m.set(g, h),
                      (h += g.length),
                      (g = a(f.description)),
                  ...
                  case "PRIV":
                    (g = t(f.id)),
                      ...
                      (h += g.length),
                      h++,
                      m.set(new Uint8Array(f.value), h),
                      (h += f.value.byteLength);
                    break;
                  case "APIC":
                    (g = [f.useUnicodeEncoding ? 1 : 0]),
                      m.set(g, h),
                      (h += g.length),
                      (g = t(f.mimeType)),
                      m.set(g, h),
                  ...
                  case "IPLS":
                    ...
                    break;
                  case "SYLT":
                    (g = [1].concat(f.language, f.timestampFormat, f.type)),
                      m.set(g, h),
                      (h += g.length),
                      (g = [].concat(d)),
                      m.set(g, h),
              ...
              (h += this.padding),
              m.set(new Uint8Array(this.arrayBuffer), h),
              (this.arrayBuffer = p),
              p
            );
          }
      ...
      "./node_modules/chaimu/dist/index.js": (d, f, p) => {
        ...
        let m = {
          ...
          h = {
            log: (...d) => {
              if (m.debug)
                return console.log(
                  `%c✦ chaimu.js v${m.version} ✦`,
                  "background: #000; color: #fff; padding: 0 8px",
                  ...d,
                );
            },
          },
          g = ["playing", "ratechange", "play", "waiting", "pause", "seeked"];
        ...
        class BasePlayer {
          ...
          handleVideoEvent = (d) => (
            h.log(`handle video ${d.type}`), this.lipSync(d.type), this
          );
          removeVideoEvents() {
            for (let d of g)
              this.chaimu.video?.removeEventListener(d, this.handleVideoEvent);
            return this;
          }
          addVideoEvents() {
            for (let d of g)
              this.chaimu.video?.addEventListener(d, this.handleVideoEvent);
            return this;
          }
          async play() {
            return this;
        ...
        class AudioPlayer extends BasePlayer {
          ...
          disconnectAudioNodes() {
            this.audioSource &&
              (this.audioSource.disconnect(), (this.audioSource = void 0)),
              this.gainNode &&
                (this.gainNode.disconnect(), (this.gainNode = void 0));
          }
          updateAudio() {
            return (
          ...
          lipSync(d = !1) {
            if (
              (h.log("[AudioPlayer] lipsync video", this.chaimu.video),
              !this.chaimu.video)
            )
              return this;
            if (
              ...
              return h.log("[AudioPlayer] lipsync mode isn't set"), this;
          ...
          syncPlay() {
            return (
              h.log("[AudioPlayer] sync play called"),
              this.audio && this.audio.play().catch(this.audioErrorHandle),
              this
            );
          }
          async play() {
            return (
              h.log("[AudioPlayer] play called"),
              this.audio &&
          ...
          async pause() {
            return (
              h.log("[AudioPlayer] pause called"),
        ...
        class ChaimuPlayer extends BasePlayer {
          ...
          async fetchAudio() {
            ...
            if (!this.chaimu.audioContext)
              throw Error("No audio context available");
            ...
            try {
              ...
              (d = URL.createObjectURL(m)),
                (this.audioBuffer =
                  await this.chaimu.audioContext.decodeAudioData(p)),
              ...
              throw (
                ...
                Error(`Failed to fetch audio file, because ${f.message}`))
              );
            }
            return this;
          }
          ...
          createAudioElement() {
            ...
            (d.crossOrigin = "anonymous"),
              "preservesPitch" in d &&
                ((d.preservesPitch = !0),
                "mozPreservesPitch" in d && (d.mozPreservesPitch = !0),
                "webkitPreservesPitch" in d && (d.webkitPreservesPitch = !0)),
              (this.audioElement = d),
              (this.mediaElementSource =
                this.chaimu.audioContext.createMediaElementSource(d)),
              this.mediaElementSource.connect(this.gainNode),
              this.gainNode.connect(this.chaimu.audioContext.destination);
          }
          lipSync(d = !1) {
            if (
              (h.log("[ChaimuPlayer] lipsync video", this.chaimu.video, this),
              !this.chaimu.video)
            )
              return this;
          ...
          async reopenCtx() {
            if (!this.chaimu.audioContext)
              throw Error("No audio context available");
            try {
              this.chaimu.audioContext.state !== "closed" &&
          ...
          async clear() {
            ...
            if (!this.chaimu.audioContext)
              throw Error("No audio context available");
            return (
              h.log("clear audio context"),
              (this.isClearing = !0),
              (this.clearingPromise = (async () => {
                try {
                  await this.pause(),
                    this.audioElement &&
                      (this.audioElement.pause(), (this.audioElement = void 0)),
                    this.blobUrl &&
                  ...
                  return (
                    ...
                    this.chaimu.audioContext &&
                      (this.initAudioBooster(), (this.volume = d)),
                    this
                  );
                } finally {
          ...
          async start() {
            ...
            return (
              this.isClearing &&
                this.clearingPromise &&
                (h.log("The other cleaner is still running, waiting..."),
                await this.clearingPromise),
              h.log("starting audio via HTMLAudioElement"),
              await this.play(),
              this.chaimu.video &&
                ((this.audioElement.currentTime =
                  this.chaimu.video.currentTime),
                (this.audioElement.playbackRate =
                  this.chaimu.video.playbackRate)),
              this.audioElement
                .play()
                .catch((d) =>
                  h.log("[ChaimuPlayer] Play audioElement failed:", d),
                ),
              this
            );
          }
          async pause() {
            ...
            return (
              ...
              this.chaimu.audioContext.state === "running" &&
        ...
        class Chaimu {
          ...
          constructor({
            ...
            (this._debug = m.debug = p),
              (this.fetchFn = h),
              (this.fetchOpts = g),
              (this.audioContext = initAudioContext()),
              (this.player =
                this.audioContext && !_
                  ? new ChaimuPlayer(this, d)
                  : new AudioPlayer(this, d)),
              (this.video = f);
          }
          async init() {
            await this.player.init(),
              this.video && !this.video.paused && this.player.lipSync("play"),
      ...
      "./node_modules/lit-html/lit-html.js": (d, f, p) => {
        ...
        let m = globalThis,
          h = m.trustedTypes,
          g = h ? h.createPolicy("lit-html", { createHTML: (d) => d }) : void 0,
          _ = "$lit$",
          ...
          w = Array.isArray,
          u = (d) => w(d) || typeof d?.[Symbol.iterator] == "function",
          T = "[ 	\n\f\r]",
          E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
          D = /-->/g,
          O = />/g,
          ...
          Y = new WeakMap(),
          X = C.createTreeWalker(C, 129);
        function P(d, f) {
          if (!w(d) || !d.hasOwnProperty("raw"))
        ...
        let V = (d, f) => {
          ...
          for (let f = 0; f < p; f++) {
            ...
            for (
              ;
              W < p.length && ((b.lastIndex = W), (w = b.exec(p)), w !== null);
                ...
                b === E
                  ...
                  : b === A
                    ? w[0] === ">"
                      ...
                      : w[1] === void 0
                        ? (T = -2)
                        : ((T = b.lastIndex - w[2].length),
                          (C = w[1]),
                          (b = w[3] === void 0 ? A : w[3] === '"' ? F : j))
                    : b === F || b === j
                      ? (b = A)
                      : b === D || b === O
                        ? (b = E)
            ...
            g +=
              b === E
                ? p + x
                : T >= 0
                  ? (m.push(C), p.slice(0, T) + _ + p.slice(T) + v + G)
                  : p + v + (T === -2 ? f : G);
          }
          return [
            P(
        ...
        class N {
          constructor({ strings: d, _$litType$: f }, p) {
            ...
            for (; (m = X.nextNode()) !== null && w.length < C; ) {
              if (m.nodeType === 1) {
                if (m.hasAttributes())
                  for (let d of m.getAttributeNames())
                    if (d.endsWith(_)) {
                      let f = E[x++],
                        p = m.getAttribute(d).split(v),
                        h = /([.?@])?(.*)/.exec(f);
                      w.push({
                        type: 1,
                        index: g,
        ...
        function S(d, f, p = d, m) {
          if (f === q) return f;
          let h = m === void 0 ? p._$Cl : p._$Co?.[m],
            g = c(f) ? void 0 : f._$litDirective$;
          return (
            h?.constructor !== g &&
              (h?._$AO?.(!1),
              g === void 0 ? (h = void 0) : ((h = new g(d)), h._$AT(d, p, m)),
              m === void 0 ? (p._$Cl = h) : ((p._$Co ??= [])[m] = h)),
            h !== void 0 && (f = S(d, h._$AS(d, f.values), h, m)),
            f
          );
        }
        class M {
          ...
          u(d) {
            let {
              ...
              m = (d?.creationScope ?? C).importNode(f, !0);
            X.currentNode = m;
            let h = X.nextNode(),
              g = 0,
              _ = 0,
            ...
            for (; v !== void 0; ) {
              if (g === v.index) {
                let f;
                v.type === 2
                  ? (f = new R(h, h.nextSibling, this, d))
                  : v.type === 1
                    ? (f = new v.ctor(h, v.name, v.strings, this, d))
                    : v.type === 6 && (f = new z(h, this, d)),
                  this._$AV.push(f),
                  (v = p[++_]);
              }
          ...
          p(d) {
            ...
            for (let p of this._$AV)
              p !== void 0 &&
                (p.strings === void 0
                  ? p._$AI(d[f])
                  : (p._$AI(d, p, f), (f += p.strings.length - 2))),
                f++;
          }
        }
        class R {
          ...
          _(d) {
            this._$AH !== J && c(this._$AH)
              ? (this._$AA.nextSibling.data = d)
              : this.T(C.createTextNode(d)),
              (this._$AH = d);
          }
          $(d) {
            let { values: f, _$litType$: p } = d,
              m =
                typeof p == "number"
                  ? this._$AC(d)
                  : (p.el === void 0 &&
                      (p.el = N.createElement(P(p.h, p.h[0]), this.options)),
                    p);
          ...
          k(d) {
            ...
            for (let h of d)
              m === f.length
                ? f.push(
                    (p = new R(this.O(l()), this.O(l()), this, this.options)),
                  )
                : (p = f[m]),
                p._$AI(h),
                m++;
            m < f.length &&
              (this._$AR(p && p._$AB.nextSibling, m), (f.length = m));
          }
        ...
        class k {
          ...
          _$AI(d, f = this, p, m) {
            ...
            if (h === void 0)
              (d = S(this, d, f, 0)),
                (g = !c(d) || (d !== this._$AH && d !== q)),
                g && (this._$AH = d);
            else {
              let m = d,
                _,
                v;
              for (d = h[0], _ = 0; _ < h.length - 1; _++)
                (v = S(this, m[p + _], f, _)),
                  v === q && (v = this._$AH[_]),
                  (g ||= !c(v) || v !== this._$AH[_]),
                  v === J ? (d = J) : d !== J && (d += (v ?? "") + h[_ + 1]),
                  (this._$AH[_] = v);
            }
            g && !m && this.j(d);
          }
          ...
          _$AI(d, f = this) {
            ...
            let p = this._$AH,
              m =
                ...
                d.passive !== p.passive,
              h = d !== J && (p === J || m);
            m && this.element.removeEventListener(this.name, this, p),
              h && this.element.addEventListener(this.name, this, d),
              (this._$AH = d);
          }
          handleEvent(d) {
            typeof this._$AH == "function"
              ? this._$AH.call(this.options?.host ?? this.element, d)
              : this._$AH.handleEvent(d);
          }
        }
        class z {
          constructor(d, f, p) {
      ...
      "./src/audioDownloader/iframe.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/@vot.js/ext/dist/helpers/youtube.js"),
              g = p("./src/utils/debug.ts"),
              _ = p("./src/utils/iframeConnector.ts"),
              v = p("./src/utils/utils.ts"),
              b = p("./src/audioDownloader/shared.ts"),
              x = d([_, v]);
            [_, v] = x.then ? (await x)() : x;
            let C = "",
              getAdaptiveFormats = () =>
                h.A.getPlayerResponse()?.streamingData?.adaptiveFormats;
            async function isEncodedRequest(d, f) {
              if (
                !d.includes("googlevideo.com/videoplayback") ||
                typeof f == "string"
              )
                return !1;
              try {
            ...
            function selectBestAudioFormat() {
              ...
              let f = d.filter(
                ({ audioQuality: d, mimeType: f }) => d || f?.includes("audio"),
              );
              if (!f.length)
                throw Error(
                  "Audio downloader. WEB API. No audio adaptive formats",
                );
              let p = f
                .filter(({ itag: d }) => d === 251)
                .sort(({ contentLength: d }, { contentLength: f }) =>
                  d && f ? Number.parseInt(d) - Number.parseInt(f) : -1,
                );
              return p.at(-1) ?? f[0];
            }
            let waitForPlayer = async () => (
              await (0, v.UV)(() => !!h.A.getPlayer(), 1e4), h.A.getPlayer()
            );
            async function getDownloadAudioData(d) {
              try {
                ...
                unsafeWindow.fetch = async (p, m) => {
                  ...
                  if (await isEncodedRequest(h, p))
                    return (
                      ...
                      (unsafeWindow.fetch = f),
                      f(p, m)
                    );
                  let g = await f(p, m);
                  return d.messageId === C
                    ? (h.includes("&itag=251&") &&
                        ((unsafeWindow.fetch = f),
                        window.parent.postMessage(
                          {
                ...
                p.loadVideoById(d.payload.videoId),
                  p.pauseVideo?.(),
                  p.mute?.(),
                  setTimeout(() => {
                    if (d.messageId !== C) {
                ...
                try {
                  switch (d.messageType) {
                    case "get-download-audio-data-in-iframe":
                      ...
                      break;
                    default:
                      g.A.log(`NOT IMPLEMENTED: ${d.messageType}`, d.payload);
                  }
                } catch (d) {
      ...
      "./src/audioDownloader/index.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/@vot.js/core/dist/types/yandex.js"),
              g = p("./src/core/eventImpl.ts"),
              _ = p("./src/utils/debug.ts"),
              v = p("./src/utils/gm.ts"),
              b = p("./src/utils/iframeConnector.ts"),
              x = p("./src/utils/utils.ts"),
              C = p("./src/audioDownloader/shared.ts"),
              w = d([v, b, x]);
            [v, b, x] = w.then ? (await w)() : w;
            let T = null,
              E = 1,
              D = new TextDecoder("ascii");
            async function sendAudioDownloadRequestToIframe(d) {
              let { videoId: f } = d.payload,
                p = `https://${C.ov}/embed/${f}?autoplay=0&mute=1`;
              try {
                let f = await (0, b.IA)(T, p, C.pr, C.D5);
                if (!(0, b.yB)(C.pr))
                  throw Error(
                    "Audio downloader. WEB API. Service iframe deleted",
                  );
                ...
                (d.error = f),
                  (d.messageDirection = "response"),
                  window.postMessage(d, "*");
              }
            }
            let getDownloadAudioDataInMainWorld = (d) =>
                (0, b.hG)("get-download-audio-data-in-main-world", d),
              O =
            ...
            async function getGeneratingAudioUrlsDataFromIframe(d) {
              try {
                return await Promise.race([
                  getDownloadAudioDataInMainWorld({ videoId: d }),
                  (0, x.wR)(2e4, O),
                ]);
              } catch (d) {
                let f = d instanceof Error && d.message === O;
                throw (
                  (_.A.log("getGeneratingAudioUrlsDataFromIframe error", d),
                  Error(
                    f
                      ? O
            ...
            function makeFileId(d, f) {
              return JSON.stringify({
                downloadType:
                  h.J.WEB_API_GET_ALL_GENERATING_URLS_DATA_FROM_IFRAME,
                itag: d,
                minChunkSize: C.Aj,
                fileSize: f,
              });
            ...
            function parseContentLength({ contentLength: d }) {
              if (typeof d != "string")
                throw Error(
                  `Audio downloader. WEB API. Content length (${d}) is not a string`,
                );
              let f = Number.parseInt(d);
              if (!Number.isFinite(f))
                throw Error(
                  `Audio downloader. WEB API. Parsed content length is not finite (${f})`,
                );
              return f;
            }
            ...
            function getChunkRangesPartsFromAdaptiveFormat(d) {
              let f = parseContentLength(d),
                p = getChunkRangesPartsFromContentLength(f);
              if (!p.length)
                throw Error(
                  "Audio downloader. WEB API. No chunk parts generated",
                );
              return p;
            }
            let A =
                "Audio downloader. WEB API. Incorrect response on fetch media url",
              j = "Audio downloader. WEB API. Can not fetch media url",
              F =
                "Audio downloader. WEB API. Can not get array buffer from media url";
            function isChunkLengthAcceptable(d, { start: f, end: p }) {
              let m = p - f;
              return m > C.ds && d.byteLength < C.ds
                ? !1
                : Math.min(m, d.byteLength) / Math.max(m, d.byteLength) > C.cP;
            }
            function patchMediaUrl(d, { start: f, end: p }) {
              let m = new URL(d);
              return (
                m.searchParams.set("range", `${f}-${p}`),
                m.searchParams.set("rn", String(E++)),
                m.searchParams.delete("ump"),
                m.toString()
              );
            }
            ...
            async function fetchMediaWithMeta({
              ...
              try {
                ...
                throw d instanceof Error && d.message === A
                  ? d
                  : (console.error(j, {
                      mediaUrl: g,
                      error: d,
              ...
              if (isChunkLengthAcceptable(b, f))
                return {
                  media: b,
                  url: h ? d : null,
                  isAcceptableLast: !1,
              ...
              throw Error(
                `Audio downloader. WEB API. Can not get redirected media url ${g}`,
              );
            }
            function mergeBuffers(d) {
              let f = d.reduce((d, f) => d + f.byteLength, 0),
                p = new Uint8Array(f),
                m = 0;
            ...
            function getChunkRangesFromAdaptiveFormat(d) {
              let f = parseContentLength(d),
                p = getChunkRangesFromContentLength(f);
              if (!p.length)
                throw Error("Audio downloader. WEB API. Empty chunk ranges");
              return p;
            }
            async function getAudioFromWebApiWithReplacedFetch({
              ...
              let {
                ...
                adaptiveFormat: g,
                itag: _,
              } = await getGeneratingAudioUrlsDataFromIframe(d);
              if (!h)
                throw Error(
                  "Audio downloader. WEB API. Can not get requestInfo",
                );
              let v = (0, C.rh)(h),
                b = (0, C.yA)(h),
                x = (0, C.RZ)(b),
              ...
              return {
                ...
                mediaPartsLength: f
                  ? getChunkRangesPartsFromAdaptiveFormat(g).length
                  : 1,
                  ...
                  if (f) {
                    ...
                    for (let f of d) {
                      let {
                        ...
                        url: m,
                        isAcceptableLast: h,
                      } = await fetchMediaWithMetaByChunkRanges(v, w, f, p);
                      if ((m && (v = m), yield d, h)) break;
                    }
                  } else {
                    let d = getChunkRangesFromAdaptiveFormat(g),
                      { media: f } = await fetchMediaWithMetaByChunkRanges(
                        v,
                        w,
                        d,
                        p,
            ...
            async function handleCommonAudioDownloadRequest({
              ...
              _.A.log("Audio downloader. Url found", {
                audioDownloadType:
                  "web_api_get_all_generating_urls_data_from_iframe",
              });
              ...
              async runAudioDownload(d, f, p) {
                ...
                try {
                  await handleCommonAudioDownloadRequest({
                    ...
                    _.A.log("Audio downloader. Audio download finished", {
                      videoId: d,
                    });
                } catch (f) {
                  console.error(
                    "Audio downloader. Failed to download audio",
                    f,
                  ),
                    this.onDownloadAudioError.dispatch(d);
                }
      ...
      "./src/audioDownloader/shared.ts": (d, f, p) => {
        ...
        let h = "vot_iframe_player",
          g = "service",
          _ = "www.youtube.com",
          v = m.$W.minChunkSize,
          b = 0.9,
          x = [6e4, 8e4, 15e4, 33e4, 46e4],
          C = 15e3,
          w = 0.9,
          getRequestUrl = (d) => (typeof d == "string" ? d : d.url);
      ...
      "./src/config/config.js": (d, f, p) => {
        ...
        let m = "api.browser.yandex.ru",
          h = "media-proxy.toil.cc/v1/proxy/m3u8",
          g = "vot-worker.toil.cc",
          _ = "https://vot.toil.cc/v1",
          v = "https://translate.toil.cc/v2",
          b = "https://rust-server-531j.onrender.com/detect",
          x = "https://t2mc.toil.cc",
          C = "https://avatars.mds.yandex.net/get-yapic",
          w = "ilyhalight/voice-over-translation",
          T = `https://raw.githubusercontent.com/${w}`,
          E = `https://github.com/${w}`,
          D = 15,
          O = 900,
          A = 5,
          j = "yandexbrowser",
          F = "yandexbrowser",
          U = ["Tampermonkey", "Violentmonkey"],
          W = ["UA", "LV", "LT"],
          G = 1e3,
          K = "2025-05-09";
      },
      "./src/core/auth.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            p.d(f, { L: () => initAuth });
            var h = p("./src/utils/storage.ts"),
              g = d([h]);
            h = (g.then ? (await g)() : g)[0];
            async function handleAuthCallbackPage() {
              let { access_token: d, expires_in: f } = Object.fromEntries(
                new URLSearchParams(window.location.hash.slice(1)),
              );
              if (!d || !f) throw Error("[VOT] Invalid token response");
              let p = parseInt(f);
              if (Number.isNaN(p))
                throw Error("[VOT] Invalid expires_in value");
      ...
      "./src/core/eventImpl.ts": (d, f, p) => {
        ...
        class EventImpl {
          ...
          addListener(d) {
            if (this.listeners.has(d))
              throw Error("[VOT] The listener has already been added.");
      ...
      "./src/core/translationHandler.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/@vot.js/core/dist/types/yandex.js"),
              g = p("./src/audioDownloader/index.ts"),
              _ = p("./src/localization/localizationProvider.ts"),
              v = p("./src/utils/VOTLocalizedError.js"),
              b = p("./src/utils/debug.ts"),
              x = p("./src/utils/localization.ts"),
              C = p("./src/utils/utils.ts"),
              w = d([g, _, v, x, C]);
            ...
            class VOTTranslationHandler {
              ...
              constructor(d) {
                (this.videoHandler = d),
                  (this.audioDownloader = new g.I()),
                  (this.downloading = !1),
                  this.audioDownloader
                    .addEventListener("downloadedAudio", async (d, f) => {
                      if ((b.A.log("downloadedAudio", f), !this.downloading)) {
                        b.A.log("skip downloadedAudio");
                        return;
                      }
                      let { videoId: p, fileId: m, audioData: h } = f,
                        g = this.getCanonicalUrl(p);
                      try {
                    ...
                    .addEventListener(
                      ...
                      async (d, f) => {
                        if (
                          (b.A.log("downloadedPartialAudio", f),
                          !this.downloading)
                        ) {
                    ...
                    .addEventListener("downloadAudioError", async (d) => {
                      ...
                      await this.videoHandler.votClient.requestVtransFailAudio(
                        f,
                      ),
                        (this.downloading = !1);
                    });
              ...
              async translateVideoImpl(
                ...
                clearTimeout(this.videoHandler.autoRetry),
                  ...
                  b.A.log(
                    d,
                    `Translate video (requestLang: ${f}, responseLang: ${p})`,
                    v,
                  );
                try {
                  ...
                  let w =
                    ...
                    T = await this.videoHandler.votClient.translateVideo({
                      videoData: d,
                      requestLang: f,
                      responseLang: p,
                      translationHelp: m,
                  ...
                  if ((b.A.log("Translate video result", T), v.aborted))
                    throw Error("AbortError");
                  if (T.translated && T.remainingTime < 1)
                    return (
                      b.A.log("Video translation finished with this data: ", T),
                      T
                    );
                  let E = T.message ?? _.j.get("translationTakeFewMinutes");
                  if (
                    (await this.videoHandler.updateTranslationErrorMsg(
                      T.remainingTime > 0 ? (0, x.o)(T.remainingTime) : E,
                    ),
                    T.status === h.v.AUDIO_REQUESTED &&
                      this.videoHandler.isYouTubeHosts())
                  ) {
                    if (
                      (b.A.log("Start audio download"),
                      (this.downloading = !0),
                      ...
                      b.A.log("waiting downloading finish"),
                      await (0, C.UV)(
                        () => !this.downloading || v.aborted,
                        15e3,
                      ),
                      v.aborted)
                    )
                      throw (
                        (b.A.log("aborted after audio downloader vtrans"),
                        Error("AbortError"))
                      );
                    return await this.translateVideoImpl(d, f, p, m, !0, v);
                  }
                } catch (m) {
                  if (m.message === "AbortError")
                    return b.A.log("aborted video translation"), null;
                  await this.videoHandler.updateTranslationErrorMsg(
                    m.data?.message ?? m,
                  ),
                    console.error("[VOT]", m);
                  ...
                  return (
                    this.videoHandler.cacheManager.setTranslation(h, {
                      error: m,
                    }),
                    null
                  );
              ...
              async translateStreamImpl(
                ...
                f,
                p,
                m = new AbortController().signal,
              ) {
                clearTimeout(this.videoHandler.autoRetry),
                  b.A.log(
                    d,
                    `Translate stream (requestLang: ${f}, responseLang: ${p})`,
                  );
                try {
                  ...
                  if (m.aborted) throw Error("AbortError");
                  if (
                    (b.A.log("Translate stream result", h),
                    !h.translated && h.interval === 10)
                  )
                    return (
                      await this.videoHandler.updateTranslationErrorMsg(
                        _.j.get("translationTakeFewMinutes"),
                      ),
                      new Promise((g) => {
                        this.videoHandler.autoRetry = setTimeout(async () => {
                  ...
                  if (this.isWaitingStreamRes(h))
                    throw (
                      (b.A.log(
                        `Stream translation aborted! Message: ${h.message}`,
                      ),
                      new v.n("streamNoConnectionToServer"))
                    );
                  if (!h.result)
                    throw (
                      (b.A.log("Failed to find translation result! Data:", h),
                      new v.n("audioNotReceived"))
                    );
                  return (
                    b.A.log("Stream translated successfully. Running...", h),
                    (this.videoHandler.streamPing = setInterval(async () => {
                      b.A.log("Ping stream translation", h.pingId),
                  ...
                  return d.message === "AbortError"
                    ? (b.A.log("aborted stream translation"), null)
                    : (console.error("[VOT] Failed to translate stream", d),
                      await this.videoHandler.updateTranslationErrorMsg(
                        d.data?.message ?? d,
                      ),
                      null);
      ...
      "./src/core/videoManager.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/@vot.js/ext/dist/utils/videoData.js"),
              g = p("./node_modules/@vot.js/shared/dist/data/config.js"),
              _ = p("./node_modules/@vot.js/shared/dist/data/consts.js"),
              v = p("./node_modules/@vot.js/ext/dist/helpers/youtube.js"),
              b = p("./src/localization/localizationProvider.ts"),
              x = p("./src/utils/VOTLocalizedError.js"),
              C = p("./src/utils/debug.ts"),
              w = p("./src/utils/gm.ts"),
              T = p("./src/utils/translateApis.ts"),
              E = p("./src/utils/utils.ts"),
              D = d([b, x, w, T, E]);
            ...
            class VOTVideoManager {
              ...
              async getVideoData() {
                let {
                    ...
                    host: m,
                    title: v,
                    translationHelp: x = null,
                    localizedTitle: D,
                    description: O,
                    detectedLanguage: A,
                    subtitles: j,
                    isStream: F = !1,
                  } = await (0, h.o4)(this.videoHandler.site, {
                    fetchFn: w.G3,
              ...
              isMuted() {
                return ["youtube", "googledrive"].includes(
                  this.videoHandler.site.host,
                )
                  ? v.A.isMuted()
              ...
              syncVideoVolumeSlider() {
                let d = this.isMuted() ? 0 : this.getVideoVolume() * 100,
                  f = Math.round(d);
                return (
                  this.videoHandler.data?.syncVolume &&
                    (this.videoHandler.tempOriginalVolume = Number(f)),
              ...
              setSelectMenuValues(d, f) {
                if (
                  ...
                  return this;
                console.log(`[VOT] Set translation from ${d} to ${f}`),
                  ...
                  (this.videoHandler.videoData.detectedLanguage = d),
                  (this.videoHandler.videoData.responseLanguage = f);
              }
            }
            m();
          } catch (d) {
      ...
      "./src/index.js": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            p.d(f, { k: () => Q });
            var h = p("./node_modules/@vot.js/ext/dist/index.js"),
              g = p("./node_modules/@vot.js/ext/dist/helpers/youtube.js"),
              _ = p("./node_modules/@vot.js/ext/dist/utils/videoData.js"),
              v = p("./node_modules/chaimu/dist/index.js"),
              b = p("./src/utils/debug.ts"),
              x = p("./src/audioDownloader/iframe.ts"),
              C = p("./src/config/config.js"),
              w = p("./src/core/auth.ts"),
              T = p("./src/core/cacheManager.ts"),
              E = p("./src/core/translationHandler.ts"),
              D = p("./src/core/videoManager.ts"),
              O = p("./src/localization/localizationProvider.ts"),
              A = p("./src/subtitles.js"),
              j = p("./src/ui/components/hotkeyButton.ts"),
              F = p("./src/ui/manager.ts"),
              U = p("./src/utils/VOTLocalizedError.js"),
              W = p("./src/utils/VideoObserver.js"),
              G = p("./src/utils/gm.ts"),
              K = p("./src/utils/iframeConnector.ts"),
              q = p("./src/utils/storage.ts"),
              J = p("./src/utils/translateApis.ts"),
              Y = p("./src/utils/utils.ts"),
              X = p("./src/utils/volume.ts"),
              Z = d([h, x, w, E, D, O, A, j, F, U, G, K, q, J, Y]);
            [h, x, w, E, D, O, A, j, F, U, G, K, q, J, Y] = Z.then
              ? (await Z)()
              : Z;
            let Q;
            class VideoHandler {
              ...
              subtitles = [];
              constructor(d, f, p) {
                b.A.log("[VideoHandler] add video:", d, "container:", f, this),
                  (this.video = d),
                  (this.container = f),
                  (this.site = p),
                  ...
                  (this.translationHandler = new E.F(this)),
                  (this.videoManager = new D.k(this)),
                  (this.cacheManager = new T.G());
              }
              getPortalContainer() {
                return this.site.host === "youtube" &&
              ...
              getEventContainer() {
                return this.site.eventSelector
                  ? this.site.host === "twitter"
                    ? this.container.closest(this.site.eventSelector)
              ...
              getPreferAudio() {
                return !this.audioContext ||
                  ...
                  ? !0
                  : this.data.newAudioPlayer && !this.data.onlyBypassMediaCSP
                    ? !1
              ...
              createPlayer() {
                ...
                return (
                  b.A.log("preferAudio:", d),
                  (this.audioPlayer = new v.Ay({
                    video: this.video,
                    debug: !1,
                    fetchFn: G.G3,
                    fetchOpts: { timeout: 0 },
              ...
              async init() {
                if (!this.initialized) {
                  if (
                    ...
                    this.data.compatVersion !== C.r4 &&
                      ((this.data = await (0, q._)(this.data)),
                      await q.d.set("compatVersion", C.r4)),
                  ...
                  C.vZ.includes(Q) &&
                    ...
                    b.A.log("Extension compatibility passed..."),
                    this.initVOTClient(),
                    this.uiManager.initUI(),
                    this.uiManager.initUIEvents(),
                    (this.subtitlesWidget = new A.o(
                      this.video,
                    ...
                    this.subtitlesWidget.setMaxLength(
                      this.data.subtitlesMaxLength,
                    ),
                    this.subtitlesWidget.setHighlightWords(
                      this.data.highlightWords,
                    ),
                    this.subtitlesWidget.setFontSize(
              ...
              initVOTClient() {
                return (
                  ...
                  (this.votClient = new (
                    this.data.translateProxyEnabled ? h.Pu : h.Ay
                  )(this.votOpts)),
                  this
                );
              }
              ...
              initExtraEvents() {
                ...
                if (
                  ((this.resizeObserver = new ResizeObserver((d) => {
                    for (let f of d)
                      this.uiManager.votOverlayView.votMenu.container.style.setProperty(
                        ...
                        `${f.contentRect.height}px`,
                      );
                    let { position: f, direction: p } =
                      this.uiManager.votOverlayView.calcButtonLayout(
                        this.data?.buttonPos,
                      );
                  ...
                  this.syncVolumeObserver = new MutationObserver((d) => {
                    if (
                      !(!this.audioPlayer.player.src || !this.data.syncVolume)
                    ) {
                      for (let f of d)
                        if (
                          f.type === "attributes" &&
                          f.attributeName === "aria-valuenow"
                        ) {
                          ...
                          let d = this.isMuted()
                            ...
                            f = Math.round(d);
                          (this.data.defaultVolume = f),
                            (this.audioPlayer.player.volume =
                              this.data.defaultVolume / 100),
                            this.syncVolumeWrapper("video", f);
                        }
                    }
                  });
                  let d = document.querySelector(".ytp-volume-panel");
                  d &&
                    this.syncVolumeObserver.observe(d, {
                      attributes: !0,
                      subtree: !0,
                    });
                }
                document.addEventListener(
                  ...
                  (d) => {
                    let f = d.target,
                      p = this.uiManager.votOverlayView.votButton.container,
                      m = this.uiManager.votOverlayView.votMenu.container,
                      h = this.container,
                      g = this.uiManager.votSettingsView.dialog.container,
                      _ = document.querySelector(".vot-dialog-temp"),
                      v = p.contains(f),
                      x = m.contains(f),
                      C = h.contains(f),
                      w = g.contains(f),
                      T = _?.contains(f) ?? !1;
                    b.A.log(`[document click] ${v} ${x} ${C} ${w} ${T}`),
                      !v &&
                        !x &&
                        !w &&
                        !T &&
                        ...
                        (this.uiManager.votOverlayView.votMenu.hidden = !0));
                  },
                  { signal: d },
                );
                let f = new Set();
                ...
                p &&
                  ...
                  addExtraEventListener(this.video, "emptied", async () => {
                    ...
                    (this.video.src &&
                      this.videoData &&
                      d === this.videoData.videoId) ||
                      (b.A.log("lipsync mode is emptied"),
                      (this.videoData = void 0),
                      this.stopTranslation());
                  }),
                  ["rutube", "ok"].includes(this.site.host) ||
                    addExtraEventListener(this.video, "volumechange", () => {
                      this.syncVideoVolumeSlider();
                    }),
                  this.site.host === "youtube" &&
                    !this.site.additionalData &&
                    addExtraEventListener(
                      document,
                      "yt-page-data-updated",
                      async () => {
                        b.A.log("yt-page-data-updated"),
              ...
              async setCanPlay() {
                ...
                (this.videoData && d === this.videoData.videoId) ||
                  (await this.handleSrcChanged(),
                  await this.autoTranslate(),
                  b.A.log("lipsync mode is canplay"));
              }
              resetTimer = () => {
              ...
              async changeSubtitlesLang(d) {
                if (
                  (b.A.log("[onchange] subtitles", d),
                  this.uiManager.votOverlayView.subtitlesSelect.setSelectedValue(
                    d,
                  ),
                  d === "disabled")
                )
                  this.subtitlesWidget.setContent(null),
                    (this.uiManager.votOverlayView.downloadSubtitlesButton.hidden =
                      !0),
                  ...
                  if (
                    ...
                    (f.url = `https://${this.data.proxyWorkerHost}/video-subtitles/subtitles-proxy/${d}`),
                      console.log(`[VOT] Subs proxied via ${f.url}`);
                  }
                  (this.yandexSubtitles = await A.I.fetchSubtitles(f)),
              ...
              async updateSubtitlesLangSelect() {
                if (!this.subtitles || this.subtitles.length === 0) {
                  ...
                  this.uiManager.votOverlayView.subtitlesSelect.updateItems(d),
                    await this.changeSubtitlesLang(d[0].value);
                  return;
                }
                let d = [
                  {
                  ...
                  ...this.subtitles.map((d, f) => ({
                    label:
                      (O.j.get(`langs.${d.language}`) ??
                        d.language.toUpperCase()) +
                      (d.translatedFromLanguage
                        ? ` ${O.j.get("VOTTranslatedFrom")} ${O.j.get(`langs.${d.translatedFromLanguage}`) ?? d.translatedFromLanguage.toUpperCase()}`
                        : "") +
                      (d.source === "yandex"
                        ? ""
                        : `, ${window.location.hostname}`) +
                      (d.isAutoGenerated
                        ? ` (${O.j.get("VOTAutogenerated")})`
                        : ""),
                    value: f,
                    selected: !1,
                    disabled: !1,
              ...
              async loadSubtitles() {
                if (!this.videoData?.videoId) {
                  console.error(`[VOT] ${O.j.getDefault("VOTNoVideoIDFound")}`),
                    (this.subtitles = []);
                  return;
                }
                ...
                try {
                  ...
                  f ||
                    ((f = await A.I.getSubtitles(
                      this.votClient,
                      this.videoData,
                    )),
                    this.cacheManager.setSubtitles(d, f)),
                    (this.subtitles = f);
                } catch (d) {
                  console.error("[VOT] Failed to load subtitles:", d),
                    (this.subtitles = []);
                }
              ...
              syncVolumeWrapper(d, f) {
                let p =
                  ...
                  m = (0, X.q)(
                    d === "translation" ? this.video : this.audioPlayer.player,
                    f,
                    p.value,
                    d === "translation"
                      ? this.tempVolume
                ...
                (p.value = m),
                  (this.tempOriginalVolume = d === "translation" ? m : f),
                  (this.tempVolume = d === "translation" ? f : m);
              }
              async getVideoData() {
              ...
              stopTranslate() {
                this.audioPlayer.player.removeVideoEvents(),
                  ...
                  (this.audioPlayer.player.src = void 0),
                  b.A.log("audioPlayer after stopTranslate", this.audioPlayer),
                  (this.uiManager.votOverlayView.videoVolumeSlider.hidden = !0),
                  (this.uiManager.votOverlayView.translationVolumeSlider.hidden =
                    !0),
                  (this.uiManager.votOverlayView.downloadTranslationButton.hidden =
                    !0),
                  (this.downloadTranslationUrl = null),
                  (this.longWaitingResCount = 0),
                  this.transformBtn("none", O.j.get("translateVideo")),
                  b.A.log(`Volume on start: ${this.volumeOnStart}`),
                  this.volumeOnStart && this.setVideoVolume(this.volumeOnStart),
                  clearInterval(this.streamPing),
                  clearTimeout(this.autoRetry),
                  this.hls?.destroy(),
                  (this.firstSyncVolume = !0),
                  (this.actionsAbortController = new AbortController());
              }
              async updateTranslationErrorMsg(d) {
                let f = O.j.get("translationTake"),
                  p = O.j.lang;
                if (
                  ((this.longWaitingResCount =
                    d === O.j.get("translationTakeAboutMinute")
                      ? this.longWaitingResCount + 1
                      : 0),
                  b.A.log("longWaitingResCount", this.longWaitingResCount),
                  this.longWaitingResCount > C.px &&
                    (d = new U.n("TranslationDelayed")),
                  d?.name === "VOTLocalizedError")
                )
                  this.transformBtn("error", d.localizedMessage);
                else if (d instanceof Error)
                  this.transformBtn("error", d?.message);
                else if (
                ...
                [
                  ...
                  (this.uiManager.votOverlayView.votButton.loading = !1);
              }
              afterUpdateTranslation(d) {
                let f =
                  this.uiManager.votOverlayView.votButton.container.dataset
                    .status === "success";
                (this.uiManager.votOverlayView.videoVolumeSlider.hidden =
                  !this.data.showVideoSlider || !f),
                  (this.uiManager.votOverlayView.translationVolumeSlider.hidden =
                    !f),
              ...
              async validateAudioUrl(d) {
                try {
                  ...
                  if ((b.A.log("Test audio response", f), f.ok))
                    return b.A.log("Valid audioUrl", d), d;
                  b.A.log("Yandex returned not valid audio, trying to fix..."),
                    (this.videoData.detectedLanguage = "auto");
                  let p = await this.translationHandler.translateVideoImpl(
                    this.videoData,
                    this.videoData.detectedLanguage,
                  ...
                  this.setSelectMenuValues(
                    ...
                    (d = p.url),
                    b.A.log("Fixed audio audioUrl", d);
                } catch (d) {
              ...
              proxifyAudio(d) {
                if (
                  ...
                  (d = `https://${this.data.proxyWorkerHost}/video-translation/audio-proxy/${f}`),
                    console.log(`[VOT] Audio proxied via ${d}`);
                }
                return d;
              }
              async updateTranslation(d) {
                d !== this.audioPlayer.player.currentSrc &&
                  (d = await this.validateAudioUrl(this.proxifyAudio(d))),
                  this.audioPlayer.player.src !== d &&
                    (this.audioPlayer.player.src = d);
                try {
                  this.audioPlayer.init();
                } catch (d) {
                  b.A.log("this.audioPlayer.init() error", d),
                    this.transformBtn("error", d.message);
                }
                this.setupAudioSettings(),
                  this.site.host === "twitter" &&
                    document
                      .querySelector(
                        'button[data-testid="app-bar-back"][role="button"]',
                      )
                      .addEventListener("click", this.stopTranslation),
                  this.transformBtn("success", O.j.get("disableTranslate")),
                  this.afterUpdateTranslation(d);
              }
              async translateFunc(d, f, p, m, h) {
                console.log("[VOT] Video Data: ", this.videoData),
                  b.A.log("Run videoValidator"),
                  this.videoValidator(),
                  (this.uiManager.votOverlayView.votButton.loading = !0),
                  (this.volumeOnStart = this.getVideoVolume());
                let _ = `${d}_${p}_${m}_${this.data.useLivelyVoice}`,
                  v = this.cacheManager.getTranslation(_);
                if (v?.url) {
                  await this.updateTranslation(v.url),
                    b.A.log("[translateFunc] Cached translation was received");
                  return;
                }
                if (v?.error) {
                  b.A.log("Skip translation - previous attempt failed"),
                    await this.updateTranslationErrorMsg(v.error.data?.message);
                  return;
                }
                if (f) {
                  let d = await this.translationHandler.translateStreamImpl(
                    this.videoData,
                    p,
                    m,
                    this.actionsAbortController.signal,
                  ...
                  return (
                    this.site.host === "youtube" &&
                      g.A.videoSeek(this.video, 10),
                    this.setupAudioSettings(),
                    !this.video.src &&
                    !this.video.currentSrc &&
                    !this.video.srcObject
                      ? this.stopTranslation()
                      : this.afterUpdateTranslation(f)
                  );
                }
                let x = await this.translationHandler.translateVideoImpl(
                  this.videoData,
                  p,
                  m,
                  h,
                ...
                C?.some(
                  (d) =>
                    ...
                    d.translatedFromLanguage ===
                      this.videoData.detectedLanguage &&
                    d.language === this.videoData.responseLanguage,
                ) ||
                  (this.cacheManager.deleteSubtitles(_), (this.subtitles = [])),
                  this.cacheManager.setTranslation(_, {
                    videoId: d,
                    from: p,
                    to: m,
              ...
              setupHLS(d) {
                this.hls.on(Hls.Events.MEDIA_ATTACHED, function () {
                  ...
                  this.hls.on(Hls.Events.MANIFEST_PARSED, function (d) {
                    b.A.log(
                      `manifest loaded, found ${d?.levels?.length} quality level`,
                    );
                  }),
                  this.hls.loadSource(d),
                  this.hls.attachMedia(this.audioPlayer.player.audio),
                  this.hls.on(Hls.Events.ERROR, function (d) {
                    if (d.fatal)
                      switch (d.type) {
              ...
              setHLSSource(d) {
                ...
                if (this.hls) this.setupHLS(f);
                  ...
                  this.audioPlayer.player.audio.canPlayType(
                    "application/vnd.apple.mpegurl",
                  )
                )
                  this.audioPlayer.player.src = f;
                else throw new U.n("audioFormatNotSupported");
                return f;
              }
              setupAudioSettings() {
                typeof this.data.defaultVolume == "number" &&
                  (this.audioPlayer.player.volume =
                    this.data.defaultVolume / 100),
                  this.data.enabledAutoVolume &&
                    this.setVideoVolume(
                      (this.data.autoVolume / 100).toFixed(2),
                    );
              }
              stopTranslation = () => {
              ...
              async handleSrcChanged() {
                b.A.log("[VideoHandler] src changed", this),
                  (this.firstPlay = !0),
                  this.stopTranslation();
                let d =
                  !this.video.src &&
                  !this.video.currentSrc &&
                  !this.video.srcObject;
                (this.uiManager.votOverlayView.votButton.container.hidden = d),
                  d && (this.uiManager.votOverlayView.votMenu.hidden = d),
                  this.site.selector ||
                ...
                (this.subtitles = this.cacheManager.getSubtitles(f)),
                  await this.updateSubtitlesLangSelect(),
                  (this.translateToLang = this.data.responseLanguage ?? "ru"),
                  this.setSelectMenuValues(
                    this.videoData.detectedLanguage,
              ...
              collectReportInfo() {
                let d = `${Y.R5.os.name} ${Y.R5.os.version}`,
                  f = `<details>
...
<ul>
  ...
  <li>Proxying mode: ${this.data.translateProxyEnabled}</li>
                  ...
                  p = `1-bug-report-${O.j.lang === "ru" ? "ru" : "en"}.yml`;
                return {
            ...
            function findContainer(d, f) {
              if ((b.A.log("findContainer", d, f), d.shadowRoot)) {
                ...
                return (
                  b.A.log("findContainer with site.shadowRoot", p),
                  p ?? f.parentElement
                );
              }
              if ((b.A.log("findContainer without shadowRoot"), !d.selector))
                return f.parentElement;
              let p = document.querySelectorAll(d.selector);
              return (
                Array.from(p).find((d) => d.contains(f)) ?? f.parentElement
              );
            }
            function initIframeInteractor() {
              let d = {
                  "https://dev.epicgames.com": {
                    ...
                    dataFilter: (d) =>
                      typeof d == "string" && d.startsWith("getVideoId:"),
                    extractVideoId: (d) =>
                      d.pathname.split("/").slice(-2, -1)[0],
                    iframeSelector: (d) =>
                      `electra-player > iframe[src="${d}"]`,
                ...
                f = Object.entries(d).find(
                  ([d]) =>
                    window.location.origin === d &&
                    (d !== "https://dev.epicgames.com" ||
              ...
              f &&
                window.addEventListener("message", (d) => {
                  try {
                    if (d.origin !== f.targetOrigin || !f.dataFilter(d.data))
                      return;
                    let p = new URL(window.location.href),
                      m = f.extractVideoId(p);
                    if (!m) return;
                    let h = f.processRequest?.(d.data) || p.href,
                      g =
                        typeof f.iframeSelector == "function"
                          ? f.iframeSelector(h)
                          : f.iframeSelector,
            ...
            async function main() {
              if (
                ...
                (0, K.d4)() && window.location.hash.includes(K.WF))
              )
                return (0, x.q)();
              if (window.location.origin === C.xW) return await (0, w.L)();
              await O.j.update(),
                b.A.log(`Selected menu language: ${O.j.lang}`),
                initIframeInteractor(),
                $.onVideoAdded.addListener(async (d) => {
                  if (ee.has(d)) return;
                  let f,
                    p = (0, _.cQ)().find(
                      (p) => ((f = findContainer(p, d)), !!f),
                    );
                  if (p) {
                    ["peertube", "directlink"].includes(p.host) &&
                      (p.url = window.location.origin);
                    try {
                      let m = new VideoHandler(d, f, p);
                      (m.videoData = await m.getVideoData()),
                        await m.init(),
                        ee.set(d, m);
                    } catch (d) {
                      console.error(
                        "[VOT] Failed to initialize videoHandler",
                        d,
                      );
                    }
                  }
      ...
      "./src/localization/localizationProvider.ts": (d, f, p) => {
        ...
        p.a(
          ...
          async (d, m) => {
            try {
              p.d(f, { j: () => T });
              var h = p("./src/localization/locales/en.json"),
                g = p("./src/config/config.js"),
                _ = p("./src/utils/debug.ts"),
                v = p("./src/utils/gm.ts"),
                b = p("./src/utils/localization.ts"),
                x = p("./src/utils/storage.ts"),
                C = p("./src/utils/utils.ts"),
                w = d([v, b, x, C]);
              ...
              class LocalizationProvider {
                ...
                async init() {
                  (this._langOverride = await x.d.get(
                    "localeLangOverride",
                    "auto",
                  )),
                ...
                async changeLang(d) {
                  ...
                  return f === d
                    ? !1
                    : (await x.d.set("localeLangOverride", d),
                      (this._langOverride = d),
                      (this.lang = this.getLang()),
                      await this.update(!0),
                      !0);
                }
                async checkUpdates(d = !1) {
                  ...
                  try {
                    ...
                    let p = await f.json();
                    return (await x.d.get("localeHash")) === p[this.lang]
                      ? !1
                      : p[this.lang];
                  } catch (d) {
                    return (
                ...
                async update(d = !1) {
                  ...
                  if (
                    !d &&
                    f + this.cacheTTL > (0, C.lg)() &&
                    (await x.d.get("localeLang")) === this.lang
                  )
                    return this;
                  let p = await this.checkUpdates(d);
                  if ((await x.d.set("localeUpdatedAt", (0, C.lg)()), !p))
                    return this;
                  _.A.log("Updating locale...");
                  try {
                    let f = await (0, v.G3)(
                      this.buildUrl(`/locales/${this.lang}.json`, d),
                    );
                    if (!f.ok) throw f.status;
                    let m = await f.text();
                    await x.d.set("localePhrases", m),
                      await x.d.set("localeHash", p),
                      await x.d.set("localeLang", this.lang),
                      this.setLocaleFromJsonString(m);
                  } catch (d) {
                    console.error(
                      "[VOT] [localizationProvider] Failed to get locale:",
                      d,
                    ),
                      this.setLocaleFromJsonString(
                        await x.d.get("localePhrases", ""),
                      );
                  }
                  return this;
                }
                setLocaleFromJsonString(d) {
                  try {
                    ...
                    console.error("[VOT] [localizationProvider]", d),
                      (this.locale = {});
                  }
                  return this;
                }
                ...
                get(d) {
                  return (
                    this.getFromLocale(this.locale, d) ?? this.getDefault(d)
                  );
                }
              }
      ...
      "./src/subtitles.js": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/@vot.js/shared/dist/utils/subs.js"),
              g = p("./node_modules/lit-html/lit-html.js"),
              _ = p("./src/config/config.js"),
              v = p("./src/localization/localizationProvider.ts"),
              b = p("./src/ui.js"),
              x = p("./src/ui/components/tooltip.ts"),
              C = p("./src/utils/gm.ts"),
              w = p("./src/utils/localization.ts"),
              T = p("./src/utils/storage.ts"),
              E = p("./src/utils/translateApis.ts"),
              D = p("./src/utils/utils.ts"),
              O = d([v, b, x, C, w, T, E, D]);
            ...
            class SubtitlesProcessor {
              static formatYandexTokens(d) {
                ...
                return d.tokens.reduce((p, m, h) => {
                  ...
                  if (
                    ...
                    let d = m.startMs + m.durationMs,
                      h = g.startMs ? g.startMs - d : f - d;
                    p.push({
                      text: " ",
                      startMs: d,
                      durationMs: h,
              ...
              static createTokens(d, f) {
                let p = d.text.split(/([\n \t])/).reduce((d, p) => {
                    ...
                    let m = d[d.length - 1] ?? f,
                      h = m?.alignRange?.end ?? 0,
                      g = h + p.length;
                    return (
                      d.push({
                        text: p,
                  ...
                  m = Math.floor(d.durationMs / p.length),
                  h = d.startMs + d.durationMs;
                return p.map((f, g) => {
                  let _ = g === p.length - 1,
                    v = d.startMs + m * g,
                    b = _ ? h - v : m;
              ...
              static processTokens(d, f) {
                let p = [],
                  m,
                  { source: h, isAutoGenerated: g } = f;
                for (let f of d.subtitles) {
                  let d = f?.tokens?.length,
                    _ =
                      d && (h === "yandex" || (h === "youtube" && g))
                        ? SubtitlesProcessor.formatYandexTokens(f)
                        : SubtitlesProcessor.createTokens(f, m);
                  (m = _[_.length - 1]),
                    p.push({
                      ...f,
                      tokens: _,
              ...
              static formatYoutubeSubtitles(d, f = !1) {
                if (!d?.events?.length)
                  return (
                    console.error("[VOT] Invalid YouTube subtitles format:", d),
                    {
                      containsTokens: f,
                      subtitles: [],
                    }
                ...
                for (let m = 0; m < d.events.length; m++) {
                  ...
                  let g = h.dDurationMs;
                  d.events[m + 1] &&
                    h.tStartMs + h.dDurationMs > d.events[m + 1].tStartMs &&
                    (g = d.events[m + 1].tStartMs - h.tStartMs);
                  let _ = [],
                    v = g;
                  for (let d = 0; d < h.segs.length; d++) {
                    ...
                    let m = f.tOffsetMs ?? 0,
                      b = g,
                      x = h.segs[d + 1];
                    x?.tOffsetMs && ((b = x.tOffsetMs - m), (v -= b)),
                      _.push({
                        text: p,
              ...
              static async fetchSubtitles(d) {
                ...
                try {
                  let _ = await (0, C.G3)(g, { timeout: 7e3 }),
                    v;
                  ...
                  return (
                    f === "youtube"
                      ? (v = SubtitlesProcessor.formatYoutubeSubtitles(v, p))
                      : f === "vk" &&
                        (v = SubtitlesProcessor.cleanJsonSubtitles(v)),
                    (v.subtitles = SubtitlesProcessor.processTokens(v, d)),
                    console.log("[VOT] Processed subtitles:", v),
                    v
                  );
                } catch (d) {
                  return (
                    console.error("[VOT] Failed to process subtitles:", d),
                    {
                      containsTokens: !1,
                      subtitles: [],
                    }
              ...
              static async getSubtitles(d, f) {
                ...
                try {
                  ...
                  console.log("[VOT] Subtitles response:", f),
                    f.waiting &&
                      console.error("[VOT] Failed to get Yandex subtitles");
                  let b = (f.subtitles ?? []).reduce(
                    (d, f) => (
                      f.language &&
                        !d.find(
                          (d) =>
                  ...
                  return [...b, ...v].sort((d, f) => {
                    if (d.source !== f.source)
                      return d.source === "yandex" ? -1 : 1;
                    if (
                      d.language !== f.language &&
                      (d.language === w.v || f.language === w.v)
                    )
                      return d.language === w.v ? -1 : 1;
                    if (d.source === "yandex") {
                      if (d.translatedFromLanguage !== f.translatedFromLanguage)
                        return !d.translatedFromLanguage ||
                          !f.translatedFromLanguage
                          ? d.language === f.language
                            ? d.translatedFromLanguage
                              ? 1
                              : -1
                            : d.translatedFromLanguage
                              ? -1
                              : 1
                          : d.translatedFromLanguage === h
                            ? -1
                            : 1;
                      if (!d.translatedFromLanguage)
                        return d.language === h ? -1 : 1;
                    }
                    return d.source !== "yandex" &&
                      d.isAutoGenerated !== f.isAutoGenerated
                      ? d.isAutoGenerated
                        ? 1
                        : -1
                      : 0;
            ...
            class SubtitlesWidget {
              ...
              createSubtitlesContainer() {
                return (
                  (this.subtitlesContainer =
                    document.createElement("vot-block")),
              ...
              bindEvents() {
                let { signal: d } = this.abortController;
                (this.onPointerDownBound = (d) => this.onPointerDown(d)),
                  (this.onPointerUpBound = () => this.onPointerUp()),
                  (this.onPointerMoveBound = (d) => this.onPointerMove(d)),
              ...
              onPointerDown(d) {
                ...
                let f = this.subtitlesContainer.getBoundingClientRect(),
              ...
              onPointerMove(d) {
                ...
                d.preventDefault();
                let { width: f, height: p } =
                    this.container.getBoundingClientRect(),
                  { containerOffset: m, offset: h } = this.dragging;
                (this.position = {
              ...
              applySubtitlePosition() {
                let { width: d, height: f } = this.containerRect,
                  { offsetWidth: p, offsetHeight: m } = this.subtitlesContainer,
                  h = ((d - p) / d) * 100,
                  g = ((f - m) / f) * 100;
                (this.position.left = Math.max(
                  0,
                  Math.min(this.position.left, h),
                )),
                  (this.position.top = Math.max(
                    0,
                    Math.min(this.position.top, g),
                  )),
              ...
              processTokens(d) {
                ...
                return (
                  f.find(
                    (d) =>
                      d[0].startMs < h &&
                      h < d.at(-1).startMs + d.at(-1).durationMs,
                  ) || f[0]
                );
              }
              trimChunk(d) {
              ...
              onClick = async (d) => {
                if (
                  this.tokenTooltip?.target === d.target &&
                ...
                let f = d.target.textContent.trim().replace(/[.|,]/, ""),
                  p = await T.d.get("translationService", _.mE),
                  m = b.A.createSubtitleInfo(
                    f,
                ...
                let h = this.strTokens,
                  g = await this.translateStrTokens(f);
                h !== this.strTokens ||
                  !this.tokenTooltip?.showed ||
                  ((m.header.textContent = g[1]),
                  (m.context.textContent = g[0]),
                  this.tokenTooltip.setContent(m.container),
                  this.tokenTooltip.create());
              };
              renderTokens(d, f) {
                return d.map((d) => {
                  let p =
                    this.highlightWords &&
                    (f > d.startMs + d.durationMs / 2 ||
                      (f > d.startMs - 100 &&
                        d.startMs + d.durationMs / 2 - f < 275));
                  return (0, g.qy)`<span
        @click="${this.onClick}"
        class="${p ? "passed" : ""}"
      >
        ${d.text.replace("\\n", "<br>")}
              ...
              setContent(d, f = void 0) {
                if (
                  ...
                  (this.subtitles = null),
                    (0, g.XX)(null, this.subtitlesContainer);
                  return;
                }
              ...
              setFontSize(d) {
                (this.fontSize = d),
                  this.subtitlesBlock &&
                    (this.subtitlesBlock.style.fontSize = `${d}px`);
              }
              setOpacity(d) {
                (this.opacity = ((100 - d) / 100).toFixed(2)),
                  this.subtitlesBlock &&
              ...
              update() {
                ...
                let d = this.video.currentTime * 1e3,
                  f = this.subtitles.subtitles.findLast(
                    (f) => f.startMs < d && d < f.startMs + f.durationMs,
                  );
                if (!f) {
                  (0, g.XX)(null, this.subtitlesContainer),
                ...
                let p = this.processTokens(f.tokens),
                  m = this.renderTokens(p, d),
                  h = JSON.stringify(m);
      ...
      "./src/types/components/tooltip.ts": (d, f, p) => {
        ...
        let m = ["left", "top", "right", "bottom"],
          h = ["hover", "click"];
      },
      "./src/types/components/votButton.ts": (d, f, p) => {
        "use strict";
        p.d(f, { X: () => m });
        let m = ["default", "top", "left", "right"],
          h = null;
      },
      ...
      "./src/ui.js": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            p.d(f, { A: () => UI });
            var h = p("./node_modules/lit-html/lit-html.js"),
              g = p("./src/styles/main.scss"),
              _ = p("./src/localization/localizationProvider.ts"),
              v = d([_]);
            ...
            class UI {
              static createEl(d, f = [], p = null) {
                ...
                return (
                  f.length && m.classList.add(...f),
                  p !== null && m.append(p),
                  m
                );
              }
              static createHeader(d, f = 4) {
                let p = UI.createEl("vot-block", [
                  "vot-header",
                  `vot-header-level-${f}`,
                ]);
                return p.append(d), p;
              ...
              static createInformation(d, f) {
                let p = UI.createEl("vot-block", ["vot-info"]),
                  m = UI.createEl("vot-block");
                (0, h.XX)(d, m);
              ...
              static createSubtitleInfo(d, f, p) {
                ...
                let h = UI.createEl(
                    ...
                    _.j.get("VOTTranslatedBy").replace("{0}", p),
                  ),
                  g = UI.createEl(
                    "vot-block",
            ...
            class AccountButton {
              ...
              constructor({
                ...
                (this.container = m.container),
                  (this.accountWrapper = m.accountWrapper),
                  (this.buttons = m.buttons),
                  (this.usernameEl = m.usernameEl),
                  (this.avatarEl = m.avatarEl),
                  (this.avatarImg = m.avatarImg),
                  (this.actionButton = m.actionButton),
                  (this.refreshButton = m.refreshButton),
                  (this.tokenButton = m.tokenButton);
              }
              createElements() {
                let d = v.A.createEl("vot-block", ["vot-account"]),
                  f = v.A.createEl("vot-block", ["vot-account-wrapper"]);
                f.hidden = !this._loggedIn;
                let p = v.A.createEl("img", ["vot-account-avatar-img"]);
                (p.src = `${h.cL}/${this._avatarId}/islands-retina-middle`),
                  (p.loading = "lazy"),
                  (p.alt = "user avatar");
                let m = v.A.createEl("vot-block", ["vot-account-avatar"], p),
                  g = v.A.createEl("vot-block", ["vot-account-username"]);
                (g.textContent = this._username), f.append(m, g);
                let _ = v.A.createEl("vot-block", ["vot-account-buttons"]),
                  x = v.A.createOutlinedButton(this.buttonText);
                x.addEventListener("click", () => {
                  this.onClick.dispatch();
                });
                let C = v.A.createIconButton(b.GA);
                (C.hidden = this._loggedIn),
              ...
              set avatarId(d) {
                (this._avatarId = d ?? "0/0-0"),
                  (this.avatarImg.src = `${h.cL}/${this._avatarId}/islands-retina-middle`);
              }
              get username() {
                return this._username;
              }
              set username(d) {
                (this._username = d ?? "unnamed"),
          ...
          try {
            ...
            class Checkbox {
              ...
              createElements() {
                ...
                (f.type = "checkbox"),
                  (f.checked = this._checked),
                  f.addEventListener("change", () => {
                    (this._checked = f.checked),
                      this.onChange.dispatch(this._checked);
                  });
                let p = _.A.createEl("span");
                return (
                  (0, h.XX)(this._labelHtml, p),
                  d.append(f, p),
                  {
                    container: d,
                    input: f,
              ...
              set checked(d) {
                this._checked !== d &&
                  ((this._checked = this.input.checked = d),
                  this.onChange.dispatch(this._checked));
              }
            }
            m();
            ...
            class Details {
              ...
              constructor({ titleHtml: d }) {
                ...
                (this.container = f.container),
                  ...
                  (this.arrowIcon = f.arrowIcon);
              }
              createElements() {
                let d = _.A.createEl("vot-block", ["vot-details"]),
                  f = _.A.createEl("vot-block");
            ...
            class Dialog {
              ...
              constructor({ titleHtml: d, isTemp: f = !1 }) {
                ...
                (this.container = p.container),
                  (this.backdrop = p.backdrop),
                  (this.box = p.box),
                  (this.contentWrapper = p.contentWrapper),
                  (this.headerContainer = p.headerContainer),
                  (this.titleContainer = p.titleContainer),
                  (this.title = p.title),
                  (this.closeButton = p.closeButton),
                  (this.bodyContainer = p.bodyContainer),
                  (this.footerContainer = p.footerContainer);
              }
              createElements() {
                let d = g.A.createEl("vot-block", ["vot-dialog-container"]);
                this._isTemp && d.classList.add("vot-dialog-temp"),
                  (d.hidden = !this._isTemp);
                let f = g.A.createEl("vot-block", ["vot-dialog-backdrop"]),
                  p = g.A.createEl("vot-block", ["vot-dialog"]),
                  m = g.A.createEl("vot-block", ["vot-dialog-content-wrapper"]),
                  h = g.A.createEl("vot-block", [
                    "vot-dialog-header-container",
                  ]),
                  v = g.A.createEl("vot-block", ["vot-dialog-title-container"]),
                  b = g.A.createEl("vot-block", ["vot-dialog-title"]);
                b.append(this._titleHtml), v.appendChild(b);
                let x = g.A.createIconButton(_.jr);
                x.classList.add("vot-dialog-close-button"),
                  ...
                  h.append(v, x);
                let C = g.A.createEl("vot-block", [
                    "vot-dialog-body-container",
                  ]),
                  w = g.A.createEl("vot-block", [
              ...
              close() {
                return this._isTemp
                  ? this.remove()
                  : ((this.hidden = !0), this.onClose.dispatch(), this);
              }
              set hidden(d) {
                this.container.hidden = d;
              }
            ...
            class DownloadButton {
              ...
              constructor() {
                ...
                (this.button = d.button),
                  (this.loaderMain = d.loaderMain),
                  (this.loaderText = d.loaderText);
              }
              createElements() {
                let d = g.A.createIconButton(_.nO),
                  f = d.querySelector(".vot-loader-main"),
                  p = d.querySelector(".vot-loader-text");
                return (
                  d.addEventListener("click", () => {
                    this.onClick.dispatch();
                  }),
              ...
              set progress(d) {
                (this._progress = d),
                  (this.loaderText.textContent = d === 0 ? "" : d.toString()),
                  !(d > 1) &&
                    (this.loaderMain.style.opacity = d === 0 ? "1" : "0");
              }
              set hidden(d) {
      ...
      "./src/ui/components/hotkeyButton.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./src/core/eventImpl.ts"),
              g = p("./src/localization/localizationProvider.ts"),
              _ = p("./src/ui.js"),
              v = d([g, _]);
            ...
            class HotkeyButton {
              ...
              keydownHandle = (d) => {
                if (!(!this.recording || d.repeat)) {
                  ...
                  this.pressedKeys.add(d.code),
                    (this.button.textContent = formatKeysCombo(
                      this.pressedKeys,
                    ));
                }
              };
              ...
              createElements() {
                let d = _.A.createEl("vot-block", ["vot-hotkey"]),
                  f = _.A.createEl("vot-block", ["vot-hotkey-label"]);
                f.textContent = this._labelHtml;
                let p = _.A.createEl("vot-block", ["vot-hotkey-button"]);
                return (
                  (p.textContent = this.keyText),
                  p.addEventListener("click", () => {
                    (p.dataset.status = "active"),
                      (this.recording = !0),
                      this.pressedKeys.clear(),
                      (this.button.textContent = g.j.get(
            ...
            function formatKeysCombo(d) {
              ...
              return f
                .map((d) => d.replace("Key", "").replace("Digit", ""))
                .join("+");
            }
            m();
          } catch (d) {
          ...
          try {
            ...
            class Label {
              ...
              createElements() {
                ...
                return (
                  this._icon && (0, h.XX)(this._icon, f),
                  d.appendChild(f),
                  {
                    container: d,
                    icon: f,
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/lit-html/lit-html.js"),
              ...
              _ = p("./src/ui.js"),
              v = p("./src/ui/icons.ts"),
              b = p("./src/ui/components/select.ts"),
              x = d([g, _, b]);
            ...
            class LanguagePairSelect {
              ...
              constructor({
                from: {
                  selectTitle: d = g.j.get("videoLanguage"),
                  dialogTitle: f = g.j.get("videoLanguage"),
                  items: p,
                },
                to: {
                  selectTitle: m = g.j.get("translationLanguage"),
                  dialogTitle: h = g.j.get("translationLanguage"),
                  items: _,
                },
                dialogParent: v = document.documentElement,
              }) {
                (this._fromSelectTitle = d),
                  (this._fromDialogTitle = f),
                  (this._fromItems = p),
                  (this._toSelectTitle = m),
                  (this._toDialogTitle = h),
                  (this._toItems = _),
                  (this.dialogParent = v);
                let b = this.createElements();
                (this.container = b.container),
                  (this.fromSelect = b.fromSelect),
                  (this.directionIcon = b.directionIcon),
                  (this.toSelect = b.toSelect);
              }
              createElements() {
                let d = _.A.createEl("vot-block", ["vot-lang-select"]),
                  f = new b.A({
                ...
                return (
                  d.append(f.container, p, m.container),
                  {
                    container: d,
                    fromSelect: f,
                    directionIcon: p,
              ...
              setSelectedValues(d, f) {
                return (
                  this.fromSelect.setSelectedValue(d),
                  this.toSelect.setSelectedValue(f),
                  this
                );
              }
              updateItems(d, f) {
                return (
                  (this._fromItems = d),
                  (this._toItems = f),
                  (this.fromSelect = this.fromSelect.updateItems(d)),
                  (this.toSelect = this.toSelect.updateItems(f)),
                  this
                );
              }
            }
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/lit-html/lit-html.js"),
              ...
              v = p("./src/ui.js"),
              b = p("./src/ui/icons.ts"),
              x = p("./src/ui/components/dialog.ts"),
              C = p("./src/ui/components/textfield.ts"),
              w = d([_, v, x, C]);
            ...
            class Select {
              ...
              constructor({
                ...
                items: p,
                labelElement: m,
                dialogParent: h = document.documentElement,
                multiSelect: g,
              }) {
                (this._selectTitle = d),
                  (this._dialogTitle = f),
                  (this._items = p),
                  (this.multiSelect = g ?? !1),
                  (this.labelElement = m),
                  (this.dialogParent = h),
              ...
              multiSelectItemHandle = (d, f) => {
                let p = f.value;
                this.selectedValues.has(p) && this.selectedValues.size > 1
                  ? (this.selectedValues.delete(p), (f.selected = !1))
                  : (this.selectedValues.add(p), (f.selected = !0)),
                  (d.dataset.votSelected = this.selectedValues
                    .has(p)
                    .toString()),
              ...
              singleSelectItemHandle = (d) => {
                ...
                for (let d of this.selectedItems)
                  d.dataset.votSelected = (d.dataset.votValue === f).toString();
              ...
              createDialogContentList() {
                ...
                for (let f of this._items) {
                  let p = v.A.createEl("vot-block", [
                    "vot-select-content-item",
                  ]);
                  (p.textContent = f.label),
                    (p.dataset.votSelected =
                      f.selected === !0 ? "true" : "false"),
                    (p.dataset.votValue = f.value),
                    f.disabled && (p.inert = !0),
                    p.addEventListener("click", (d) => {
                      if (!d.target.inert)
                        return this.multiSelect
                          ? this.multiSelectItemHandle(p, f)
                          : this.singleSelectItemHandle(f);
                    }),
                    d.appendChild(p);
                }
              ...
              createElements() {
                ...
                let f = v.A.createEl("vot-block", ["vot-select-outer"]),
                  p = v.A.createEl("vot-block", ["vot-select-title"]);
                  ...
                  f.addEventListener("click", () => {
                    if (!(this.isLoading || this.isDialogOpen))
                      try {
                        ...
                        this.onBeforeOpen.dispatch(d),
                          this.dialogParent.appendChild(d.container);
                        ...
                        f.addEventListener("input", (d) => {
                          ...
                          d.bodyContainer.append(f.container, this.contentList),
              ...
              calcSelectedValues() {
                return new Set(
                  this._items.filter((d) => d.selected).map((d) => d.value),
                );
              }
              addEventListener(d, f) {
                return (
                  d === "selectItem"
                    ? this.onSelectItem.addListener(f)
                    : d === "beforeOpen" && this.onBeforeOpen.addListener(f),
                  this
                );
              }
              removeEventListener(d, f) {
                return (
                  d === "selectItem"
                    ? this.onSelectItem.removeListener(f)
                    : d === "beforeOpen" && this.onBeforeOpen.removeListener(f),
                  this
                );
              }
              updateTitle() {
              ...
              setSelectedValue(d) {
                this.multiSelect
                  ...
                  : (this.selectedValues = new Set([String(d)]));
                for (let d of this._items)
                  d.selected = this.selectedValues.has(String(d.value));
              ...
              updateItems(d) {
                ...
                return (
                  (this.contentList = this.createDialogContentList()),
                  f.replaceChild(this.contentList, p),
                  this
                );
              }
              get visibleText() {
                return this.multiSelect
                  ? (this._items
                      .filter((d) => this.selectedValues.has(d.value))
                      .map((d) => d.label)
                      .join(", ") ?? this._selectTitle)
                  : (this._items.find((d) => d.selected)?.label ??
                      this._selectTitle);
              }
              set selectTitle(d) {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            class Slider {
              ...
              createElements() {
                let d = _.A.createEl("vot-block", ["vot-slider"]),
                  f = document.createElement("input");
                (f.type = "range"),
                  (f.min = this._min.toString()),
                  (f.max = this._max.toString()),
                  (f.step = this._step.toString()),
                  (f.value = this._value.toString());
                let p = _.A.createEl("span");
                return (
                  (0, h.XX)(this._labelHtml, p),
                  d.append(f, p),
              ...
              set value(d) {
                (this._value = d),
                  (this.input.value = d.toString()),
                  this.updateProgress(),
                  this.onInput.dispatch(this._value, !0);
              }
              get min() {
                return this._min;
              }
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            class Textfield {
              ...
              createElements() {
                let d = g.A.createEl("vot-block", ["vot-textfield"]),
                  f = document.createElement(
                    this._multiline ? "textarea" : "input",
                  );
                this._labelHtml || f.classList.add("vot-show-placeholer"),
                  (f.placeholder = this._placeholder),
                  (f.value = this._value);
                let p = g.A.createEl("span");
                return (
                  p.append(this._labelHtml),
                  d.append(f, p),
                  f.addEventListener("input", () => {
              ...
              addEventListener(d, f) {
                return (
                  d === "change"
                    ...
                    : d === "input" && this.onInput.addListener(f),
                  this
                );
              }
              removeEventListener(d, f) {
                return (
                  d === "change"
                    ? this.onChange.removeListener(f)
                    : d === "input" && this.onInput.removeListener(f),
                  this
                );
              }
              get value() {
              ...
              set value(d) {
                this._value !== d &&
                  ((this.input.value = this._value = d),
                  this.onChange.dispatch(this._value));
              }
              get placeholder() {
      ...
      "./src/ui/components/tooltip.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            p.d(f, { A: () => Tooltip });
            var h = p("./src/types/components/tooltip.ts"),
              g = p("./src/ui.js"),
              _ = p("./src/utils/utils.ts"),
              v = d([g, _]);
            [g, _] = v.then ? (await v)() : v;
            class Tooltip {
              showed = !1;
              ...
              constructor({
                ...
                hidden: v = !1,
                autoLayout: b = !0,
                backgroundColor: x = void 0,
                borderRadius: C = void 0,
                bordered: w = !0,
                parentElement: T = document.body,
                layoutRoot: E = document.documentElement,
              }) {
                if (!(d instanceof HTMLElement))
                  throw Error("target must be a valid HTMLElement");
                (this.target = d),
                  (this.anchor = f instanceof HTMLElement ? f : d),
                  (this.content = p),
                  typeof g == "number"
                    ? (this.offsetY = this.offsetX = g)
                    : ((this.offsetX = g.x), (this.offsetY = g.y)),
                  (this.hidden = v),
                  (this.autoLayout = b),
                  (this.trigger = Tooltip.validateTrigger(h) ? h : "hover"),
                  (this.position = Tooltip.validatePos(m) ? m : "top"),
              ...
              setPosition(d) {
                return (
                  (this.position = Tooltip.validatePos(d) ? d : "top"),
                  this.updatePos(),
                  this
                );
              }
              ...
              updatePageSize() {
                ...
                return (
                  (this.pageWidth =
                    (this.layoutRoot.clientWidth ||
                      document.documentElement.clientWidth) +
                    window.pageXOffset),
                  (this.pageHeight =
                    (this.layoutRoot.clientHeight ||
                ...
                return (
                  ...
                  this.trigger === "click"
                    ...
                    : (this.target.addEventListener(
                      ...
                      this.target.addEventListener(
                        "pointerdown",
                        this.onHoverPointerDown,
                      ),
                      this.target.addEventListener(
                        "pointerup",
                        this.onHoverPointerUp,
                      ),
                      this)
                );
              }
              ...
              create() {
                return (
                  ...
                  this.hidden && (this.container.hidden = !0),
              ...
              updatePos() {
                ...
                let { top: d, left: f } = this.calcPos(this.autoLayout),
                  p = this.pageWidth - this.offsetX * 2,
                  m =
                    this.maxWidth ??
                    Math.min(
                      p,
                      this.pageWidth - Math.min(f, this.pageWidth - p),
                    );
                return (
                  (this.container.style.transform = `translate(${f}px, ${d}px)`),
                  (this.container.style.maxWidth = `${m}px`),
                  this
                );
              }
              calcPos(d = !0) {
                ...
                let {
                  ...
                  { width: b, height: x } =
                    this.container.getBoundingClientRect(),
                  C = (0, _.qE)(b, 0, this.pageWidth),
                  w = (0, _.qE)(x, 0, this.pageHeight),
                  T = f - this.globalOffsetX,
                  E = p - this.globalOffsetX,
                  D = m - this.globalOffsetY,
                  O = h - this.globalOffsetY;
                switch (this.position) {
                  case "top": {
                    let f = (0, _.qE)(D - w - this.offsetY, 0, this.pageHeight);
                    return d && f + this.offsetY < w
                      ? ((this.position = "bottom"), this.calcPos(!1))
                      : {
                          top: f,
                          left: (0, _.qE)(
                            T - C / 2 + g / 2,
                            this.offsetX,
                            this.pageWidth - C - this.offsetX,
                          ),
                        };
                  }
                  case "right": {
                    let f = (0, _.qE)(E + this.offsetX, 0, this.pageWidth - C);
                    return d && f + C > this.pageWidth - this.offsetX
                      ? ((this.position = "left"), this.calcPos(!1))
                      : {
                          top: (0, _.qE)(
                            D + (v - w) / 2,
                            this.offsetY,
                            this.pageHeight - w - this.offsetY,
                          ),
                          left: f,
                        };
                  }
                  case "bottom": {
                    ...
                    return d && f + w > this.pageHeight - this.offsetY
                      ? ((this.position = "top"), this.calcPos(!1))
                      : {
                          top: f,
                          left: (0, _.qE)(
                            T - C / 2 + g / 2,
                  ...
                  case "left": {
                    ...
                    return d && f + C > T - this.offsetX
                      ? ((this.position = "right"), this.calcPos(!1))
                      : {
                          top: (0, _.qE)(
                            D + (v - w) / 2,
                            this.offsetY,
          ...
          try {
            ...
            class VOTButton {
              ...
              constructor({
                ...
                let h = this.createElements();
                (this.container = h.container),
                  (this.translateButton = h.translateButton),
                  (this.separator = h.separator),
                  (this.pipButton = h.pipButton),
                  (this.separator2 = h.separator2),
                  (this.menuButton = h.menuButton),
                  (this.label = h.label);
              }
              ...
              createElements() {
                ...
                (d.dataset.position = this._position),
                  (d.dataset.direction = this._direction),
                  (d.dataset.status = this._status);
                let f = g.A.createEl("vot-block", [
                  "vot-segment",
                ...
                let m = g.A.createEl("vot-block", ["vot-separator"]),
                  v = g.A.createEl("vot-block", ["vot-segment-only-icon"]);
                (0, h.XX)(_.B9, v);
                let b = g.A.createEl("vot-block", ["vot-separator"]),
                  x = g.A.createEl("vot-block", ["vot-segment-only-icon"]);
                return (
                  (0, h.XX)(_.kO, x),
                  d.append(f, m, v, b, x),
                  {
              ...
              showPiPButton(d) {
                return (
                  (this.separator2.hidden = this.pipButton.hidden = !d), this
                );
              }
              setText(d) {
          ...
          try {
            ...
            class VOTMenu {
              ...
              createElements() {
                ...
                d.appendChild(f);
                let p = h.A.createEl("vot-block", [
                    "vot-menu-header-container",
                  ]),
                  m = h.A.createEl("vot-block", ["vot-menu-title-container"]);
                p.appendChild(m);
                let g = h.A.createEl("vot-block", ["vot-menu-title"]);
                g.append(this._titleHtml), m.appendChild(g);
                let _ = h.A.createEl("vot-block", ["vot-menu-body-container"]),
                  v = h.A.createEl("vot-block", ["vot-menu-footer-container"]);
                return (
                  f.append(p, _, v),
                  {
                    container: d,
      ...
      "./src/ui/icons.ts": (d, f, p) => {
        ...
        let h = (0,
          m.JW)`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
  <path
  ...
  ></path>
          ...
          g = (0,
          m.JW)`<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
  <path
  ...
  />
          ...
          v = (0,
          m.JW)`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="100%" viewBox="0 0 24 24" class="vot-loader" id="vot-loader-download">
  ...
  <text class="vot-loader-text" dominant-baseline="middle" text-anchor="middle" x="50%" y="50%"></text>
          ...
          b = (0,
          m.JW)`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="100%" viewBox="0 0 24 24">
  <path d="M4 20q-.825 0-1.413-.588T2 18V6q0-.825.588-1.413T4 4h16q.825 0 1.413.588T22 6v12q0 .825-.588 1.413T20 20H4Zm2-4h8v-2H6v2Zm10 0h2v-2h-2v2ZM6 12h2v-2H6v2Zm4 0h8v-2h-8v2Z"/>
          ...
          x = (0,
          m.JW)`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="100%" viewBox="0 -960 960 960">
  ...
  <path fill="currentColor" d="M7 15q1.25 0 2.125-.875T10 12t-.875-2.125T7 9t-2.125.875T4 12t.875 2.125T7 15m0 3q-2.5 0-4.25-1.75T1 12t1.75-4.25T7 6q2.025 0 3.538 1.15T12.65 10h8.375L23 11.975l-3.5 4L17 14l-2 2l-2-2h-.35q-.625 1.8-2.175 2.9T7 18"/>
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/@vot.js/shared/dist/utils/subs.js"),
              ...
              _ = p("./src/config/config.js"),
              v = p("./src/localization/localizationProvider.ts"),
              b = p("./src/utils/VOTLocalizedError.js"),
              x = p("./src/utils/debug.ts"),
              C = p("./src/utils/gm.ts"),
              w = p("./src/utils/storage.ts"),
              T = p("./src/utils/utils.ts"),
              E = p("./src/ui/components/votButton.ts"),
              D = p("./src/ui/views/overlay.ts"),
              O = p("./src/ui/views/settings.ts"),
              A = d([g, v, b, C, w, T, E, D, O]);
            ...
            class UIManager {
              ...
              constructor({
                ...
                (this.root = d),
                  (this.portalContainer = f),
                  (this.tooltipLayoutRoot = p),
                  (this.videoHandler = h),
                  (this.data = m);
              }
              isInitialized() {
              ...
              initUI() {
                if (this.isInitialized())
                  throw Error("[VOT] UIManager is already initialized");
                return (
                  (this.initialized = !0),
                  (this.votGlobalPortal = g.A.createPortal()),
                  document.documentElement.appendChild(this.votGlobalPortal),
                  (this.votOverlayView = new D.i({
                    root: this.root,
              ...
              initUIEvents() {
                if (!this.isInitialized())
                  throw Error("[VOT] UIManager isn't initialized");
                this.votOverlayView.initUIEvents(),
                  this.votOverlayView
                    ...
                    .addEventListener("click:downloadTranslation", async () => {
                      if (
                        ...
                        try {
                          if (!this.data.downloadWithName || !C.yx)
                            return (0, T.Wo)(
                              this.videoHandler.downloadTranslationUrl,
                            );
                          ...
                          await (0, T.MR)(d, f, (d) => {
                            this.votOverlayView.downloadTranslationButton.progress =
                              d;
                          });
                        } catch (d) {
                          console.error(
                            "[VOT] Download translation failed:",
                            d,
                          ),
                            (0, T.Wo)(this.videoHandler.downloadTranslationUrl);
                        }
                        this.votOverlayView.downloadTranslationButton.progress = 0;
                      }
                    })
                    .addEventListener("click:downloadSubtitles", async () => {
                      if (
                        ...
                        return;
                      let d = this.data.subtitlesDownloadFormat ?? "json",
                        f = (0, h.vk)(this.videoHandler.yandexSubtitles, d),
                        p = new Blob([d === "json" ? JSON.stringify(f) : f], {
                          type: "text/plain",
                        }),
                        m = this.data.downloadWithName
                          ? (0, T.Le)(this.videoHandler.videoData.downloadTitle)
                          : `subtitles_${this.videoHandler.videoData.videoId}`;
                      (0, T.WN)(p, `${m}.${d}`);
                    })
                    .addEventListener("input:videoVolume", (d) => {
                      this.videoHandler &&
                        (this.videoHandler.setVideoVolume(d / 100),
                        this.data.syncVolume &&
                          this.videoHandler.syncVolumeWrapper("video", d));
                    })
                    .addEventListener("input:translationVolume", () => {
                      if (!this.videoHandler) return;
                      let d = this.data.defaultVolume ?? 100;
                      (this.videoHandler.audioPlayer.player.volume = d / 100),
                        this.data.syncVolume &&
                          ...
                          ["youtube", "googledrive"].includes(
                            ...
                            this.videoHandler.site.additionalData !==
                              "mobile" &&
                  ...
                  this.votSettingsView
                    .addEventListener("update:account", async (d) => {
                      this.videoHandler &&
                        (this.videoHandler.votClient.apiToken = d?.token);
                    })
                    ...
                    .addEventListener("change:audioBuster", async () => {
                      ...
                      (this.votOverlayView.translationVolumeSlider.max = this
                        .data.audioBooster
                        ? _.T8
                        : 100),
                        (this.votOverlayView.translationVolumeSlider.value = (0,
                        T.qE)(d, 0, 100));
                    })
                    ...
                    .addEventListener("click:resetSettings", async () => {
                      ...
                      await Promise.all(
                        d.map(async (d) => await w.d.delete(d)),
                      ),
                        await w.d.set("compatVersion", _.r4),
                        window.location.reload();
                    });
              }
              async reloadMenu() {
                if (!this.votOverlayView?.isInitialized())
                  throw Error("[VOT] OverlayView isn't initialized");
                if (
              ...
              async handleTranslationBtnClick() {
                ...
                if (
                  (x.A.log("[handleTranslationBtnClick] click translationBtn"),
                  this.videoHandler.hasActiveSource())
                )
                  return (
                    x.A.log(
                      "[handleTranslationBtnClick] video has active source",
                    ),
                    this.videoHandler.stopTranslation(),
                    this
                  );
                ...
                try {
                  ...
                  if ((console.error("[VOT]", d), !(d instanceof Error)))
                    return this.transformBtn("error", String(d)), this;
                  let f =
                    d.name === "VOTLocalizedError"
                      ? d.localizedMessage
                      : d.message;
              ...
              isLoadingText(d) {
                return (
                  typeof d == "string" &&
                  (d.includes(v.j.get("translationTake")) ||
                    d.includes(v.j.get("TranslationDelayed")))
                );
              }
              transformBtn(d, f) {
                if (!this.votOverlayView?.isInitialized())
                  throw Error("[VOT] OverlayView isn't initialized");
                return (
                  (this.votOverlayView.votButton.status = d),
                  (this.votOverlayView.votButton.loading =
                    d === "error" && this.isLoadingText(f)),
                  this.votOverlayView.votButton.setText(f),
                  this.votOverlayView.votButtonTooltip.setContent(f),
                  this
                );
              }
              releaseUI(d = !1) {
                if (!this.isInitialized())
                  throw Error("[VOT] UIManager isn't initialized");
                return (
                  this.votOverlayView.releaseUI(!0),
                  this.votSettingsView.releaseUI(!0),
              ...
              releaseUIEvents(d = !1) {
                if (!this.isInitialized())
                  throw Error("[VOT] UIManager isn't initialized");
                return (
                  this.votOverlayView.releaseUIEvents(!1),
                  this.votSettingsView.releaseUIEvents(!1),
                  (this.initialized = d),
                  this
                );
              }
      ...
      "./src/ui/views/overlay.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            p.d(f, { i: () => OverlayView });
            var h = p("./node_modules/@vot.js/shared/dist/data/consts.js"),
              g = p("./src/ui.js"),
              _ = p("./src/ui/components/languagePairSelect.ts"),
              v = p("./src/ui/components/select.ts"),
              b = p("./src/ui/components/slider.ts"),
              x = p("./src/ui/components/sliderLabel.ts"),
              C = p("./src/ui/components/tooltip.ts"),
              w = p("./src/ui/components/votButton.ts"),
              T = p("./src/ui/components/votMenu.ts"),
              E = p("./src/ui/icons.ts"),
              D = p("./src/config/config.js"),
              O = p("./src/core/eventImpl.ts"),
              A = p("./src/localization/localizationProvider.ts"),
              j = p("./src/utils/storage.ts"),
              F = p("./src/utils/utils.ts"),
              U = p("./src/ui/components/downloadButton.ts"),
              W = p("./src/ui/components/label.ts"),
              G = d([g, _, v, b, x, C, w, T, A, j, F, U, W]);
            ...
            class OverlayView {
              ...
              initUI(d = "default") {
                if (this.isInitialized())
                  throw Error("[VOT] OverlayView is already initialized");
                this.initialized = !0;
                let { position: f, direction: p } = this.calcButtonLayout(d);
                (this.votOverlayPortal = g.A.createPortal(!0)),
                  this.portalContainer.appendChild(this.votOverlayPortal),
                  (this.votButton = new w.A({
                    position: f,
                    direction: p,
                    status: "none",
                  ...
                  this.pipButtonVisible || this.votButton.showPiPButton(!1),
                  this.root.appendChild(this.votButton.container),
                  (this.votButtonTooltip = new C.A({
                  ...
                  (this.downloadTranslationButton = new U.A()),
                  (this.downloadTranslationButton.hidden = !0),
                  (this.downloadSubtitlesButton = g.A.createIconButton(E.U0)),
                  (this.downloadSubtitlesButton.hidden = !0),
                  (this.openSettingsButton = g.A.createIconButton(E.c1)),
                ...
                let m = this.videoHandler?.videoData?.detectedLanguage ?? "en",
                  O = this.data.responseLanguage ?? "ru";
                (this.languagePairSelect = new _.A({
                  ...
                  (this.subtitlesSelectLabel = new W.A({
                    labelText: A.j.get("VOTSubtitles"),
                  })),
                  (this.subtitlesSelect = new v.A({
                ...
                (this.videoVolumeSliderLabel = new x.A({
                  ...
                  (this.videoVolumeSlider.hidden =
                    !this.data.showVideoSlider ||
                    this.votButton.status !== "success");
                let F = this.data.defaultVolume ?? 100;
                return (
                  (this.tranlsationVolumeSliderLabel = new x.A({
                  ...
                  (this.translationVolumeSlider.hidden =
                    this.votButton.status !== "success"),
              ...
              initUIEvents() {
                ...
                for (let d of this.cancelDraggingEvents)
                  document.addEventListener(d, this.disableDragging);
                return (
                  ...
                  this.downloadTranslationButton.addEventListener(
                    "click",
                    async () => {
                  ...
                  this.languagePairSelect.fromSelect.addEventListener(
                    ...
                    (d) => {
                      this.videoHandler?.videoData &&
                        (this.videoHandler.videoData.detectedLanguage = d),
                        this.onSelectFromLanguage.dispatch(d);
                    },
                  ),
                    ...
                    async (d) => {
                      this.videoHandler?.videoData &&
                        (this.videoHandler.translateToLang =
                          this.videoHandler.videoData.responseLanguage =
                            d),
                        (this.data.responseLanguage = d),
                        await j.d.set(
                          "responseLanguage",
                          this.data.responseLanguage,
                        ),
                        this.onSelectToLanguage.dispatch(d);
                    },
                  ),
                  this.subtitlesSelect.addEventListener(
                    "beforeOpen",
                    async (d) => {
                      ...
                      if (this.videoHandler.cacheManager.getSubtitles(f))
                        return;
                      this.votButton.loading = !0;
                      let p = g.A.createInlineLoader();
                      (p.style.margin = "0 auto"),
                        d.footerContainer.appendChild(p),
                        await this.videoHandler.loadSubtitles(),
                        d.footerContainer.removeChild(p),
                        (this.votButton.loading = !1);
                    },
                  ),
                  ...
                  this.videoVolumeSlider.addEventListener("input", (d, f) => {
                    (this.videoVolumeSliderLabel.value = d),
                      !f && this.onInputVideoVolume.dispatch(d);
                  }),
                  this.translationVolumeSlider.addEventListener(
                    "input",
                    async (d, f) => {
                      (this.tranlsationVolumeSliderLabel.value = d),
                        (this.data.defaultVolume = d),
                        await j.d.set("defaultVolume", this.data.defaultVolume),
                        !f && this.onInputTranslationVolume.dispatch(d);
                    },
                  ),
                  this
                );
              ...
              updateButtonLayout(d, f) {
                return this.isInitialized()
                  ? ((this.votMenu.position = d),
                    (this.votButton.position = d),
                    (this.votButton.direction = f),
                    (this.votButtonTooltip.hidden = f === "row"),
                    this.votButtonTooltip.setPosition(
                      this.votButton.tooltipPos,
                    ),
                    this)
                  : this;
              }
              async moveButton(d) {
                ...
                return (
                  (this.data.buttonPos = f),
                  this.updateButtonLayout(f, p),
                  this.isBigContainer && (await j.d.set("buttonPos", f)),
                  this
                );
              }
              async handleDragMove(
                d,
                f,
                p = this.root.getBoundingClientRect(),
              ) {
              ...
              releaseUIEvents(d = !1) {
                ...
                for (let d of this.cancelDraggingEvents)
                  document.removeEventListener(d, this.disableDragging);
                return (
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/@vot.js/shared/dist/data/consts.js"),
              g = p("./node_modules/lit-html/lit-html.js"),
              _ = p("./src/ui.js"),
              v = p("./src/ui/components/accountButton.ts"),
              b = p("./src/ui/components/checkbox.ts"),
              x = p("./src/ui/components/details.ts"),
              C = p("./src/ui/components/dialog.ts"),
              w = p("./src/ui/components/hotkeyButton.ts"),
              T = p("./src/ui/components/label.ts"),
              E = p("./src/ui/components/select.ts"),
              D = p("./src/ui/components/slider.ts"),
              O = p("./src/ui/components/sliderLabel.ts"),
              A = p("./src/ui/components/textfield.ts"),
              j = p("./src/ui/components/tooltip.ts"),
              F = p("./node_modules/@vot.js/ext/dist/types/service.js"),
              U = p("./src/index.js"),
              W = p("./src/audioDownloader/index.ts"),
              G = p("./src/config/config.js"),
              K = p("./src/core/eventImpl.ts"),
              q = p("./src/localization/localizationProvider.ts"),
              J = p("./src/types/components/votButton.ts"),
              Y = p("./src/utils/debug.ts"),
              X = p("./src/utils/gm.ts"),
              Z = p("./src/utils/storage.ts"),
              Q = p("./src/utils/translateApis.ts"),
              $ = p("./src/utils/utils.ts"),
              ee = p("./src/ui/icons.ts"),
              te = d([_, v, b, x, C, w, T, E, D, O, A, j, U, W, q, X, Z, Q, $]);
            [_, v, b, x, C, w, T, E, D, O, A, j, U, W, q, X, Z, Q, $] = te.then
              ? (await te)()
              : te;
            class SettingsView {
              globalPortal;
              ...
              initUI() {
                if (this.isInitialized())
                  throw Error("[VOT] SettingsView is already initialized");
                (this.initialized = !0),
                  (this.dialog = new C.A({
                    titleHtml: q.j.get("VOTSettings"),
                  })),
                  this.globalPortal.appendChild(this.dialog.container),
                  (this.accountHeader = _.A.createHeader(
                    q.j.get("VOTMyAccount"),
                  )),
                  (this.accountButton = new v.A({
                    avatarId: this.data.account?.avatarId,
                    username: this.data.account?.username,
                    loggedIn: !!this.data.account?.token,
                  })),
                  Z.d.isSupportOnlyLS()
                    ? (this.accountButton.refreshButton.setAttribute(
                        "disabled",
                        "true",
                      ),
                      this.accountButton.actionButton.setAttribute(
                        "disabled",
                        "true",
                      ))
                    : (this.accountButtonRefreshTooltip = new j.A({
                  ...
                  (this.translationSettingsHeader = _.A.createHeader(
                    q.j.get("translationSettings"),
                  )),
                  (this.autoTranslateCheckbox = new b.A({
                ...
                (this.dontTranslateLanguagesCheckbox = new b.A({
                  ...
                  (this.dontTranslateLanguagesSelect = new E.A({
                    ...
                    selectTitle:
                      d.map((d) => q.j.get(`langs.${d}`)).join(", ") ??
                      q.j.get("DontTranslateSelectedLanguages"),
                ...
                (this.autoSetVolumeSliderLabel = new O.A({
                  ...
                  this.videoHandler?.audioContext ||
                    ((this.audioBoosterCheckbox.disabled = !0),
                    (this.audioBoosterTooltip = new j.A({
                  ...
                  (this.downloadWithNameCheckbox.disabled = !X.yx),
                  (this.sendNotifyOnCompleteCheckbox = new b.A({
                  ...
                  this.data.account?.token ||
                    (this.useLivelyVoiceCheckbox.disabled = !0),
                  (this.useAudioDownloadCheckboxLabel = new T.A({
                  ...
                  X.B0 || (this.useAudioDownloadCheckbox.disabled = !0),
                  (this.useAudioDownloadCheckboxTooltip = new j.A({
                  ...
                  (this.subtitlesSettingsHeader = _.A.createHeader(
                    q.j.get("subtitlesSettings"),
                  )),
                  (this.subtitlesDownloadFormatSelectLabel = new T.A({
                    labelText: q.j.get("VOTSubtitlesDownloadFormat"),
                  })),
                  (this.subtitlesDownloadFormatSelect = new E.A({
                    selectTitle:
                      this.data.subtitlesDownloadFormat ??
                      q.j.get("VOTSubtitlesDownloadFormat"),
                    dialogTitle: q.j.get("VOTSubtitlesDownloadFormat"),
                    dialogParent: this.globalPortal,
                    labelElement:
                      this.subtitlesDownloadFormatSelectLabel.container,
                    items: h.EG.map((d) => ({
                      label: d.toUpperCase(),
                      value: d,
                  ...
                  (this.subtitlesDesignDetails = new x.A({
                  ...
                  (this.hotkeysSettingsHeader = _.A.createHeader(
                    q.j.get("hotkeysSettings"),
                  )),
                  (this.translateHotkeyButton = new w.A({
                  ...
                  (this.proxySettingsHeader = _.A.createHeader(
                    q.j.get("proxySettings"),
                  )),
                  (this.proxyM3U8HostTextfield = new A.A({
                ...
                let p = [
                  ...
                  m = this.data.translateProxyEnabled ?? 0,
                  g = U.k && G.vZ.includes(U.k);
                (this.proxyTranslationStatusSelectLabel = new T.A({
                  icon: g ? ee.Xd : void 0,
                  labelText: q.j.get("VOTTranslateProxyStatus"),
                })),
                  g &&
                    (this.proxyTranslationStatusSelectTooltip = new j.A({
                  ...
                  (this.proxyTranslationStatusSelect = new E.A({
                    ...
                    dialogParent: this.globalPortal,
                    labelElement:
                      this.proxyTranslationStatusSelectLabel.container,
                    items: p.map((d, f) => ({
                      label: d,
                      value: f.toString(),
                      selected: f === m,
                  ...
                  (this.miscSettingsHeader = _.A.createHeader(
                    q.j.get("miscSettings"),
                  )),
                  (this.translateAPIErrorsCheckbox = new b.A({
                    labelHtml: q.j.get("VOTTranslateAPIErrors"),
                    checked: this.data.translateAPIErrors ?? !0,
                  })),
                  (this.translateAPIErrorsCheckbox.hidden = q.j.lang === "ru"),
                  (this.useNewAudioPlayerCheckbox = new b.A({
                    labelHtml: q.j.get("VOTNewAudioPlayer"),
                    checked: this.data.newAudioPlayer,
                  })),
                  this.videoHandler?.audioContext ||
                    ((this.useNewAudioPlayerCheckbox.disabled = !0),
                    (this.useNewAudioPlayerTooltip = new j.A({
                ...
                let F = this.videoHandler?.site.needBypassCSP
                  ? `${q.j.get("VOTOnlyBypassMediaCSP")} (${q.j.get("VOTMediaCSPEnabledOnSite")})`
                  : q.j.get("VOTOnlyBypassMediaCSP");
                (this.onlyBypassMediaCSPCheckbox = new b.A({
                  ...
                  this.videoHandler?.audioContext ||
                    (this.onlyBypassMediaCSPTooltip = new j.A({
                  ...
                  (this.onlyBypassMediaCSPCheckbox.disabled =
                    ...
                    !!this.videoHandler?.audioContext),
                  this.data.newAudioPlayer ||
                    (this.onlyBypassMediaCSPCheckbox.hidden = !0),
                  (this.translationTextServiceLabel = new T.A({
                ...
                (this.translationTextServiceSelect = new E.A({
                  ...
                  (this.detectServiceLabel = new T.A({
                    labelText: q.j.get("VOTDetectService"),
                  }));
                let K = this.data.detectService ?? G.K2;
                return (
                  (this.detectServiceSelect = new E.A({
                  ...
                  (this.appearanceDetails = new x.A({
                    titleHtml: q.j.get("appearance"),
                  })),
                  (this.aboutExtensionDetails = new x.A({
                    titleHtml: q.j.get("aboutExtension"),
                  })),
                  (this.bugReportButton = _.A.createOutlinedButton(
                    q.j.get("VOTBugReport"),
                  )),
                  (this.resetSettingsButton = _.A.createButton(
                    q.j.get("resetSettings"),
                  )),
                  this.dialog.bodyContainer.append(
              ...
              initUIEvents() {
                ...
                return (
                    ...
                    async () => {
                      ...
                      p.addEventListener("change", async (d) => {
                        (this.data.account = d
                          ...
                          : {}),
                          await Z.d.set("account", this.data.account),
                          this.updateAccountInfo();
                      }),
                  ...
                  this.accountButton.addEventListener("refresh", async () => {
                    Z.d.isSupportOnlyLS() ||
                      ((this.data.account = await Z.d.get("account", {})),
                      this.updateAccountInfo());
                  }),
                  this.autoTranslateCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.autoTranslate = d),
                        await Z.d.set("autoTranslate", this.data.autoTranslate),
                        Y.A.log("autoTranslate value changed. New value:", d),
                        this.onChangeAutoTranslate.dispatch(d);
                    },
                  ),
                  this.dontTranslateLanguagesCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.enabledDontTranslateLanguages = d),
                        await Z.d.set(
                  ...
                  this.dontTranslateLanguagesSelect.addEventListener(
                    "selectItem",
                    async (d) => {
                      (this.data.dontTranslateLanguages = d),
                        await Z.d.set(
                          "dontTranslateLanguages",
                          this.data.dontTranslateLanguages,
                        ),
                        Y.A.log(
                          "dontTranslateLanguages value changed. New value:",
                          d,
                        );
                    },
                  ),
                  this.autoSetVolumeCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.enabledAutoVolume = d),
                        await Z.d.set(
                          "enabledAutoVolume",
                          this.data.enabledAutoVolume,
                        ),
                        Y.A.log(
                          "enabledAutoVolume value changed. New value:",
                          d,
                        );
                    },
                  ),
                  this.autoSetVolumeSlider.addEventListener(
                    ...
                    async (d) => {
                      (this.data.autoVolume =
                        this.autoSetVolumeSliderLabel.value =
                          d),
                        await Z.d.set("autoVolume", this.data.autoVolume),
                        Y.A.log("autoVolume value changed. New value:", d);
                    },
                  ),
                  this.showVideoVolumeSliderCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.showVideoSlider = d),
                        await Z.d.set(
                          "showVideoSlider",
                          this.data.showVideoSlider,
                        ),
                        Y.A.log(
                          "showVideoVolumeSlider value changed. New value:",
                          d,
                        ),
                        this.onChangeShowVideoVolume.dispatch(d);
                    },
                  ),
                  this.audioBoosterCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.audioBooster = d),
                        await Z.d.set("audioBooster", this.data.audioBooster),
                        Y.A.log("audioBooster value changed. New value:", d),
                        this.onChangeAudioBooster.dispatch(d);
                    },
                  ),
                  this.syncVolumeCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.syncVolume = d),
                        await Z.d.set("syncVolume", this.data.syncVolume),
                        Y.A.log("syncVolume value changed. New value:", d);
                    },
                  ),
                  this.downloadWithNameCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.downloadWithName = d),
                        await Z.d.set(
                          "downloadWithName",
                  ...
                  this.sendNotifyOnCompleteCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.sendNotifyOnComplete = d),
                        await Z.d.set(
                  ...
                  this.useLivelyVoiceCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.useLivelyVoice = d),
                        await Z.d.set(
                          "useLivelyVoice",
                          this.data.useLivelyVoice,
                        ),
                        Y.A.log("useLivelyVoice value changed. New value:", d),
                        this.onChangeUseLivelyVoice.dispatch(d);
                    },
                  ),
                  this.useAudioDownloadCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.useAudioDownload = d),
                        await Z.d.set(
                          "useAudioDownload",
                          this.data.useAudioDownload,
                        ),
                        Y.A.log(
                          "useAudioDownload value changed. New value:",
                          d,
                        );
                    },
                  ),
                  this.subtitlesDownloadFormatSelect.addEventListener(
                    "selectItem",
                    async (d) => {
                      (this.data.subtitlesDownloadFormat = d),
                        await Z.d.set(
                          "subtitlesDownloadFormat",
                          this.data.subtitlesDownloadFormat,
                        ),
                        Y.A.log(
                          "subtitlesDownloadFormat value changed. New value:",
                          d,
                        );
                    },
                  ),
                  this.subtitlesDesignDetails.addEventListener("click", () => {
                    ...
                    let f = new b.A({
                      ...
                      p = this.data.subtitlesMaxLength ?? 300,
                      m = new O.A({
                      ...
                      g = this.data.subtitlesFontSize ?? 20,
                      _ = new O.A({
                      ...
                      x = this.data.subtitlesOpacity ?? 20,
                      w = new O.A({
                    ...
                    d.bodyContainer.append(
                      ...
                      f.addEventListener("change", async (d) => {
                        (this.data.highlightWords = d),
                          ...
                          this.onChangeSubtitlesHighlightWords.dispatch(d);
                      }),
                      h.addEventListener("input", (d) => {
                        (m.value = d),
                          ...
                          this.onInputSubtitlesMaxLength.dispatch(d);
                      }),
                      v.addEventListener("input", (d) => {
                        (_.value = d),
                          ...
                          Y.A.log(
                            "subtitlesFontSize value changed. New value:",
                            d,
                          ),
                          this.onInputSubtitlesFontSize.dispatch(d);
                      }),
                      T.addEventListener("input", (d) => {
                        (w.value = d),
                          ...
                          Y.A.log(
                            "subtitlesOpacity value changed. New value:",
                            d,
                          ),
                          this.onInputSubtitlesBackgroundOpacity.dispatch(d);
                      });
                  }),
                  this.translateHotkeyButton.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.translationHotkey = d),
                        await Z.d.set(
                          "translationHotkey",
                          this.data.translationHotkey,
                        ),
                        Y.A.log(
                          "translationHotkey value changed. New value:",
                          d,
                        );
                    },
                  ),
                  this.proxyM3U8HostTextfield.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.m3u8ProxyHost = d || G.se),
                        await Z.d.set("m3u8ProxyHost", this.data.m3u8ProxyHost),
                        Y.A.log(
                  ...
                  this.proxyWorkerHostTextfield.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.proxyWorkerHost = d || G.Pm),
                        await Z.d.set(
                          "proxyWorkerHost",
                          this.data.proxyWorkerHost,
                        ),
                        ...
                        this.onChangeProxyWorkerHost.dispatch(d);
                    },
                  ),
                  this.proxyTranslationStatusSelect.addEventListener(
                    "selectItem",
                    async (d) => {
                      (this.data.translateProxyEnabled = Number.parseInt(d)),
                        await Z.d.set(
                          "translateProxyEnabled",
                          this.data.translateProxyEnabled,
                        ),
                        await Z.d.set("translateProxyEnabledDefault", !1),
                        Y.A.log(
                          "translateProxyEnabled value changed. New value:",
                          this.data.translateProxyEnabled,
                        ),
                        this.onSelectItemProxyTranslationStatus.dispatch(d);
                    },
                  ),
                  this.translateAPIErrorsCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.translateAPIErrors = d),
                        await Z.d.set(
                          "translateAPIErrors",
                          this.data.translateAPIErrors,
                        ),
                  ...
                  this.useNewAudioPlayerCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.newAudioPlayer = d),
                        await Z.d.set(
                          "newAudioPlayer",
                          this.data.newAudioPlayer,
                        ),
                        Y.A.log("newAudioPlayer value changed. New value:", d),
                        (this.onlyBypassMediaCSPCheckbox.disabled =
                          this.onlyBypassMediaCSPCheckbox.hidden =
                            !d),
                        this.onChangeUseNewAudioPlayer.dispatch(d);
                    },
                  ),
                  this.onlyBypassMediaCSPCheckbox.addEventListener(
                    "change",
                    async (d) => {
                      (this.data.onlyBypassMediaCSP = d),
                        await Z.d.set(
                          "onlyBypassMediaCSP",
                        ...
                        this.onChangeOnlyBypassMediaCSP.dispatch(d);
                    },
                  ),
                  this.translationTextServiceSelect.addEventListener(
                    "selectItem",
                    async (d) => {
                      (this.data.translationService = d),
                        await Z.d.set(
                          "translationService",
                          this.data.translationService,
                        ),
                        Y.A.log(
                          "translationService value changed. New value:",
                          d,
                        ),
                        this.onSelectItemTranslationTextService.dispatch(d);
                    },
                  ),
                  this.detectServiceSelect.addEventListener(
                    "selectItem",
                    async (d) => {
                      (this.data.detectService = d),
                        await Z.d.set("detectService", this.data.detectService),
                        Y.A.log("detectService value changed. New value:", d);
                    },
                  ),
                  this.appearanceDetails.addEventListener("click", () => {
                    ...
                    f.hidden = !(0, $.Bs)();
                    let p = (this.data.autoHideButtonDelay ?? G.qU) / 1e3,
                      m = new O.A({
                    ...
                    d.bodyContainer.append(
                      ...
                      f.addEventListener("change", async (d) => {
                        (this.data.showPiPButton = d),
                          await Z.d.set(
                            "showPiPButton",
                            this.data.showPiPButton,
                          ),
                          Y.A.log("showPiPButton value changed. New value:", d),
                          this.onChangeShowPiPButton.dispatch(d);
                      }),
                      h.addEventListener("input", async (d) => {
                        m.value = d;
                        let f = Math.round(d * 1e3);
                        Y.A.log(
                          "autoHideButtonDelay value changed. New value:",
                          f,
                        ),
                          (this.data.autoHideButtonDelay = f),
                          await Z.d.set(
                            "autoHideButtonDelay",
                            this.data.autoHideButtonDelay,
                          ),
                          this.onInputAutoHideButtonDelay.dispatch(d);
                      }),
                      _.addEventListener("selectItem", async (d) => {
                        Y.A.log("buttonPos value changed. New value:", d),
                          (this.data.buttonPos = d),
                          await Z.d.set("buttonPos", this.data.buttonPos),
                          this.onSelectItemButtonPosition.dispatch(d);
                      }),
                      w.addEventListener("selectItem", async (d) => {
                        let f = await q.j.changeLang(d);
                        f &&
                          ((this.data.localeUpdatedAt = await Z.d.get(
                            "localeUpdatedAt",
                            0,
                          )),
                          this.onSelectItemMenuLanguage.dispatch(d));
                      });
                  }),
                  this.aboutExtensionDetails.addEventListener("click", () => {
                    ...
                    this.globalPortal.appendChild(d.container);
                    let f = _.A.createInformation(
                        `${q.j.get("VOTVersion")}:`,
                        GM_info.script.version || q.j.get("notFound"),
                      ),
                      p = _.A.createInformation(
                        `${q.j.get("VOTAuthors")}:`,
                        GM_info.script.author ?? q.j.get("notFound"),
                      ),
                      m = _.A.createInformation(
                        `${q.j.get("VOTLoader")}:`,
                        `${GM_info.scriptHandler} v${GM_info.version}`,
                      ),
                      h = _.A.createInformation(
                        `${q.j.get("VOTBrowser")}:`,
                        `${$.R5.browser.name} ${$.R5.browser.version} (${$.R5.os.name} ${$.R5.os.version})`,
                      ),
                      v = new Date(
                        (this.data.localeUpdatedAt ?? 0) * 1e3,
                      ).toLocaleString(),
                      b = (0,
                      g.qy)`${this.data.localeHash}<br />(${q.j.get("VOTUpdatedAt")}
        ${v})`,
                      x = _.A.createInformation(
                        `${q.j.get("VOTLocaleHash")}:`,
                        b,
                      ),
                      w = _.A.createOutlinedButton(
                        q.j.get("VOTUpdateLocaleFiles"),
                      );
                    d.bodyContainer.append(
                      f.container,
                      p.container,
              ...
              updateAccountInfo() {
                ...
                return (
                  ...
                  (this.useLivelyVoiceTooltip.hidden =
                    this.accountButton.loggedIn =
                      d),
                  (this.accountButton.username = this.data.account?.username),
                  (this.useLivelyVoiceCheckbox.disabled = !d),
      ...
      "./src/utils/VOTLocalizedError.js": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./src/localization/localizationProvider.ts"),
              g = d([h]);
            h = (g.then ? (await g)() : g)[0];
            class VOTLocalizedError extends Error {
              constructor(d) {
                super(h.j.getDefault(d)),
                  (this.name = "VOTLocalizedError"),
                  (this.unlocalizedMessage = d),
                  (this.localizedMessage = h.j.get(d));
              }
            }
            m();
          } catch (d) {
      ...
      "./src/utils/VideoObserver.js": (d, f, p) => {
        ...
        var m = p("./node_modules/requestidlecallback-polyfill/index.js"),
          h = p("./node_modules/@vot.js/shared/dist/data/alternativeUrls.js"),
          g = p("./src/core/eventImpl.ts"),
          _ = p("./src/utils/debug.ts");
        class VideoObserver {
          ...
          constructor() {
            (this.videoCache = new WeakSet()),
              ...
              (this.onVideoAdded = new g.Z()),
              (this.onVideoRemoved = new g.Z()),
              (this.observer = new MutationObserver(this.handleMutations));
          }
          isAdRelated(d) {
            let f = ["class", "id", "title"];
            for (let p of f) {
          ...
          hasAudio(d) {
            return h.sx.includes(window.location.hostname)
              ? !d.muted
              : d.mozHasAudio === void 0
                ? d.webkitAudioDecodedByteCount === void 0
                  ? ("audioTracks" in d && d.audioTracks.length > 0) || !d.muted
                  : d.webkitAudioDecodedByteCount > 0
                : d.mozHasAudio;
          }
          isValidVideo(d) {
            ...
            return f
              ...
              : this.hasAudio(d)
                ? !0
                : (_.A.log("Ignoring video without audio:", d), !1);
          }
          traverseDOM(root) {
            if (!root) return;
            const elements = [root];
          ...
          checkVideoState(d) {
            ...
            let onLoadedData = () => {
                this.isValidVideo(d) && this.onVideoAdded.dispatch(d),
                  d.removeEventListener("loadeddata", onLoadedData);
              },
              onEmptied = () => {
                d.isConnected ||
                  (this.onVideoRemoved.dispatch(d),
                  this.videoCache.delete(d),
                  d.removeEventListener("emptied", onEmptied));
              };
            d.addEventListener("emptied", onEmptied),
              d.readyState >= HTMLMediaElement.HAVE_CURRENT_DATA
                ? onLoadedData()
                : d.addEventListener("loadeddata", onLoadedData);
          }
          handleMutations = (d) => {
            for (let f of d) {
            ...
            window.requestIdleCallback(
              () => {
                ...
                for (let d of this.observedNodes.removed)
      ...
      "./src/utils/gm.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            _ = (v.then ? (await v)() : v)[0];
            let b =
                GM_info?.scriptHandler && !h.Wl.includes(GM_info.scriptHandler),
              x = typeof GM < "u",
              C = typeof unsafeWindow < "u",
              w = typeof GM_xmlhttpRequest < "u";
            async function GM_fetch(d, f = {}) {
              let { timeout: p = 15e3, ...m } = f,
                h = new AbortController();
              try {
                if (typeof d == "string" && d.includes("api.browser.yandex.ru"))
                  throw Error("Preventing yandex cors");
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            let _ = "vot_iframe",
              ...
              hasServiceIframe = (d) => document.getElementById(d);
            async function setupServiceIframe(d, f, p) {
              ...
              let g = new Promise((d) => {
                let handleMessage = ({ data: f }) => {
                  f.messageType === `say-${p}-iframe-is-ready` &&
              ...
              return (
                await Promise.race([
                  ...
                  (0, h.wR)(
                    15e3,
                    "Service iframe did not have time to be ready",
                  ),
                ]),
                m
              );
            ...
            function requestDataFromMainWorld(d, f) {
              ...
              return new Promise((m, h) => {
                let handleMessage = ({ data: f }) => {
                  f?.messageId === p &&
                    f.messageType === d &&
                    f.messageDirection === "response" &&
                    (window.removeEventListener("message", handleMessage),
                    f.error ? h(f.error) : m(f.payload));
                };
                window.addEventListener("message", handleMessage),
                  window.postMessage(
                    {
      ...
      "./src/utils/localization.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            h = (g.then ? (await g)() : g)[0];
            let _ = 0.66,
              v = navigator.language?.substring(0, 2).toLowerCase() || "en";
            function secsToStrTime(d) {
              let f = Math.floor(d / 60),
                p = Math.floor(d % 60),
                m = p / 60;
              if ((m >= _ && ((f += 1), (p = 0)), f >= 60))
                return h.j.get("translationTakeMoreThanHour");
              ...
              return f !== 11 && f % 10 == 1
                ? h.j
                    ...
                    .replace("{0}", g)
                : ![12, 13, 14].includes(f) && [2, 3, 4].includes(f % 10)
                  ? h.j
      ...
      "./src/utils/storage.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./src/config/config.js"),
              g = p("./src/localization/localizationProvider.ts"),
              _ = p("./src/types/storage.ts"),
              v = p("./src/utils/debug.ts"),
              b = p("./src/utils/gm.ts"),
              x = d([g, b]);
            ...
            function convertByCompatCategory(d, f) {
              return ["string", "array", "number"].includes(d) ? f : !!f;
            }
            async function updateConfig(d) {
              if (d.compatVersion === h.r4) return d;
              let f = Object.values(C)
                  .flat()
                  .reduce((d, f) => (f[1] && (d[f[0]] = void 0), d), {}),
                p = await w.getValues(f),
                m = Object.fromEntries(
                  Object.entries(p).filter(([d, f]) => f !== void 0),
                ),
                _ = {
                  ...d,
                  ...m,
                },
                v = Object.keys(_).reduce((d, f) => ((d[f] = void 0), d), {}),
                b = await w.getValues(v),
                x = d;
              for (let [d, f] of Object.entries(_)) {
                ...
                d === "autoVolume" && f < 1 && (v = Math.round(f * 100)),
                  (x[_] = v),
                  m[d] !== void 0 && (await w.delete(d)),
                  _ === "localeLangOverride" && (await g.j.changeLang(f)),
                  await w.set(_, v);
              }
              return {
                ...x,
            ...
            let w = new (class {
              ...
              supportGMGetValues;
              constructor() {
                (this.supportGM = false),
                  (this.supportGMPromises = false),
                  (this.supportGMGetValues =
                    b.O6 && typeof GM?.getValues == "function"),
                  v.A.log(
              ...
              async get(d, f) {
                return this.supportGMPromises
                  ? await GM.getValue(d, f)
                  : Promise.resolve(this.syncGet(d, f));
              }
              async getValues(d) {
                return this.supportGMGetValues
                  ? await GM.getValues(d)
                  : Object.fromEntries(
                      await Promise.all(
                        Object.entries(d).map(async ([d, f]) => {
              ...
              syncSet(d, f) {
                return this.supportGM
                  ? GM_setValue(d, f)
                  : window.localStorage.setItem(d, JSON.stringify(f));
              }
              async set(d, f) {
                return this.supportGMPromises
                  ? await GM.setValue(d, f)
                  : Promise.resolve(this.syncSet(d, f));
              }
              syncDelete(d) {
                return this.supportGM
                  ? GM_deleteValue(d)
              ...
              async delete(d) {
                return this.supportGMPromises
                  ? await GM.deleteValue(d)
                  : Promise.resolve(this.syncDelete(d));
              }
              syncList() {
          ...
          try {
            ...
            let b = new (class {
                ...
                async request(d, f = {}) {
                  try {
                    ...
                    console.error(
                      `[VOT] Failed to get data from FOSWLY Translate API, because ${d.message}`,
                    );
                    return;
                  }
                }
              ...
              x = {
                async detect(d) {
                  try {
                    ...
                    return (
                      console.error(
                        `[VOT] Error getting lang from text, because ${d.message}`,
                      ),
                      "en"
                    );
                  }
              ...
              switch (m) {
                ...
                case "msedge": {
                  ...
                  return Array.isArray(d)
                    ? await b.translateMultiple(d, h, m)
                    : await b.translate(d, h, m);
                }
                default:
                  return d;
              }
            ...
            async function detect(d) {
              ...
              switch (f) {
                case "yandexbrowser":
                case "msedge":
                  return await b.detect(d, f);
                case "rust-server":
                  return await x.detect(d);
                default:
                  return "en";
              }
            }
            let C = ["yandexbrowser", "msedge"],
              w = [...C, "rust-server"];
            m();
          } catch (d) {
            m(d);
      ...
      "./src/utils/utils.ts": (d, f, p) => {
        ...
        p.a(d, async (d, m) => {
          try {
            ...
            var h = p("./node_modules/bowser/es5.js"),
              g = p.n(h),
              _ = p(
                "./node_modules/browser-id3-writer/dist/browser-id3-writer.mjs",
              ),
              v = p("./node_modules/@vot.js/shared/dist/data/consts.js"),
              b = p("./src/utils/localization.ts"),
              x = d([b]);
            ...
            let C =
              ...
              T = (() =>
                v.Xh.includes(b.v) ? b.v : w.has(b.v) ? "ru" : "en")(),
              E = g().getParser(window.navigator.userAgent).getResult(),
              isPiPAvailable = () =>
                "pictureInPictureEnabled" in document &&
                document.pictureInPictureEnabled;
            function initHls() {
              return typeof Hls < "u" && Hls?.isSupported()
                ? new Hls({
                    debug: !1,
                    lowLatencyMode: !0,
                    backBufferLength: 90,
            ...
            function clearFileName(d) {
              return d.trim().length === 0
                ...
                : d.replace(/^https?:\/\//, "").replace(/[\\/:*?"'<>|]/g, "-");
            }
            function getTimestamp() {
              return Math.floor(Date.now() / 1e3);
            }
            function getHeaders(d) {
              return d instanceof Headers
            ...
            function toFlatObj(d) {
              return Object.entries(d).reduce((f, [p, m]) => {
                ...
                let h = Object.entries(toFlatObj(d[p])).reduce(
                  (d, [f, m]) => ((d[`${p}.${f}`] = m), d),
                  {},
                );
                return {
            ...
            async function exitFullscreen() {
              ...
              (d.fullscreenElement || d.webkitFullscreenElement) &&
                (d.webkitExitFullscreen && (await d.webkitExitFullscreen()),
                d.exitFullscreen && (await d.exitFullscreen()));
            }
              ...
              return Promise.race([
                ...
                new Promise((d, h) => {
                  setTimeout(() => {
                    (m = !0),
                      p
                        ? h(Error(`Wait for condition reached timeout of ${f}`))
                        : d();
                  }, f);
                }),
              ]);
            ...
            async function downloadTranslation(d, f, p = (d) => {}) {
              let m = +(d.headers.get("Content-Length") ?? 0),
                h = await (m
                  ? _downloadTranslationWithProgress(d, m, p)
                  : d.arrayBuffer());
              p(100);
              let g = new _.Q(h);
              return (
  ...
  (() => {
    ...
    __webpack_require__.a = (m, h, g) => {
      ...
      (T[f] = exports),
        (T[d] = (d) => (_ && d(_), v.forEach(d), T.catch((d) => {}))),
        (m.exports = T),
        h(
          (m) => {
            x = wrapDeps(m);
            var fn,
              ...
              h = new Promise((f) => {
                ...
                var fnQueue = (d) =>
                  d !== _ &&
                  !v.has(d) &&
                  (v.add(d), d && !d.d && (fn.r++, d.push(fn)));
                x.map((f) => f[d](fnQueue));
              });
            return fn.r ? h : getResult();
          },
          (d) => (d ? w((T[p] = d)) : C(exports), resolveQueue(_)),
        ),
        _ && _.d < 0 && (_.d = 0);
    };
  })(),
    ...
    (__webpack_require__.d = (exports, f) => {
      for (var p in f)
        __webpack_require__.o(f, p) &&
          !__webpack_require__.o(exports, p) &&
          Object.defineProperty(exports, p, {
            enumerable: !0,
            get: f[p],
          });
    }),
    (__webpack_require__.o = (d, f) =>
